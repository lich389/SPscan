...
Else If (i_par.Eq.3) Then 
If (i_c.Eq.0) Lambda3pInput= Cmplx(wert,Aimag(Lambda3pInput),dp) 
If (i_c.Eq.1) Lambda3pInput= Cmplx(Real(Lambda3pInput,dp),wert,dp) 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) Lambda4pInput= Cmplx(wert,Aimag(Lambda4pInput),dp) 
If (i_c.Eq.1) Lambda4pInput= Cmplx(Real(Lambda4pInput,dp),wert,dp) 
Else If (i_par.Eq.5) Then 
If (i_c.Eq.0) Lambda5pInput= Cmplx(wert,Aimag(Lambda5pInput),dp) 
If (i_c.Eq.1) Lambda5pInput= Cmplx(Real(Lambda5pInput,dp),wert,dp) 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) Lambda6pInput= Cmplx(wert,Aimag(Lambda6pInput),dp) 
If (i_c.Eq.1) Lambda6pInput= Cmplx(Real(Lambda6pInput,dp),wert,dp) 
Else If (i_par.Eq.7) Then 
If (i_c.Eq.0) Lambda7pInput= Cmplx(wert,Aimag(Lambda7pInput),dp) 
If (i_c.Eq.1) Lambda7pInput= Cmplx(Real(Lambda7pInput,dp),wert,dp) 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) Lambda1ppInput= Cmplx(wert,Aimag(Lambda1ppInput),dp) 
If (i_c.Eq.1) Lambda1ppInput= Cmplx(Real(Lambda1ppInput,dp),wert,dp) 
Else If (i_par.Eq.9) Then 
If (i_c.Eq.0) Lambda2ppInput= Cmplx(wert,Aimag(Lambda2ppInput),dp) 
If (i_c.Eq.1) Lambda2ppInput= Cmplx(Real(Lambda2ppInput,dp),wert,dp) 
...
Write(io_L,101) 8, Real(TanBeta,dp) ,"# TanBeta"
...
End if 
WriteNextBlock = .false. 
If (Abs(Real(Lambda1pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda2pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda3pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda4pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda5pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda6pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda7pInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda1ppInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda2ppInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda3ppInput,dp)).gt.0._dp) WriteNextBlock = .True. 
...
If (Abs(Real(Lambda1pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 1, Real(Lambda1pInput,dp) ,"# Lambda1pInput"
End if 
If (Abs(Real(Lambda2pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 2, Real(Lambda2pInput,dp) ,"# Lambda2pInput"
End if 
If (Abs(Real(Lambda3pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 3, Real(Lambda3pInput,dp) ,"# Lambda3pInput"
End if 
If (Abs(Real(Lambda4pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 4, Real(Lambda4pInput,dp) ,"# Lambda4pInput"
End if 
If (Abs(Real(Lambda5pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 5, Real(Lambda5pInput,dp) ,"# Lambda5pInput"
End if 
If (Abs(Real(Lambda6pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 6, Real(Lambda6pInput,dp) ,"# Lambda6pInput"
End if 
If (Abs(Real(Lambda7pInput,dp)).gt.0._dp) Then 
Write(io_L,101) 7, Real(Lambda7pInput,dp) ,"# Lambda7pInput"
End if 
If (Abs(Real(Lambda1ppInput,dp)).gt.0._dp) Then 
Write(io_L,101) 8, Real(Lambda1ppInput,dp) ,"# Lambda1ppInput"
End if 
If (Abs(Real(Lambda2ppInput,dp)).gt.0._dp) Then 
Write(io_L,101) 9, Real(Lambda2ppInput,dp) ,"# Lambda2ppInput"
End if 
If (Abs(Real(Lambda3ppInput,dp)).gt.0._dp) Then 
Write(io_L,101) 10, Real(Lambda3ppInput,dp) ,"# Lambda3ppInput"
End if 
If (Abs(Real(MUS1Input,dp)).gt.0._dp) Then 
Write(io_L,101) 11, Real(MUS1Input,dp) ,"# MUS1Input"
End if 
If (Abs(Real(MUS2Input,dp)).gt.0._dp) Then 
Write(io_L,101) 12, Real(MUS2Input,dp) ,"# MUS2Input"
End if 
If (Abs(Real(MU11Input,dp)).gt.0._dp) Then 
Write(io_L,101) 13, Real(MU11Input,dp) ,"# MU11Input"
End if 
If (Abs(Real(MU22Input,dp)).gt.0._dp) Then 
Write(io_L,101) 14, Real(MU22Input,dp) ,"# MU22Input"
End if 
...
If (Abs(Aimag(Lambda3pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda4pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda5pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda6pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda7pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda1ppInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda2ppInput)).gt.0._dp) WriteNextBlock = .True. 
...
Write(io_L,101) 1, Aimag(Lambda1pInput) ,"# Lambda1pInput"
End if 
If (Abs(Aimag(Lambda2pInput)).gt.0._dp) Then 
Write(io_L,101) 2, Aimag(Lambda2pInput) ,"# Lambda2pInput"
End if 
If (Abs(Aimag(Lambda3pInput)).gt.0._dp) Then 
Write(io_L,101) 3, Aimag(Lambda3pInput) ,"# Lambda3pInput"
End if 
If (Abs(Aimag(Lambda4pInput)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(Lambda4pInput) ,"# Lambda4pInput"
End if 
If (Abs(Aimag(Lambda5pInput)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(Lambda5pInput) ,"# Lambda5pInput"
End if 
If (Abs(Aimag(Lambda6pInput)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(Lambda6pInput) ,"# Lambda6pInput"
End if 
If (Abs(Aimag(Lambda7pInput)).gt.0._dp) Then 
Write(io_L,101) 7, Aimag(Lambda7pInput) ,"# Lambda7pInput"
End if 
If (Abs(Aimag(Lambda1ppInput)).gt.0._dp) Then 
Write(io_L,101) 8, Aimag(Lambda1ppInput) ,"# Lambda1ppInput"
End if 
If (Abs(Aimag(Lambda2ppInput)).gt.0._dp) Then 
Write(io_L,101) 9, Aimag(Lambda2ppInput) ,"# Lambda2ppInput"
End if 
If (Abs(Aimag(Lambda3ppInput)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(Lambda3ppInput) ,"# Lambda3ppInput"
End if 
If (Abs(Aimag(MUS1Input)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(MUS1Input) ,"# MUS1Input"
End if 
If (Abs(Aimag(MUS2Input)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(MUS2Input) ,"# MUS2Input"
End if 
If (Abs(Aimag(MU11Input)).gt.0._dp) Then 
Write(io_L,101) 13, Aimag(MU11Input) ,"# MU11Input"
End if 
If (Abs(Aimag(MU22Input)).gt.0._dp) Then 
Write(io_L,101) 14, Aimag(MU22Input) ,"# MU22Input"
End if 
