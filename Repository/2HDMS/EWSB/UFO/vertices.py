...
V_463 = Vertex(name = 'V_463', 
	 ...
	 color = ['Identity(1,2)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_666,(0,0):C.GC_667}) 
...
V_464 = Vertex(name = 'V_464', 
	 ...
	 color = ['Identity(1,2)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_668,(0,0):C.GC_669}) 
...
V_491 = Vertex(name = 'V_491', 
	 ...
	 color = ['T(3,2,1)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_704,(0,0):C.GC_705}) 
...
V_492 = Vertex(name = 'V_492', 
	 ...
	 color = ['T(3,2,1)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_706,(0,0):C.GC_707}) 
...
V_493 = Vertex(name = 'V_493', 
	 ...
	 color = ['T(3,2,1)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_708,(0,0):C.GC_709}) 
...
V_494 = Vertex(name = 'V_494', 
	 ...
	 color = ['Identity(1,2)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_710,(0,0):C.GC_711}) 
...
V_495 = Vertex(name = 'V_495', 
	 ...
	 color = ['Identity(1,2)'], 
	 lorentz = [L.FFV2,L.FFV3], 
	 couplings = {(0,1):C.GC_712,(0,0):C.GC_713}) 
...
V_524 = Vertex(name = 'V_524', 
	 ...
	 couplings = {(0,0):C.GC_746,(1,0):C.GC_747,(0,1):C.GC_748,(2,1):C.GC_749,(1,2):C.GC_750,(2,2):C.GC_751}) 
...
V_525 = Vertex(name = 'V_525', 
	 ...
	 color = ['1'], 
	 lorentz = [L.VVVV1,L.VVVV2,L.VVVV3], 
	 couplings = {(0,0):C.GC_752,(0,1):C.GC_753,(0,2):C.GC_754}) 
...
V_526 = Vertex(name = 'V_526', 
	 ...
	 color = ['1'], 
	 lorentz = [L.VVVV1,L.VVVV2,L.VVVV3], 
	 couplings = {(0,0):C.GC_755,(0,1):C.GC_756,(0,2):C.GC_757}) 
...
V_527 = Vertex(name = 'V_527', 
	 ...
	 color = ['1'], 
	 lorentz = [L.VVVV1,L.VVVV2,L.VVVV3], 
	 couplings = {(0,0):C.GC_758,(0,1):C.GC_759,(0,2):C.GC_760}) 
...
V_528 = Vertex(name = 'V_528', 
	 ...
	 color = ['1'], 
	 lorentz = [L.VVVV1,L.VVVV2,L.VVVV3], 
	 couplings = {(0,0):C.GC_761,(0,1):C.GC_762,(0,2):C.GC_763}) 
