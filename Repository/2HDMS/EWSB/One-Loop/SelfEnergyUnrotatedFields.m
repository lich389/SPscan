{{sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[Hm[{gI1}]]]*
      conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][PL]]*
      Mass[Fe[{gI2}]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][PR]]] - 
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][
         PR]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][PR]]] - 
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][
         PL]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][PL]]] - 
   sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], Mass2[VZ]])*
 ...
 (3*((-2*p^2*rMS)/3 - 2*A0[0] - 4*p^2*B0[p^2, 0, 0] - 10*B00[p^2, 0, 0])*
  ...
  B00[p^2, Mass2[gWmC], Mass2[gWmC]]*conj[Cp[VP, bar[gWmC], gWmC]]*
   ...
   Cp[VP, conj[VWm], VWm]*(-2*A0[Mass2[VWm]] - 
    10*B00[p^2, Mass2[VWm], Mass2[VWm]] + 2*rMS*(-1/3*p^2 + 2*Mass2[VWm]) - 
    B0[p^2, Mass2[VWm], Mass2[VWm]]*(4*p^2 + 2*Mass2[VWm])) + 
  sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*Cp[VP, VP, conj[Hm[{gI1}]], 
     Hm[{gI1}]]] - 4*sum[gI1, 1, 2, sum[gI2, 1, 2, 
     B00[p^2, Mass2[Hm[{gI1}]], Mass2[Hm[{gI2}]]]*
      conj[Cp[VP, conj[Hm[{gI1}]], Hm[{gI2}]]]*Cp[VP, conj[Hm[{gI1}]], 
