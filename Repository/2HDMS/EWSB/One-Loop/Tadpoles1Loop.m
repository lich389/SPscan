{{hh, A0[Mass2[gWm]]*Cp[Uhh[{gO1}], bar[gWm], gWm] + 
   ...
   sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*Cp[Uhh[{gO1}], conj[Hm[{gI1}]], 
      Hm[{gI1}]]] - sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*
      Cp[Uhh[{gO1}], Ah[{gI1}], Ah[{gI1}]]]/2 - 
   sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*Cp[Uhh[{gO1}], hh[{gI1}], hh[{gI1}]]]/
    2 + 6*sum[gI1, 1, 3, A0[Mass2[Fd[{gI1}]]]*Mass[Fd[{gI1}]]*
