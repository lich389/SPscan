{{hh, 2*(-1/2*rMS + B0[p^2, Mass2[VZ], Mass2[VZ]])*
    conj[Cp[Uhh[{gO2}], VZ, VZ]]*Cp[Uhh[{gO1}], VZ, VZ] + 
   4*(-1/2*rMS + B0[p^2, Mass2[VWm], Mass2[VWm]])*
   ...
   sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], 
      conj[Hm[{gI1}]], Hm[{gI1}]]] + sum[gI1, 1, 2, 
    sum[gI2, 1, 2, B0[p^2, Mass2[Hm[{gI1}]], Mass2[Hm[{gI2}]]]*
 ...
 {Ah, -(B0[p^2, Mass2[gWm], Mass2[gWm]]*Cp[UAh[{gO1}], bar[gWm], gWm]*
   ...
   4*Cp[UAh[{gO1}], UAh[{gO2}], conj[VWm], VWm]*(A0[Mass2[VWm]] - 
    ...
    A0[Mass2[Hm[{gI1}]]]*Cp[UAh[{gO1}], UAh[{gO2}], conj[Hm[{gI1}]], 
      Hm[{gI1}]]] + sum[gI1, 1, 2, sum[gI2, 1, 2, 
 ...
 {Hm, 4*(-1/2*rMS + B0[p^2, 0, Mass2[VWm]])*
    conj[Cp[conj[UHm[{gO2}]], VWm, VP]]*Cp[conj[UHm[{gO1}]], VWm, VP] + 
   4*(-1/2*rMS + B0[p^2, Mass2[VWm], Mass2[VZ]])*
   ...
   2*Cp[UHm[{gO1}], conj[UHm[{gO2}]], VZ, VZ]*(A0[Mass2[VZ]] - 
     (rMS*Mass2[VZ])/2) - sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*
     Cp[UHm[{gO1}], conj[UHm[{gO2}]], conj[Hm[{gI1}]], Hm[{gI1}]]] + 
   sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Hm[{gI1}]], Mass2[Ah[{gI2}]]]*
   ...
   sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[UHm[{gO1}], conj[UHm[{gO2}]], 
       Ah[{gI1}], Ah[{gI1}]]]/2 - 
   ...
   3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fu[{gI1}]], 
        Mass2[Fd[{gI2}]]]*(conj[Cp[conj[UHm[{gO2}]], bar[Fu[{gI1}]], 
            Fd[{gI2}]][PL]]*Cp[conj[UHm[{gO1}]], bar[Fu[{gI1}]], Fd[{gI2}]][
          PL] + conj[Cp[conj[UHm[{gO2}]], bar[Fu[{gI1}]], Fd[{gI2}]][PR]]*
         Cp[conj[UHm[{gO1}]], bar[Fu[{gI1}]], Fd[{gI2}]][PR])]] - 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fv[{gI1}]], Mass2[Fe[{gI2}]]]*
      (conj[Cp[conj[UHm[{gO2}]], bar[Fv[{gI1}]], Fe[{gI2}]][PL]]*
       ...
       conj[Cp[conj[UHm[{gO2}]], bar[Fv[{gI1}]], Fe[{gI2}]][PR]]*
        Cp[conj[UHm[{gO1}]], bar[Fv[{gI1}]], Fe[{gI2}]][PR])]] + 
   sum[gI2, 1, 2, conj[Cp[conj[UHm[{gO2}]], VP, Hm[{gI2}]]]*
   ...
   sum[gI2, 1, 2, conj[Cp[conj[UHm[{gO2}]], VZ, Hm[{gI2}]]]*
     Cp[conj[UHm[{gO1}]], VZ, Hm[{gI2}]]*F0[p^2, Mass2[Hm[{gI2}]], 
      Mass2[VZ]]] + sum[gI2, 1, 3, conj[Cp[conj[UHm[{gO2}]], VWm, Ah[{gI2}]]]*
     Cp[conj[UHm[{gO1}]], VWm, Ah[{gI2}]]*F0[p^2, Mass2[Ah[{gI2}]], 
      Mass2[VWm]]] + sum[gI2, 1, 3, 
    conj[Cp[conj[UHm[{gO2}]], VWm, hh[{gI2}]]]*Cp[conj[UHm[{gO1}]], VWm, 
      hh[{gI2}]]*F0[p^2, Mass2[hh[{gI2}]], Mass2[VWm]]]}, 
 {Fd, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hm[{gI1}], Fu[{gI2}]][PL]]*
       Mass[Fu[{gI2}]]*Cp[bar[UFd[{gO1}]], Hm[{gI1}], Fu[{gI2}]][PR]]] + 
    ...
    4*sum[gI2, 1, 3, (-1/2*rMS + B0[p^2, Mass2[Fu[{gI2}]], Mass2[VWm]])*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hm[{gI1}], Fu[{gI2}]][
          PR]]*Cp[bar[UFd[{gO1}]], Hm[{gI1}], Fu[{gI2}]][PR]]] - 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hm[{gI1}], Fu[{gI2}]][
          PL]]*Cp[bar[UFd[{gO1}]], Hm[{gI1}], Fu[{gI2}]][PL]]] - 
    sum[gI1, 1, 3, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFd[{gO2}]], Fd[{gI1}], Ah[{gI2}]][PL]]*
 ...
 {Fu, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFu[{gO2}]], conj[Hm[{gI1}]], 
          Fd[{gI2}]][PL]]*Mass[Fd[{gI2}]]*
       Cp[bar[UFu[{gO1}]], conj[Hm[{gI1}]], Fd[{gI2}]][PR]]] + 
    ...
    4*sum[gI2, 1, 3, (-1/2*rMS + B0[p^2, Mass2[Fd[{gI2}]], Mass2[VWm]])*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFu[{gO2}]], conj[Hm[{gI1}]], 
           Fd[{gI2}]][PR]]*Cp[bar[UFu[{gO1}]], conj[Hm[{gI1}]], Fd[{gI2}]][
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFu[{gO2}]], conj[Hm[{gI1}]], 
           Fd[{gI2}]][PL]]*Cp[bar[UFu[{gO1}]], conj[Hm[{gI1}]], Fd[{gI2}]][
         PL]]] - sum[gI1, 1, 3, sum[gI2, 1, 3, 
       B1[p^2, Mass2[Fu[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFu[{gO2}]], Fu[{gI1}], Ah[{gI2}]][PL]]*
 ...
 {Fe, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hm[{gI1}], Fv[{gI2}]][PL]]*
       Mass[Fv[{gI2}]]*Cp[bar[UFe[{gO1}]], Hm[{gI1}], Fv[{gI2}]][PR]]] + 
    ...
    4*sum[gI2, 1, 3, (-1/2*rMS + B0[p^2, Mass2[Fv[{gI2}]], Mass2[VWm]])*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hm[{gI1}], Fv[{gI2}]][
          PR]]*Cp[bar[UFe[{gO1}]], Hm[{gI1}], Fv[{gI2}]][PR]]] - 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hm[{gI1}], Fv[{gI2}]][
          PL]]*Cp[bar[UFe[{gO1}]], Hm[{gI1}], Fv[{gI2}]][PL]]] - 
    sum[gI1, 1, 3, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI1}]], Mass2[Ah[{gI2}]]]*
        conj[Cp[bar[UFe[{gO2}]], Fe[{gI1}], Ah[{gI2}]][PL]]*
 ...
 {Fv, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][
         PL]]*Mass[Fe[{gI2}]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][
        PR]]] - 4*sum[gI2, 1, 3, (-1/2*rMS + B0[p^2, Mass2[Fv[{gI2}]], 
         Mass2[VZ]])*conj[Cp[bar[Fv[{gO2}]], VZ, Fv[{gI2}]][PR]]*
       Mass[Fv[{gI2}]]*Cp[bar[Fv[{gO1}]], VZ, Fv[{gI2}]][PL]] - 
    4*sum[gI2, 1, 3, (-1/2*rMS + B0[p^2, Mass2[Fe[{gI2}]], Mass2[VWm]])*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], 
           Fe[{gI2}]][PR]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][
         PR]]] - sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], 
        Mass2[VZ]])*conj[Cp[bar[Fv[{gO2}]], VZ, Fv[{gI2}]][PL]]*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
         Mass2[Hm[{gI1}]]]*conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], 
           Fe[{gI2}]][PL]]*Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][
         PL]]] - sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], 
        Mass2[VZ]])*conj[Cp[bar[Fv[{gO2}]], VZ, Fv[{gI2}]][PR]]*
 ...
 {VP, B00[p^2, Mass2[gWm], Mass2[gWm]]*conj[Cp[VP, bar[gWm], gWm]]*
   ...
   conj[Cp[VP, conj[VWm], VWm]]*Cp[VP, conj[VWm], VWm]*
    (-2*A0[Mass2[VWm]] - 10*B00[p^2, Mass2[VWm], Mass2[VWm]] + 
     2*rMS*(-1/3*p^2 + 2*Mass2[VWm]) - B0[p^2, Mass2[VWm], Mass2[VWm]]*
      (4*p^2 + 2*Mass2[VWm])) + sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*
     Cp[VP, VP, conj[Hm[{gI1}]], Hm[{gI1}]]] - 
   4*sum[gI1, 1, 2, sum[gI2, 1, 2, B00[p^2, Mass2[Hm[{gI1}]], 
        Mass2[Hm[{gI2}]]]*conj[Cp[VP, conj[Hm[{gI1}]], Hm[{gI2}]]]*
       Cp[VP, conj[Hm[{gI1}]], Hm[{gI2}]]]] + 
       ...
       H0[p^2, Mass2[Fu[{gI1}]], Mass2[Fu[{gI2}]]]*
        (conj[Cp[VP, bar[Fu[{gI1}]], Fu[{gI2}]][PL]]*
         ...
         conj[Cp[VP, bar[Fu[{gI1}]], Fu[{gI2}]][PR]]*
          Cp[VP, bar[Fu[{gI1}]], Fu[{gI2}]][PR])]] + 
   2*sum[gI2, 1, 2, B0[p^2, Mass2[VWm], Mass2[Hm[{gI2}]]]*
      conj[Cp[VP, conj[VWm], Hm[{gI2}]]]*Cp[VP, conj[VWm], Hm[{gI2}]]] + 
 ...
 {VZ, B00[p^2, Mass2[gWm], Mass2[gWm]]*conj[Cp[VZ, bar[gWm], gWm]]*
   ...
   conj[Cp[VZ, conj[VWm], VWm]]*Cp[VZ, conj[VWm], VWm]*
    (-2*A0[Mass2[VWm]] - 10*B00[p^2, Mass2[VWm], Mass2[VWm]] + 
     2*rMS*(-1/3*p^2 + 2*Mass2[VWm]) - B0[p^2, Mass2[VWm], Mass2[VWm]]*
      (4*p^2 + 2*Mass2[VWm])) + sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*
     Cp[VZ, VZ, conj[Hm[{gI1}]], Hm[{gI1}]]] - 
   4*sum[gI1, 1, 2, sum[gI2, 1, 2, B00[p^2, Mass2[Hm[{gI1}]], 
        Mass2[Hm[{gI2}]]]*conj[Cp[VZ, conj[Hm[{gI1}]], Hm[{gI2}]]]*
       Cp[VZ, conj[Hm[{gI1}]], Hm[{gI2}]]]] + 
      ...
      H0[p^2, Mass2[Fv[{gI1}]], Mass2[Fv[{gI2}]]]*
       (conj[Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PL]]*
        ...
        conj[Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PR]]*
         Cp[VZ, bar[Fv[{gI1}]], Fv[{gI2}]][PR])]] + 
   2*sum[gI2, 1, 2, B0[p^2, Mass2[VWm], Mass2[Hm[{gI2}]]]*
      conj[Cp[VZ, conj[VWm], Hm[{gI2}]]]*Cp[VZ, conj[VWm], Hm[{gI2}]]] + 
 ...
 {VWm, B00[p^2, Mass2[gWm], Mass2[gP]]*conj[Cp[conj[VWm], bar[gP], gWm]]*
   ...
   conj[Cp[conj[VWm], VWm, VP]]*Cp[conj[VWm], VWm, VP]*
    (-A0[0] - A0[Mass2[VWm]] - 10*B00[p^2, Mass2[VWm], 0] + 
     2*rMS*(-1/3*p^2 + Mass2[VWm]) - B0[p^2, Mass2[VWm], 0]*
      (4*p^2 + Mass2[VWm])) + conj[Cp[conj[VWm], VZ, VWm]]*
    Cp[conj[VWm], VZ, VWm]*(-A0[Mass2[VWm]] - A0[Mass2[VZ]] - 
     10*B00[p^2, Mass2[VZ], Mass2[VWm]] + 
     2*rMS*(-1/3*p^2 + Mass2[VWm] + Mass2[VZ]) - 
     B0[p^2, Mass2[VZ], Mass2[VWm]]*(4*p^2 + Mass2[VWm] + Mass2[VZ])) + 
   sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*Cp[VWm, conj[VWm], conj[Hm[{gI1}]], 
      Hm[{gI1}]]] - 4*sum[gI1, 1, 2, sum[gI2, 1, 3, 
      B00[p^2, Mass2[Ah[{gI2}]], Mass2[Hm[{gI1}]]]*
       conj[Cp[conj[VWm], Hm[{gI1}], Ah[{gI2}]]]*Cp[conj[VWm], Hm[{gI1}], 
        Ah[{gI2}]]]] - 4*sum[gI1, 1, 2, sum[gI2, 1, 3, 
      B00[p^2, Mass2[hh[{gI2}]], Mass2[Hm[{gI1}]]]*
       conj[Cp[conj[VWm], Hm[{gI1}], hh[{gI2}]]]*Cp[conj[VWm], Hm[{gI1}], 
      ...
      H0[p^2, Mass2[Fv[{gI1}]], Mass2[Fe[{gI2}]]]*
       (conj[Cp[conj[VWm], bar[Fv[{gI1}]], Fe[{gI2}]][PL]]*
        ...
        conj[Cp[conj[VWm], bar[Fv[{gI1}]], Fe[{gI2}]][PR]]*
         Cp[conj[VWm], bar[Fv[{gI1}]], Fe[{gI2}]][PR])]] + 
   sum[gI2, 1, 2, B0[p^2, 0, Mass2[Hm[{gI2}]]]*
     conj[Cp[conj[VWm], VP, Hm[{gI2}]]]*Cp[conj[VWm], VP, Hm[{gI2}]]] + 
   sum[gI2, 1, 2, B0[p^2, Mass2[VZ], Mass2[Hm[{gI2}]]]*
     conj[Cp[conj[VWm], VZ, Hm[{gI2}]]]*Cp[conj[VWm], VZ, Hm[{gI2}]]] + 
