...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MAh,MFe,Mhh,MHm,MVWm,epsE,g2,ZER,               & 
& vd,vu,ZEL,Ye,ZA,ZH,ZP,res)

Implicit None 
Real(dp),Intent(in) :: MAh(3),MFe(3),Mhh(3),MHm(2),MVWm,g2,vd,vu,ZA(3,3),ZH(3,3),ZP(2,2)
...
End Module LoopCouplings_2HDMS 
