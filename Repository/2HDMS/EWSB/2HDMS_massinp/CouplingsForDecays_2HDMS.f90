...
Module CouplingsForDecays_2HDMS
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam1ppinput,Lam4pinput,Lam6pinput,          & 
& Lam7pinput,Lam5pinput,Lam2ppinput,Lam6input,Lam5input,Lam7input,Lam3pinput,            & 
& Lam1input,Lam4input,Lam3input,Lam2input,Lam1pinput,Lam2pinput,Lam3ppinput,             & 
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdcHmL,cplcFuFdcHmR,    & 
...
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,      & 
...
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,      & 
...
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,  & 
...
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhAh,          & 
...
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,MUS1input,MU11input,             & 
& MU12input,MU21input,MU22input,MUS2input,MSpinput,M12input,M112input,M222input,         & 
& MS2input,vdinput,vuinput,vSinput,cplAhHmcHm,cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,     & 
...
End Module CouplingsForDecays_2HDMS
