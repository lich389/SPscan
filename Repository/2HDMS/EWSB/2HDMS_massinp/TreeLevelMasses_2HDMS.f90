...
& MU12,MU21,MU22,MUS2,MSp,M12,M112,M222,MS2,GenerationMixing,kont)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMasses2HDMS'
...
Call CalculateMhh(MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,Lam4p,Lam6p,           & 
& Lam7p,Lam5p,Lam2pp,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,Lam2,             & 
& Lam1p,Lam2p,Lam3pp,vd,vu,vS,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAh(g1,g2,MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,Lam4p,           & 
& Lam6p,Lam7p,Lam5p,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,Lam2,              & 
& Lam1p,Lam2p,Lam3pp,vd,vu,vS,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHm(g2,M12,MU11,MU12,MU21,MU22,Lam4p,Lam6p,Lam7p,Lam5p,Lam6,            & 
& Lam5,Lam7,Lam3p,M112,M222,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,vd,vu,vS,ZP,MHm,             & 
& MHm2,kont)
...
& betaH,vd,vu,vS,g1,g2,g3,Lam1pp,Lam4p,Lam6p,Lam7p,Lam5p,Lam2pp,Lam6,Lam5,               & 
& Lam7,Lam3p,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,Lam3pp,Yu,epsU,Yd,Ye,epsD,epsE,             & 
& MUS1,MU11,MU12,MU21,MU22,MUS2,MSp,M12,M112,M222,MS2,GenerationMixing,kont)
...
Call CalculateMhhEffPot(MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,Lam4p,           & 
& Lam6p,Lam7p,Lam5p,Lam2pp,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,            & 
& Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAhEffPot(g1,g2,MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,           & 
& Lam4p,Lam6p,Lam7p,Lam5p,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,             & 
& Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHmEffPot(g2,M12,MU11,MU12,MU21,MU22,Lam4p,Lam6p,Lam7p,Lam5p,           & 
...
MFd2 = MFd**2 
Call CalculateMFuEffPot(Yu,epsU,vd,vu,ZUL,ZUR,MFu,kont)
...
Subroutine CalculateMhh(MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,Lam4p,           & 
& Lam6p,Lam7p,Lam5p,Lam2pp,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,            & 
& Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,ZH,Mhh,Mhh2,kont)
...
mat(1,1) = mat(1,1)+MU11*vS
mat(1,1) = mat(1,1)+Lam1p*vS**2
mat(1,1) = mat(1,1)+Lam4p*vS**2
mat(1,1) = mat(1,1)+vS**2*Conjg(Lam4p)
mat(1,1) = mat(1,1)+(vu**2*Conjg(Lam5))/4._dp
mat(1,1) = mat(1,1)+(3*vd*vu*Conjg(Lam6))/2._dp
mat(1,1) = mat(1,1)+vS*Conjg(MU11)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-1._dp/2._dp*M12
...
mat(1,2) = mat(1,2)+(MU12*vS)/2._dp
mat(1,2) = mat(1,2)+(MU21*vS)/2._dp
mat(1,2) = mat(1,2)+(Lam3p*vS**2)/2._dp
mat(1,2) = mat(1,2)+(Lam6p*vS**2)/2._dp
mat(1,2) = mat(1,2)+(Lam7p*vS**2)/2._dp
mat(1,2) = mat(1,2)+(vS**2*Conjg(Lam3p))/2._dp
mat(1,2) = mat(1,2)+(vd*vu*Conjg(Lam5))/2._dp
mat(1,2) = mat(1,2)+(3*vd**2*Conjg(Lam6))/4._dp
mat(1,2) = mat(1,2)+(vS**2*Conjg(Lam6p))/2._dp
mat(1,2) = mat(1,2)+(3*vu**2*Conjg(Lam7))/4._dp
mat(1,2) = mat(1,2)+(vS**2*Conjg(Lam7p))/2._dp
mat(1,2) = mat(1,2)-1._dp/2._dp*Conjg(M12)
mat(1,2) = mat(1,2)+(vS*Conjg(MU12))/2._dp
mat(1,2) = mat(1,2)+(vS*Conjg(MU21))/2._dp
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+MU11*vd
mat(1,3) = mat(1,3)+(MU12*vu)/2._dp
mat(1,3) = mat(1,3)+(MU21*vu)/2._dp
mat(1,3) = mat(1,3)+2*Lam1p*vd*vS
mat(1,3) = mat(1,3)+2*Lam4p*vd*vS
mat(1,3) = mat(1,3)+Lam3p*vu*vS
mat(1,3) = mat(1,3)+Lam6p*vu*vS
mat(1,3) = mat(1,3)+Lam7p*vu*vS
mat(1,3) = mat(1,3)+vu*vS*Conjg(Lam3p)
mat(1,3) = mat(1,3)+2*vd*vS*Conjg(Lam4p)
mat(1,3) = mat(1,3)+vu*vS*Conjg(Lam6p)
mat(1,3) = mat(1,3)+vu*vS*Conjg(Lam7p)
mat(1,3) = mat(1,3)+vd*Conjg(MU11)
mat(1,3) = mat(1,3)+(vu*Conjg(MU12))/2._dp
mat(1,3) = mat(1,3)+(vu*Conjg(MU21))/2._dp
mat(2,2) = 0._dp 
...
mat(2,2) = mat(2,2)+MU22*vS
mat(2,2) = mat(2,2)+Lam2p*vS**2
mat(2,2) = mat(2,2)+Lam5p*vS**2
mat(2,2) = mat(2,2)+(vd**2*Conjg(Lam5))/4._dp
mat(2,2) = mat(2,2)+vS**2*Conjg(Lam5p)
mat(2,2) = mat(2,2)+(3*vd*vu*Conjg(Lam7))/2._dp
mat(2,2) = mat(2,2)+vS*Conjg(MU22)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(MU12*vd)/2._dp
mat(2,3) = mat(2,3)+(MU21*vd)/2._dp
mat(2,3) = mat(2,3)+MU22*vu
mat(2,3) = mat(2,3)+Lam3p*vd*vS
mat(2,3) = mat(2,3)+Lam6p*vd*vS
mat(2,3) = mat(2,3)+Lam7p*vd*vS
mat(2,3) = mat(2,3)+2*Lam2p*vu*vS
mat(2,3) = mat(2,3)+2*Lam5p*vu*vS
mat(2,3) = mat(2,3)+vd*vS*Conjg(Lam3p)
mat(2,3) = mat(2,3)+2*vu*vS*Conjg(Lam5p)
mat(2,3) = mat(2,3)+vd*vS*Conjg(Lam6p)
mat(2,3) = mat(2,3)+vd*vS*Conjg(Lam7p)
mat(2,3) = mat(2,3)+(vd*Conjg(MU12))/2._dp
mat(2,3) = mat(2,3)+(vd*Conjg(MU21))/2._dp
mat(2,3) = mat(2,3)+vu*Conjg(MU22)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+2._dp*(MS2)
mat(3,3) = mat(3,3)+MSp
mat(3,3) = mat(3,3)+Lam1p*vd**2
mat(3,3) = mat(3,3)+Lam4p*vd**2
mat(3,3) = mat(3,3)+Lam3p*vd*vu
mat(3,3) = mat(3,3)+Lam6p*vd*vu
mat(3,3) = mat(3,3)+Lam7p*vd*vu
mat(3,3) = mat(3,3)+Lam2p*vu**2
mat(3,3) = mat(3,3)+Lam5p*vu**2
mat(3,3) = mat(3,3)+MUS1*vS
mat(3,3) = mat(3,3)+3*MUS2*vS
mat(3,3) = mat(3,3)+(Lam1pp*vS**2)/2._dp
mat(3,3) = mat(3,3)+2*Lam2pp*vS**2
mat(3,3) = mat(3,3)+3*Lam3pp*vS**2
mat(3,3) = mat(3,3)+(vS**2*Conjg(Lam1pp))/2._dp
mat(3,3) = mat(3,3)+2*vS**2*Conjg(Lam2pp)
mat(3,3) = mat(3,3)+vd*vu*Conjg(Lam3p)
mat(3,3) = mat(3,3)+vd**2*Conjg(Lam4p)
mat(3,3) = mat(3,3)+vu**2*Conjg(Lam5p)
mat(3,3) = mat(3,3)+vd*vu*Conjg(Lam6p)
mat(3,3) = mat(3,3)+vd*vu*Conjg(Lam7p)
mat(3,3) = mat(3,3)+Conjg(MSp)
mat(3,3) = mat(3,3)+vS*Conjg(MUS1)
mat(3,3) = mat(3,3)+3*vS*Conjg(MUS2)
...
Subroutine CalculateMAh(g1,g2,MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,           & 
& Lam4p,Lam6p,Lam7p,Lam5p,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,Lam3,             & 
& Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,TW,ZA,MAh,MAh2,kont)
...
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(MU12*vu)/2._dp
mat(1,3) = mat(1,3)-1._dp/2._dp*(MU21*vu)
mat(1,3) = mat(1,3)+Lam6p*vu*vS
mat(1,3) = mat(1,3)-(Lam7p*vu*vS)
mat(1,3) = mat(1,3)+vu*vS*Conjg(Lam6p)
mat(1,3) = mat(1,3)-(vu*vS*Conjg(Lam7p))
mat(1,3) = mat(1,3)+(vu*Conjg(MU12))/2._dp
mat(1,3) = mat(1,3)-1._dp/2._dp*(vu*Conjg(MU21))
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+M222
mat(2,2) = mat(2,2)+(Lam3*vd**2)/2._dp
mat(2,2) = mat(2,2)+(Lam4*vd**2)/2._dp
...
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)-1._dp/2._dp*(MU12*vd)
mat(2,3) = mat(2,3)+(MU21*vd)/2._dp
mat(2,3) = mat(2,3)-(Lam6p*vd*vS)
mat(2,3) = mat(2,3)+Lam7p*vd*vS
mat(2,3) = mat(2,3)-(vd*vS*Conjg(Lam6p))
mat(2,3) = mat(2,3)+vd*vS*Conjg(Lam7p)
mat(2,3) = mat(2,3)-1._dp/2._dp*(vd*Conjg(MU12))
mat(2,3) = mat(2,3)+(vd*Conjg(MU21))/2._dp
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+2._dp*(MS2)
mat(3,3) = mat(3,3)-1._dp*(MSp)
mat(3,3) = mat(3,3)+Lam1p*vd**2
mat(3,3) = mat(3,3)-(Lam4p*vd**2)
mat(3,3) = mat(3,3)+Lam3p*vd*vu
mat(3,3) = mat(3,3)-(Lam6p*vd*vu)
...
mat(3,3) = mat(3,3)-(Lam5p*vu**2)
mat(3,3) = mat(3,3)-(MUS1*vS)
mat(3,3) = mat(3,3)+MUS2*vS
mat(3,3) = mat(3,3)-1._dp/2._dp*(Lam1pp*vS**2)
mat(3,3) = mat(3,3)+Lam3pp*vS**2
mat(3,3) = mat(3,3)-1._dp/2._dp*(vS**2*Conjg(Lam1pp))
mat(3,3) = mat(3,3)+vd*vu*Conjg(Lam3p)
mat(3,3) = mat(3,3)-(vd**2*Conjg(Lam4p))
mat(3,3) = mat(3,3)-(vu**2*Conjg(Lam5p))
mat(3,3) = mat(3,3)-(vd*vu*Conjg(Lam6p))
...
Subroutine CalculateMHm(g2,M12,MU11,MU12,MU21,MU22,Lam4p,Lam6p,Lam7p,Lam5p,           & 
& Lam6,Lam5,Lam7,Lam3p,M112,M222,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,vd,vu,vS,               & 
& ZP,MHm,MHm2,kont)
...
mat(1,2) = mat(1,2)+(Lam5*vd*vu)/2._dp
mat(1,2) = mat(1,2)+MU21*vS
mat(1,2) = mat(1,2)+Lam7p*vS**2
mat(1,2) = mat(1,2)+vS**2*Conjg(Lam3p)
mat(1,2) = mat(1,2)+(vd**2*Conjg(Lam6))/2._dp
mat(1,2) = mat(1,2)+vS**2*Conjg(Lam6p)
mat(1,2) = mat(1,2)+(vu**2*Conjg(Lam7))/2._dp
mat(1,2) = mat(1,2)-Conjg(M12)
mat(1,2) = mat(1,2)+vS*Conjg(MU12)
...
Subroutine CalculateMFu(Yu,epsU,vd,vu,ZUL,ZUR,MFu,kont)
...
mat(1,1) = mat(1,1)+(vd*Yu(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(vu*epsU(2,1))/sqrt(2._dp)
mat(1,2) = mat(1,2)+(vd*Yu(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(vu*epsU(3,1))/sqrt(2._dp)
mat(1,3) = mat(1,3)+(vd*Yu(3,1))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(vu*epsU(1,2))/sqrt(2._dp)
mat(2,1) = mat(2,1)+(vd*Yu(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vu*epsU(2,2))/sqrt(2._dp)
mat(2,2) = mat(2,2)+(vd*Yu(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(vu*epsU(3,2))/sqrt(2._dp)
mat(2,3) = mat(2,3)+(vd*Yu(3,2))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(vu*epsU(1,3))/sqrt(2._dp)
mat(3,1) = mat(3,1)+(vd*Yu(1,3))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(vu*epsU(2,3))/sqrt(2._dp)
mat(3,2) = mat(3,2)+(vd*Yu(2,3))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vu*epsU(3,3))/sqrt(2._dp)
mat(3,3) = mat(3,3)+(vd*Yu(3,3))/sqrt(2._dp)
...
Subroutine CalculateMhhEffPot(MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,Lam1pp,           & 
& Lam4p,Lam6p,Lam7p,Lam5p,Lam2pp,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,           & 
& Lam3,Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,ZH,Mhh,Mhh2,kont)
...
Subroutine CalculateMAhEffPot(g1,g2,MSp,M12,MUS1,MU11,MU12,MU21,MU22,MUS2,            & 
& Lam1pp,Lam4p,Lam6p,Lam7p,Lam5p,Lam6,Lam5,Lam7,Lam3p,M112,M222,MS2,Lam1,Lam4,           & 
& Lam3,Lam2,Lam1p,Lam2p,Lam3pp,vd,vu,vS,TW,ZA,MAh,MAh2,kont)
...
Subroutine CalculateMHmEffPot(g2,M12,MU11,MU12,MU21,MU22,Lam4p,Lam6p,Lam7p,           & 
& Lam5p,Lam6,Lam5,Lam7,Lam3p,M112,M222,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,vd,               & 
...
Subroutine CalculateMFuEffPot(Yu,epsU,vd,vu,ZUL,ZUR,MFu,kont)
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,vd,vu,vS,g1,g2,g3,Lam1pp,Lam4p,Lam6p,Lam7p,           & 
...
End Module TreeLevelMasses_2HDMS 
