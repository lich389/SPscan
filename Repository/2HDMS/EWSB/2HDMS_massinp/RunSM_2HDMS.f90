...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,g2input,g3input,Lam1ppinput,              & 
...
& M112input,M222input,MS2input,vdinput,vuinput,vSinput,g1,g2,g3,Lam1pp,Lam4p,            & 
& Lam6p,Lam7p,Lam5p,Lam2pp,Lam6,Lam5,Lam7,Lam3p,Lam1,Lam4,Lam3,Lam2,Lam1p,               & 
& Lam2p,Lam3pp,Yu,epsU,Yd,Ye,epsD,epsE,MUS1,MU11,MU12,MU21,MU22,MUS2,MSp,M12,            & 
& M112,M222,MS2,vd,vu,vS,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(170), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG170(g1input,g2input,g3input,Lam1ppinput,Lam4pinput,Lam6pinput,      & 
...
& MS2input,vdinput,vuinput,vSinput,g1D)

Call GToParameters170(g1D,g1,g2,g3,Lam1pp,Lam4p,Lam6p,Lam7p,Lam5p,Lam2pp,             & 
