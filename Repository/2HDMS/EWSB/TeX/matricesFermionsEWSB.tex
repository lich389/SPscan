...
m_{d} = \left( 
\begin{array}{c}
\frac{1}{\sqrt{2}} \delta_{{\alpha_1} {\beta_1}} \Big(v_1 Y_{d}^{T}  + v_2 \epsilon_{d}^{T} \Big)\end{array} 
\right) 
 \end{equation} 
...
m_{u} = \left( 
\begin{array}{c}
\frac{1}{\sqrt{2}} \delta_{{\alpha_1} {\beta_1}} \Big(v_1 Y_{u}^{T}  + v_2 \epsilon_{u}^{T} \Big)\end{array} 
\right) 
 \end{equation} 
...
m_{e} = \left( 
\begin{array}{c}
\frac{1}{\sqrt{2}} \Big(v_1 Y_{e}^{T}  + v_2 \epsilon_{e}^{T} \Big)\end{array} 
\right) 
 \end{equation} 
