...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MFe,Mhh,MHm,MVWm,epsE,eta,g2,ZER,               & 
& vd,vu,ZEL,Ye,ZH,ZP,res)

Implicit None 
Real(dp),Intent(in) :: MFe(3),Mhh(6),MHm(2),MVWm,eta,g2,vd,vu,ZH(6,6),ZP(2,2)

Complex(dp),Intent(in) :: epsE(3,3),ZER(3,3),ZEL(3,3),Ye(3,3)

Real(dp) :: MFe2(3),Mhh2(6),MHm2(2),MVWm2

Complex(dp) :: cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),          & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),           & 
& cplhhcHmVWm(6,2),cplhhcVWmVWm(6)
...
End Module LoopCouplings_C2HDMS 
