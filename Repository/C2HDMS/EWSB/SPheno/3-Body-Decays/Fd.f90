...
Subroutine FdThreeBodyDecay(n_in,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,             & 
...
& mu22,mus2,M122,M112,M222,mS2,mSp2,vd,vu,vS,gThh,gTHm,gTVWm,gTVZ,gFdFdcFdFd,            & 
...
Call CouplingsFor_Fd_decays_3B(MFd(i_run),i_run,MFd,MFd2,MFe,MFe2,MFu,MFu2,           & 
...
gFdFdcFuFui = 0._dp 
Call FdToFdcFuFu(i_run,MFd,MFu,MVZ,MVWm,MHm,Mhh,cplcFdFdhhL,cplcFdFdhhR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
...
Real(dp),Intent(in) :: MFd(3),MVZ,Mhh(6)
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MVZ,Mhh(6)
...
Subroutine FdToFdcFuFu(iIN,MFd,MFu,MVZ,MVWm,MHm,Mhh,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVZL,cplcFuFuVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVWm,MHm(2),Mhh(6)
