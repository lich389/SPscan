...
Subroutine FuThreeBodyDecay(n_in,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,             & 
...
& mu22,mus2,M122,M112,M222,mS2,mSp2,vd,vu,vS,gThh,gTHm,gTVWm,gTVZ,gFuFucFdFd,            & 
& gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,gFuFucFvFv,epsI,deltaM,CheckRealStates,               & 
& gT,gPartial,BR)
...
Real(dp),Intent(in) :: gThh(6),gTHm(2),gTVWm,gTVZ

Real(dp) :: gFuFucFdFdi(3,3,3),gFuFdcFeFvi(3,3,3),gFuFucFeFei(3,3,3),gFuFucFuFui(3,3,3),          & 
& gFuFucFvFvi(3,3,3)

Real(dp) :: gThhtemp(6),gTHmtemp(2),gTVWmtemp,gTVZtemp
...
Call CouplingsFor_Fu_decays_3B(MFu(i_run),i_run,MFd,MFd2,MFe,MFe2,MFu,MFu2,           & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZH,ZP,              & 
& ZW,ZZ,betaH,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,L3pp,              & 
& L1pp,Lam4p,Lam6p,Lam7p,Lam5p,L2pp,Lam3p,Yu,epsU,Yd,Ye,epsD,epsE,mus1,mu11,             & 
& mu12,mu21,mu22,mus2,M122,M112,M222,mS2,mSp2,vd,vu,vS,cplcFdFdhhL,cplcFdFdhhR,          & 
...
gFuFucFdFdi = 0._dp 
Call FuToFucFdFd(i_run,MFu,MFd,MVZ,MVWm,MHm,Mhh,cplcFdFdhhL,cplcFdFdhhR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
...
& NVSss,NVSst,NVVss,NVVst,gTVZtemp,gTVWmtemp,gTHmtemp,gThhtemp,deltaM,epsI,              & 
& check,gFuFucFdFdi)
...
Subroutine FuToFucFdFd(iIN,MFu,MFd,MVZ,MVWm,MHm,Mhh,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVZL,cplcFuFuVZR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,               & 
& IntegralVSss,IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,               & 
& NVSss,NVSst,NVVss,NVVst,gTVZ,gTVWm,gTHm,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVWm,MHm(2),Mhh(6)
...
Real(dp),Intent(inout) :: gTVZ,gTVWm,gTHm(2),gThh(6)
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVZ,Mhh(6)
...
Real(dp),Intent(inout) :: gTVZ,gThh(6)
...
Real(dp),Intent(in) :: MFu(3),MVZ,Mhh(6)

Complex(dp),Intent(in) :: cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3)
