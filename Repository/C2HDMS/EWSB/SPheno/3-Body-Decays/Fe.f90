...
Subroutine FeThreeBodyDecay(n_in,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,             & 
...
& mu22,mus2,M122,M112,M222,mS2,mSp2,vd,vu,vS,gThh,gTHm,gTVWm,gTVZ,gFeFecFdFd,            & 
...
Call CouplingsFor_Fe_decays_3B(MFe(i_run),i_run,MFd,MFd2,MFe,MFe2,MFu,MFu2,           & 
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MVZ,Mhh(6)
...
Real(dp),Intent(in) :: MFe(3),MVZ,Mhh(6)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MVZ,Mhh(6)
