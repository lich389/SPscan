...
If (i_c.Eq.0) Lambda3ppInput= Cmplx(wert,Aimag(Lambda3ppInput),dp) 
If (i_c.Eq.1) Lambda3ppInput= Cmplx(Real(Lambda3ppInput,dp),wert,dp) 
Else If (i_par.Eq.7) Then 
If (i_c.Eq.0) Lambda1pInput= Cmplx(wert,Aimag(Lambda1pInput),dp) 
If (i_c.Eq.1) Lambda1pInput= Cmplx(Real(Lambda1pInput,dp),wert,dp) 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) Lambda2pInput= Cmplx(wert,Aimag(Lambda2pInput),dp) 
If (i_c.Eq.1) Lambda2pInput= Cmplx(Real(Lambda2pInput,dp),wert,dp) 
...
If (i_c.Eq.0) mSp2Input= Cmplx(wert,Aimag(mSp2Input),dp) 
If (i_c.Eq.1) mSp2Input= Cmplx(Real(mSp2Input,dp),wert,dp) 
...
If (i_c.Eq.0) zUrInput= Cmplx(wert,Aimag(zUrInput),dp) 
If (i_c.Eq.1) zUrInput= Cmplx(Real(zUrInput,dp),wert,dp) 
Else If (i_par.Eq.13) Then 
If (i_c.Eq.0) zDrInput= Cmplx(wert,Aimag(zDrInput),dp) 
If (i_c.Eq.1) zDrInput= Cmplx(Real(zDrInput,dp),wert,dp) 
Else If (i_par.Eq.14) Then 
If (i_c.Eq.0) zErInput= Cmplx(wert,Aimag(zErInput),dp) 
If (i_c.Eq.1) zErInput= Cmplx(Real(zErInput,dp),wert,dp) 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Lambda1pprInput= Cmplx(wert,Aimag(Lambda1pprInput),dp) 
If (i_c.Eq.1) Lambda1pprInput= Cmplx(Real(Lambda1pprInput,dp),wert,dp) 
Else If (i_par.Eq.2) Then 
If (i_c.Eq.0) Lambda2pprInput= Cmplx(wert,Aimag(Lambda2pprInput),dp) 
If (i_c.Eq.1) Lambda2pprInput= Cmplx(Real(Lambda2pprInput,dp),wert,dp) 
Else If (i_par.Eq.3) Then 
If (i_c.Eq.0) Lambda3prInput= Cmplx(wert,Aimag(Lambda3prInput),dp) 
If (i_c.Eq.1) Lambda3prInput= Cmplx(Real(Lambda3prInput,dp),wert,dp) 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) Lambda4prInput= Cmplx(wert,Aimag(Lambda4prInput),dp) 
If (i_c.Eq.1) Lambda4prInput= Cmplx(Real(Lambda4prInput,dp),wert,dp) 
Else If (i_par.Eq.5) Then 
If (i_c.Eq.0) Lambda5prInput= Cmplx(wert,Aimag(Lambda5prInput),dp) 
If (i_c.Eq.1) Lambda5prInput= Cmplx(Real(Lambda5prInput,dp),wert,dp) 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) Lambda6prInput= Cmplx(wert,Aimag(Lambda6prInput),dp) 
If (i_c.Eq.1) Lambda6prInput= Cmplx(Real(Lambda6prInput,dp),wert,dp) 
Else If (i_par.Eq.7) Then 
If (i_c.Eq.0) Lambda7prInput= Cmplx(wert,Aimag(Lambda7prInput),dp) 
If (i_c.Eq.1) Lambda7prInput= Cmplx(Real(Lambda7prInput,dp),wert,dp) 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) Lambda5rInput= Cmplx(wert,Aimag(Lambda5rInput),dp) 
If (i_c.Eq.1) Lambda5rInput= Cmplx(Real(Lambda5rInput,dp),wert,dp) 
Else If (i_par.Eq.9) Then 
If (i_c.Eq.0) Lambda6rInput= Cmplx(wert,Aimag(Lambda6rInput),dp) 
If (i_c.Eq.1) Lambda6rInput= Cmplx(Real(Lambda6rInput,dp),wert,dp) 
Else If (i_par.Eq.10) Then 
If (i_c.Eq.0) Lambda7rInput= Cmplx(wert,Aimag(Lambda7rInput),dp) 
If (i_c.Eq.1) Lambda7rInput= Cmplx(Real(Lambda7rInput,dp),wert,dp) 
Else If (i_par.Eq.11) Then 
If (i_c.Eq.0) Lambda1ppiInput= Cmplx(wert,Aimag(Lambda1ppiInput),dp) 
If (i_c.Eq.1) Lambda1ppiInput= Cmplx(Real(Lambda1ppiInput,dp),wert,dp) 
Else If (i_par.Eq.12) Then 
If (i_c.Eq.0) Lambda2ppiInput= Cmplx(wert,Aimag(Lambda2ppiInput),dp) 
If (i_c.Eq.1) Lambda2ppiInput= Cmplx(Real(Lambda2ppiInput,dp),wert,dp) 
Else If (i_par.Eq.13) Then 
If (i_c.Eq.0) Lambda3piInput= Cmplx(wert,Aimag(Lambda3piInput),dp) 
If (i_c.Eq.1) Lambda3piInput= Cmplx(Real(Lambda3piInput,dp),wert,dp) 
Else If (i_par.Eq.14) Then 
If (i_c.Eq.0) Lambda4piInput= Cmplx(wert,Aimag(Lambda4piInput),dp) 
If (i_c.Eq.1) Lambda4piInput= Cmplx(Real(Lambda4piInput,dp),wert,dp) 
Else If (i_par.Eq.15) Then 
If (i_c.Eq.0) Lambda5piInput= Cmplx(wert,Aimag(Lambda5piInput),dp) 
If (i_c.Eq.1) Lambda5piInput= Cmplx(Real(Lambda5piInput,dp),wert,dp) 
Else If (i_par.Eq.16) Then 
If (i_c.Eq.0) Lambda6piInput= Cmplx(wert,Aimag(Lambda6piInput),dp) 
If (i_c.Eq.1) Lambda6piInput= Cmplx(Real(Lambda6piInput,dp),wert,dp) 
Else If (i_par.Eq.17) Then 
If (i_c.Eq.0) Lambda7piInput= Cmplx(wert,Aimag(Lambda7piInput),dp) 
If (i_c.Eq.1) Lambda7piInput= Cmplx(Real(Lambda7piInput,dp),wert,dp) 
Else If (i_par.Eq.18) Then 
If (i_c.Eq.0) Lambda5iInput= Cmplx(wert,Aimag(Lambda5iInput),dp) 
If (i_c.Eq.1) Lambda5iInput= Cmplx(Real(Lambda5iInput,dp),wert,dp) 
Else If (i_par.Eq.19) Then 
If (i_c.Eq.0) Lambda6iInput= Cmplx(wert,Aimag(Lambda6iInput),dp) 
If (i_c.Eq.1) Lambda6iInput= Cmplx(Real(Lambda6iInput,dp),wert,dp) 
Else If (i_par.Eq.20) Then 
If (i_c.Eq.0) Lambda7iInput= Cmplx(wert,Aimag(Lambda7iInput),dp) 
If (i_c.Eq.1) Lambda7iInput= Cmplx(Real(Lambda7iInput,dp),wert,dp) 
Else If (i_par.Eq.21) Then 
If (i_c.Eq.0) mu11rInput= Cmplx(wert,Aimag(mu11rInput),dp) 
If (i_c.Eq.1) mu11rInput= Cmplx(Real(mu11rInput,dp),wert,dp) 
Else If (i_par.Eq.22) Then 
If (i_c.Eq.0) mu12rInput= Cmplx(wert,Aimag(mu12rInput),dp) 
If (i_c.Eq.1) mu12rInput= Cmplx(Real(mu12rInput,dp),wert,dp) 
Else If (i_par.Eq.23) Then 
If (i_c.Eq.0) mu21rInput= Cmplx(wert,Aimag(mu21rInput),dp) 
If (i_c.Eq.1) mu21rInput= Cmplx(Real(mu21rInput,dp),wert,dp) 
Else If (i_par.Eq.24) Then 
If (i_c.Eq.0) mu22rInput= Cmplx(wert,Aimag(mu22rInput),dp) 
If (i_c.Eq.1) mu22rInput= Cmplx(Real(mu22rInput,dp),wert,dp) 
Else If (i_par.Eq.25) Then 
If (i_c.Eq.0) mus1rInput= Cmplx(wert,Aimag(mus1rInput),dp) 
If (i_c.Eq.1) mus1rInput= Cmplx(Real(mus1rInput,dp),wert,dp) 
Else If (i_par.Eq.26) Then 
If (i_c.Eq.0) mus2rInput= Cmplx(wert,Aimag(mus2rInput),dp) 
If (i_c.Eq.1) mus2rInput= Cmplx(Real(mus2rInput,dp),wert,dp) 
Else If (i_par.Eq.31) Then 
If (i_c.Eq.0) mu11iInput= Cmplx(wert,Aimag(mu11iInput),dp) 
If (i_c.Eq.1) mu11iInput= Cmplx(Real(mu11iInput,dp),wert,dp) 
Else If (i_par.Eq.32) Then 
If (i_c.Eq.0) mu12iInput= Cmplx(wert,Aimag(mu12iInput),dp) 
If (i_c.Eq.1) mu12iInput= Cmplx(Real(mu12iInput,dp),wert,dp) 
Else If (i_par.Eq.33) Then 
If (i_c.Eq.0) mu21iInput= Cmplx(wert,Aimag(mu21iInput),dp) 
If (i_c.Eq.1) mu21iInput= Cmplx(Real(mu21iInput,dp),wert,dp) 
Else If (i_par.Eq.34) Then 
If (i_c.Eq.0) mu22iInput= Cmplx(wert,Aimag(mu22iInput),dp) 
If (i_c.Eq.1) mu22iInput= Cmplx(Real(mu22iInput,dp),wert,dp) 
Else If (i_par.Eq.35) Then 
If (i_c.Eq.0) mus1iInput= Cmplx(wert,Aimag(mus1iInput),dp) 
If (i_c.Eq.1) mus1iInput= Cmplx(Real(mus1iInput,dp),wert,dp) 
Else If (i_par.Eq.36) Then 
If (i_c.Eq.0) mus2iInput= Cmplx(wert,Aimag(mus2iInput),dp) 
If (i_c.Eq.1) mus2iInput= Cmplx(Real(mus2iInput,dp),wert,dp) 
Else If (i_par.Eq.41) Then 
If (i_c.Eq.0) zUiInput= Cmplx(wert,Aimag(zUiInput),dp) 
If (i_c.Eq.1) zUiInput= Cmplx(Real(zUiInput,dp),wert,dp) 
Else If (i_par.Eq.42) Then 
If (i_c.Eq.0) zDiInput= Cmplx(wert,Aimag(zDiInput),dp) 
If (i_c.Eq.1) zDiInput= Cmplx(Real(zDiInput,dp),wert,dp) 
Else If (i_par.Eq.43) Then 
If (i_c.Eq.0) zEiInput= Cmplx(wert,Aimag(zEiInput),dp) 
If (i_c.Eq.1) zEiInput= Cmplx(Real(zEiInput,dp),wert,dp) 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
...
Complex(dp) :: PDGhh(6),PDGHm(2),PDGVP,PDGVZ,PDGVG,PDGVWm,PDGgP,PDGgWm,PDGgWmC,PDGgZ,PDGgG,          & 
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - C2HDMS Spectrum + Decays + Flavour Observables"
...
Write(io_L,101) 6, Real(Lambda3ppInput,dp) ,"# Lambda3ppInput"
Write(io_L,101) 7, Real(Lambda1pInput,dp) ,"# Lambda1pInput"
Write(io_L,101) 8, Real(Lambda2pInput,dp) ,"# Lambda2pInput"
Write(io_L,101) 5, Real(M122Input,dp) ,"# M122Input"
Write(io_L,101) 9, Real(mSp2Input,dp) ,"# mSp2Input"
Write(io_L,101) 10, Real(TanBeta,dp) ,"# TanBeta"
Write(io_L,101) 11, Real(vSInput,dp) ,"# vSInput"
Write(io_L,101) 12, Real(zUrInput,dp) ,"# zUrInput"
Write(io_L,101) 13, Real(zDrInput,dp) ,"# zDrInput"
Write(io_L,101) 14, Real(zErInput,dp) ,"# zErInput"
Write(io_L,101) 15, Real(etaInput,dp) ,"# etaInput"
Write(io_L,101) 16, Real(zetaInput,dp) ,"# zetaInput"
...
If (Abs(Aimag(Lambda3ppInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda1pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda2pInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(M122Input)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mSp2Input)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vSInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zUrInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zDrInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zErInput)).gt.0._dp) WriteNextBlock = .True. 
...
End if 
If (Abs(Aimag(Lambda3ppInput)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(Lambda3ppInput) ,"# Lambda3ppInput"
End if 
If (Abs(Aimag(Lambda1pInput)).gt.0._dp) Then 
Write(io_L,101) 7, Aimag(Lambda1pInput) ,"# Lambda1pInput"
End if 
If (Abs(Aimag(Lambda2pInput)).gt.0._dp) Then 
Write(io_L,101) 8, Aimag(Lambda2pInput) ,"# Lambda2pInput"
End if 
If (Abs(Aimag(M122Input)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(M122Input) ,"# M122Input"
End if 
If (Abs(Aimag(mSp2Input)).gt.0._dp) Then 
Write(io_L,101) 9, Aimag(mSp2Input) ,"# mSp2Input"
End if 
If (Abs(Aimag(vSInput)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(vSInput) ,"# vSInput"
End if 
If (Abs(Aimag(zUrInput)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(zUrInput) ,"# zUrInput"
End if 
If (Abs(Aimag(zDrInput)).gt.0._dp) Then 
Write(io_L,101) 13, Aimag(zDrInput) ,"# zDrInput"
End if 
If (Abs(Aimag(zErInput)).gt.0._dp) Then 
Write(io_L,101) 14, Aimag(zErInput) ,"# zErInput"
End if 
End if 
WriteNextBlock = .false. 
If (Abs(Real(Lambda1pprInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda2pprInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda3prInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda4prInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda5prInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda6prInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda7prInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda5rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda6rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda7rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda1ppiInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda2ppiInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda3piInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda4piInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda5piInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda6piInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda7piInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda5iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda6iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(Lambda7iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu11rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu12rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu21rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu22rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mus1rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mus2rInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu11iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu12iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu21iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mu22iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mus1iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(mus2iInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(zUiInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(zDiInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Real(zEiInput,dp)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,100) "Block EXTPAR  # Input parameters"
If (Abs(Real(Lambda1pprInput,dp)).gt.0._dp) Then 
Write(io_L,101) 1, Real(Lambda1pprInput,dp) ,"# Lambda1pprInput"
End if 
If (Abs(Real(Lambda2pprInput,dp)).gt.0._dp) Then 
Write(io_L,101) 2, Real(Lambda2pprInput,dp) ,"# Lambda2pprInput"
End if 
If (Abs(Real(Lambda3prInput,dp)).gt.0._dp) Then 
Write(io_L,101) 3, Real(Lambda3prInput,dp) ,"# Lambda3prInput"
End if 
If (Abs(Real(Lambda4prInput,dp)).gt.0._dp) Then 
Write(io_L,101) 4, Real(Lambda4prInput,dp) ,"# Lambda4prInput"
End if 
If (Abs(Real(Lambda5prInput,dp)).gt.0._dp) Then 
Write(io_L,101) 5, Real(Lambda5prInput,dp) ,"# Lambda5prInput"
End if 
If (Abs(Real(Lambda6prInput,dp)).gt.0._dp) Then 
Write(io_L,101) 6, Real(Lambda6prInput,dp) ,"# Lambda6prInput"
End if 
If (Abs(Real(Lambda7prInput,dp)).gt.0._dp) Then 
Write(io_L,101) 7, Real(Lambda7prInput,dp) ,"# Lambda7prInput"
End if 
If (Abs(Real(Lambda5rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 8, Real(Lambda5rInput,dp) ,"# Lambda5rInput"
End if 
If (Abs(Real(Lambda6rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 9, Real(Lambda6rInput,dp) ,"# Lambda6rInput"
End if 
If (Abs(Real(Lambda7rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 10, Real(Lambda7rInput,dp) ,"# Lambda7rInput"
End if 
If (Abs(Real(Lambda1ppiInput,dp)).gt.0._dp) Then 
Write(io_L,101) 11, Real(Lambda1ppiInput,dp) ,"# Lambda1ppiInput"
End if 
If (Abs(Real(Lambda2ppiInput,dp)).gt.0._dp) Then 
Write(io_L,101) 12, Real(Lambda2ppiInput,dp) ,"# Lambda2ppiInput"
End if 
If (Abs(Real(Lambda3piInput,dp)).gt.0._dp) Then 
Write(io_L,101) 13, Real(Lambda3piInput,dp) ,"# Lambda3piInput"
End if 
If (Abs(Real(Lambda4piInput,dp)).gt.0._dp) Then 
Write(io_L,101) 14, Real(Lambda4piInput,dp) ,"# Lambda4piInput"
End if 
If (Abs(Real(Lambda5piInput,dp)).gt.0._dp) Then 
Write(io_L,101) 15, Real(Lambda5piInput,dp) ,"# Lambda5piInput"
End if 
If (Abs(Real(Lambda6piInput,dp)).gt.0._dp) Then 
Write(io_L,101) 16, Real(Lambda6piInput,dp) ,"# Lambda6piInput"
End if 
If (Abs(Real(Lambda7piInput,dp)).gt.0._dp) Then 
Write(io_L,101) 17, Real(Lambda7piInput,dp) ,"# Lambda7piInput"
End if 
If (Abs(Real(Lambda5iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 18, Real(Lambda5iInput,dp) ,"# Lambda5iInput"
End if 
If (Abs(Real(Lambda6iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 19, Real(Lambda6iInput,dp) ,"# Lambda6iInput"
End if 
If (Abs(Real(Lambda7iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 20, Real(Lambda7iInput,dp) ,"# Lambda7iInput"
End if 
If (Abs(Real(mu11rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 21, Real(mu11rInput,dp) ,"# mu11rInput"
End if 
If (Abs(Real(mu12rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 22, Real(mu12rInput,dp) ,"# mu12rInput"
End if 
If (Abs(Real(mu21rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 23, Real(mu21rInput,dp) ,"# mu21rInput"
End if 
If (Abs(Real(mu22rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 24, Real(mu22rInput,dp) ,"# mu22rInput"
End if 
If (Abs(Real(mus1rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 25, Real(mus1rInput,dp) ,"# mus1rInput"
End if 
If (Abs(Real(mus2rInput,dp)).gt.0._dp) Then 
Write(io_L,101) 26, Real(mus2rInput,dp) ,"# mus2rInput"
End if 
If (Abs(Real(mu11iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 31, Real(mu11iInput,dp) ,"# mu11iInput"
End if 
If (Abs(Real(mu12iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 32, Real(mu12iInput,dp) ,"# mu12iInput"
End if 
If (Abs(Real(mu21iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 33, Real(mu21iInput,dp) ,"# mu21iInput"
End if 
If (Abs(Real(mu22iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 34, Real(mu22iInput,dp) ,"# mu22iInput"
End if 
If (Abs(Real(mus1iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 35, Real(mus1iInput,dp) ,"# mus1iInput"
End if 
If (Abs(Real(mus2iInput,dp)).gt.0._dp) Then 
Write(io_L,101) 36, Real(mus2iInput,dp) ,"# mus2iInput"
End if 
If (Abs(Real(zUiInput,dp)).gt.0._dp) Then 
Write(io_L,101) 41, Real(zUiInput,dp) ,"# zUiInput"
End if 
If (Abs(Real(zDiInput,dp)).gt.0._dp) Then 
Write(io_L,101) 42, Real(zDiInput,dp) ,"# zDiInput"
End if 
If (Abs(Real(zEiInput,dp)).gt.0._dp) Then 
Write(io_L,101) 43, Real(zEiInput,dp) ,"# zEiInput"
End if 
End if 
WriteNextBlock = .false. 
If (Abs(Aimag(Lambda1pprInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda2pprInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda3prInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda4prInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda5prInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda6prInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda7prInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda5rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda6rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda7rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda1ppiInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda2ppiInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda3piInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda4piInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda5piInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda6piInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda7piInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda5iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda6iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Lambda7iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu11rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu12rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu21rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu22rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mus1rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mus2rInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu11iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu12iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu21iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mu22iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mus1iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(mus2iInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zUiInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zDiInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(zEiInput)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,100) "Block IMEXTPAR  # Input parameters"
If (Abs(Aimag(Lambda1pprInput)).gt.0._dp) Then 
Write(io_L,101) 1, Aimag(Lambda1pprInput) ,"# Lambda1pprInput"
End if 
If (Abs(Aimag(Lambda2pprInput)).gt.0._dp) Then 
Write(io_L,101) 2, Aimag(Lambda2pprInput) ,"# Lambda2pprInput"
End if 
If (Abs(Aimag(Lambda3prInput)).gt.0._dp) Then 
Write(io_L,101) 3, Aimag(Lambda3prInput) ,"# Lambda3prInput"
End if 
If (Abs(Aimag(Lambda4prInput)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(Lambda4prInput) ,"# Lambda4prInput"
End if 
If (Abs(Aimag(Lambda5prInput)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(Lambda5prInput) ,"# Lambda5prInput"
End if 
If (Abs(Aimag(Lambda6prInput)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(Lambda6prInput) ,"# Lambda6prInput"
End if 
If (Abs(Aimag(Lambda7prInput)).gt.0._dp) Then 
Write(io_L,101) 7, Aimag(Lambda7prInput) ,"# Lambda7prInput"
End if 
If (Abs(Aimag(Lambda5rInput)).gt.0._dp) Then 
Write(io_L,101) 8, Aimag(Lambda5rInput) ,"# Lambda5rInput"
End if 
If (Abs(Aimag(Lambda6rInput)).gt.0._dp) Then 
Write(io_L,101) 9, Aimag(Lambda6rInput) ,"# Lambda6rInput"
End if 
If (Abs(Aimag(Lambda7rInput)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(Lambda7rInput) ,"# Lambda7rInput"
End if 
If (Abs(Aimag(Lambda1ppiInput)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(Lambda1ppiInput) ,"# Lambda1ppiInput"
End if 
If (Abs(Aimag(Lambda2ppiInput)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(Lambda2ppiInput) ,"# Lambda2ppiInput"
End if 
If (Abs(Aimag(Lambda3piInput)).gt.0._dp) Then 
Write(io_L,101) 13, Aimag(Lambda3piInput) ,"# Lambda3piInput"
End if 
If (Abs(Aimag(Lambda4piInput)).gt.0._dp) Then 
Write(io_L,101) 14, Aimag(Lambda4piInput) ,"# Lambda4piInput"
End if 
If (Abs(Aimag(Lambda5piInput)).gt.0._dp) Then 
Write(io_L,101) 15, Aimag(Lambda5piInput) ,"# Lambda5piInput"
End if 
If (Abs(Aimag(Lambda6piInput)).gt.0._dp) Then 
Write(io_L,101) 16, Aimag(Lambda6piInput) ,"# Lambda6piInput"
End if 
If (Abs(Aimag(Lambda7piInput)).gt.0._dp) Then 
Write(io_L,101) 17, Aimag(Lambda7piInput) ,"# Lambda7piInput"
End if 
If (Abs(Aimag(Lambda5iInput)).gt.0._dp) Then 
Write(io_L,101) 18, Aimag(Lambda5iInput) ,"# Lambda5iInput"
End if 
If (Abs(Aimag(Lambda6iInput)).gt.0._dp) Then 
Write(io_L,101) 19, Aimag(Lambda6iInput) ,"# Lambda6iInput"
End if 
If (Abs(Aimag(Lambda7iInput)).gt.0._dp) Then 
Write(io_L,101) 20, Aimag(Lambda7iInput) ,"# Lambda7iInput"
End if 
If (Abs(Aimag(mu11rInput)).gt.0._dp) Then 
Write(io_L,101) 21, Aimag(mu11rInput) ,"# mu11rInput"
End if 
If (Abs(Aimag(mu12rInput)).gt.0._dp) Then 
Write(io_L,101) 22, Aimag(mu12rInput) ,"# mu12rInput"
End if 
If (Abs(Aimag(mu21rInput)).gt.0._dp) Then 
Write(io_L,101) 23, Aimag(mu21rInput) ,"# mu21rInput"
End if 
If (Abs(Aimag(mu22rInput)).gt.0._dp) Then 
Write(io_L,101) 24, Aimag(mu22rInput) ,"# mu22rInput"
End if 
If (Abs(Aimag(mus1rInput)).gt.0._dp) Then 
Write(io_L,101) 25, Aimag(mus1rInput) ,"# mus1rInput"
End if 
If (Abs(Aimag(mus2rInput)).gt.0._dp) Then 
Write(io_L,101) 26, Aimag(mus2rInput) ,"# mus2rInput"
End if 
If (Abs(Aimag(mu11iInput)).gt.0._dp) Then 
Write(io_L,101) 31, Aimag(mu11iInput) ,"# mu11iInput"
End if 
If (Abs(Aimag(mu12iInput)).gt.0._dp) Then 
Write(io_L,101) 32, Aimag(mu12iInput) ,"# mu12iInput"
End if 
If (Abs(Aimag(mu21iInput)).gt.0._dp) Then 
Write(io_L,101) 33, Aimag(mu21iInput) ,"# mu21iInput"
End if 
If (Abs(Aimag(mu22iInput)).gt.0._dp) Then 
Write(io_L,101) 34, Aimag(mu22iInput) ,"# mu22iInput"
End if 
If (Abs(Aimag(mus1iInput)).gt.0._dp) Then 
Write(io_L,101) 35, Aimag(mus1iInput) ,"# mus1iInput"
End if 
If (Abs(Aimag(mus2iInput)).gt.0._dp) Then 
Write(io_L,101) 36, Aimag(mus2iInput) ,"# mus2iInput"
End if 
If (Abs(Aimag(zUiInput)).gt.0._dp) Then 
Write(io_L,101) 41, Aimag(zUiInput) ,"# zUiInput"
End if 
If (Abs(Aimag(zDiInput)).gt.0._dp) Then 
Write(io_L,101) 42, Aimag(zDiInput) ,"# zDiInput"
End if 
If (Abs(Aimag(zEiInput)).gt.0._dp) Then 
Write(io_L,101) 43, Aimag(zEiInput) ,"# zEiInput"
End if 
End if 
...
Write(io_L,104) 41,Real(Lam1p,dp), "# Lam1p" 
Write(io_L,104) 42,Real(Lam2p,dp), "# Lam2p" 
Write(io_L,104) 40,Real(L3pp,dp), "# L3pp" 
Write(io_L,104) 38,Real(L1pp,dp), "# L1pp" 
If (Abs(Aimag(L1pp)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 44,Real(Lam4p,dp), "# Lam4p" 
If (Abs(Aimag(Lam4p)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 46,Real(Lam6p,dp), "# Lam6p" 
If (Abs(Aimag(Lam6p)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 47,Real(Lam7p,dp), "# Lam7p" 
If (Abs(Aimag(Lam7p)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 45,Real(Lam5p,dp), "# Lam5p" 
If (Abs(Aimag(Lam5p)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 39,Real(L2pp,dp), "# L2pp" 
If (Abs(Aimag(L2pp)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 43,Real(Lam3p,dp), "# Lam3p" 
If (Abs(Aimag(Lam3p)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 52,Real(mus1,dp), "# mus1" 
If (Abs(Aimag(mus1)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 48,Real(mu11,dp), "# mu11" 
If (Abs(Aimag(mu11)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 50,Real(mu12,dp), "# mu12" 
If (Abs(Aimag(mu12)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 51,Real(mu21,dp), "# mu21" 
If (Abs(Aimag(mu21)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 49,Real(mu22,dp), "# mu22" 
If (Abs(Aimag(mu22)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 53,Real(mus2,dp), "# mus2" 
...
Write(io_L,104) 24,Real(mSp2,dp), "# mSp2" 
If (Abs(Aimag(mSp2)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 102,Real(vd,dp), "# vd" 
Write(io_L,104) 103,Real(vu,dp), "# vu" 
Write(io_L,104) 500,Real(eta,dp), "# eta" 
Write(io_L,104) 501,Real(zeta,dp), "# zeta" 
...
Write(io_L,104) 38,Aimag(L1pp), "# L1pp" 
Write(io_L,104) 44,Aimag(Lam4p), "# Lam4p" 
Write(io_L,104) 46,Aimag(Lam6p), "# Lam6p" 
Write(io_L,104) 47,Aimag(Lam7p), "# Lam7p" 
Write(io_L,104) 45,Aimag(Lam5p), "# Lam5p" 
Write(io_L,104) 39,Aimag(L2pp), "# L2pp" 
Write(io_L,104) 43,Aimag(Lam3p), "# Lam3p" 
Write(io_L,104) 52,Aimag(mus1), "# mus1" 
Write(io_L,104) 48,Aimag(mu11), "# mu11" 
Write(io_L,104) 50,Aimag(mu12), "# mu12" 
Write(io_L,104) 51,Aimag(mu21), "# mu21" 
Write(io_L,104) 49,Aimag(mu22), "# mu22" 
Write(io_L,104) 53,Aimag(mus2), "# mus2" 
Write(io_L,104) 22,Aimag(M122), "# M122" 
Write(io_L,104) 24,Aimag(mSp2), "# mSp2" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 1,Real(exp((0._dp,1._dp)*eta),dp), "# exp((0._dp,1._dp)*eta)" 
If (Abs(Aimag(exp((0._dp,1._dp)*eta))).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 2,Real(exp((0._dp,1._dp)*zeta),dp), "# exp((0._dp,1._dp)*zeta)" 
If (Abs(Aimag(exp((0._dp,1._dp)*zeta))).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMMixedBlock Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Aimag(exp((0._dp,1._dp)*eta)), "# exp((0._dp,1._dp)*eta)" 
Write(io_L,104) 2,Aimag(exp((0._dp,1._dp)*zeta)), "# exp((0._dp,1._dp)*zeta)" 
End if 
...
Write(io_L,104) 22,Real(M122Tree,dp), "# M122" 
If (Abs(Aimag(M122Tree)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 20,Real(M112Tree,dp), "# M112" 
Write(io_L,104) 21,Real(M222Tree,dp), "# M222" 
Write(io_L,104) 23,Real(mS2Tree,dp), "# mS2" 
Write(io_L,104) 24,Real(mSp2Tree,dp), "# mSp2" 
If (Abs(Aimag(mSp2Tree)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block TREEIMHMIX Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 22,Aimag(M122Tree), "# M122" 
Write(io_L,104) 24,Aimag(mSp2Tree), "# mSp2" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LOOPHMIX Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 22,Real(M1221L,dp), "# M122" 
If (Abs(Aimag(M1221L)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 20,Real(M1121L,dp), "# M112" 
Write(io_L,104) 21,Real(M2221L,dp), "# M222" 
Write(io_L,104) 23,Real(mS21L,dp), "# mS2" 
Write(io_L,104) 24,Real(mSp21L,dp), "# mSp2" 
If (Abs(Aimag(mSp21L)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block LOOPIMHMIX Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 22,Aimag(M1221L), "# M122" 
Write(io_L,104) 24,Aimag(mSp21L), "# mSp2" 
End if 
Else 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 41,Real(Lam1pGUT,dp), "# Lam1p" 
Write(io_L,104) 42,Real(Lam2pGUT,dp), "# Lam2p" 
Write(io_L,104) 40,Real(L3ppGUT,dp), "# L3pp" 
Write(io_L,104) 38,Real(L1ppGUT,dp), "# L1pp" 
Write(io_L,104) 44,Real(Lam4pGUT,dp), "# Lam4p" 
Write(io_L,104) 46,Real(Lam6pGUT,dp), "# Lam6p" 
Write(io_L,104) 47,Real(Lam7pGUT,dp), "# Lam7p" 
Write(io_L,104) 45,Real(Lam5pGUT,dp), "# Lam5p" 
Write(io_L,104) 39,Real(L2ppGUT,dp), "# L2pp" 
Write(io_L,104) 43,Real(Lam3pGUT,dp), "# Lam3p" 
Write(io_L,104) 52,Real(mus1GUT,dp), "# mus1" 
Write(io_L,104) 48,Real(mu11GUT,dp), "# mu11" 
Write(io_L,104) 50,Real(mu12GUT,dp), "# mu12" 
Write(io_L,104) 51,Real(mu21GUT,dp), "# mu21" 
Write(io_L,104) 49,Real(mu22GUT,dp), "# mu22" 
Write(io_L,104) 53,Real(mus2GUT,dp), "# mus2" 
...
Write(io_L,104) 24,Real(mSp2GUT,dp), "# mSp2" 
...
Write(io_L,104) 1, Abs(eta), "# eta "  
Write(io_L,104) 2, Abs(zeta), "# zeta "  
MassLSP = 100000._dp 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(2)**2+mass_uncertainty_Yt(2)**2),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(35)), Sqrt(mass_uncertainty_Q(3)**2+mass_uncertainty_Yt(3)**2),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), Sqrt(mass_uncertainty_Q(4)**2+mass_uncertainty_Yt(4)**2),"# Mhh(4) " 
 Write(io_L,102) INT(Abs(45)), Sqrt(mass_uncertainty_Q(5)**2+mass_uncertainty_Yt(5)**2),"# Mhh(5) " 
 Write(io_L,102) INT(Abs(46)), Sqrt(mass_uncertainty_Q(6)**2+mass_uncertainty_Yt(6)**2),"# Mhh(6) " 
...
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(2),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Q(3),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Q(4),"# Mhh(4) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Q(5),"# Mhh(5) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Q(6),"# Mhh(6) " 
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Q(8),"# MHm(2) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(2),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Yt(3),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Yt(4),"# Mhh(4) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Yt(5),"# Mhh(5) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Yt(6),"# Mhh(6) " 
...
Write(io_L,1101) rHB_S_S_Fd(2,3),rHB_S_P_Fd(2,3), 3 ,25,5,5, " # h_2 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(2,2),rHB_S_P_Fd(2,2), 3 ,25,3,3, " # h_2 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(2,3),rHB_S_P_Fu(2,3), 3 ,25,6,6, " # h_2 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(2,2),rHB_S_P_Fu(2,2),3 ,25,4,4, " # h_2 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(2,3),rHB_S_P_Fe(2,3), 3 ,25,15,15, " # h_2 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(2,2),rHB_S_P_Fe(2,2), 3 ,25,13,13, " # h_2 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(3,3),rHB_S_P_Fd(3,3), 3 ,35,5,5, " # h_3 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(3,2),rHB_S_P_Fd(3,2), 3 ,35,3,3, " # h_3 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(3,3),rHB_S_P_Fu(3,3), 3 ,35,6,6, " # h_3 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(3,2),rHB_S_P_Fu(3,2),3 ,35,4,4, " # h_3 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(3,3),rHB_S_P_Fe(3,3), 3 ,35,15,15, " # h_3 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(3,2),rHB_S_P_Fe(3,2), 3 ,35,13,13, " # h_3 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(4,3),rHB_S_P_Fd(4,3), 3 ,36,5,5, " # h_4 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(4,2),rHB_S_P_Fd(4,2), 3 ,36,3,3, " # h_4 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(4,3),rHB_S_P_Fu(4,3), 3 ,36,6,6, " # h_4 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(4,2),rHB_S_P_Fu(4,2),3 ,36,4,4, " # h_4 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(4,3),rHB_S_P_Fe(4,3), 3 ,36,15,15, " # h_4 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(4,2),rHB_S_P_Fe(4,2), 3 ,36,13,13, " # h_4 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(5,3),rHB_S_P_Fd(5,3), 3 ,45,5,5, " # h_5 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(5,2),rHB_S_P_Fd(5,2), 3 ,45,3,3, " # h_5 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(5,3),rHB_S_P_Fu(5,3), 3 ,45,6,6, " # h_5 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(5,2),rHB_S_P_Fu(5,2),3 ,45,4,4, " # h_5 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(5,3),rHB_S_P_Fe(5,3), 3 ,45,15,15, " # h_5 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(5,2),rHB_S_P_Fe(5,2), 3 ,45,13,13, " # h_5 mu mu coupling  " 
Write(io_L,1101) rHB_S_S_Fd(6,3),rHB_S_P_Fd(6,3), 3 ,46,5,5, " # h_6 b b coupling " 
Write(io_L,1101) rHB_S_S_Fd(6,2),rHB_S_P_Fd(6,2), 3 ,46,3,3, " # h_6 s s coupling " 
Write(io_L,1101) rHB_S_S_Fu(6,3),rHB_S_P_Fu(6,3), 3 ,46,6,6, " # h_6 t t coupling  " 
Write(io_L,1101) rHB_S_S_Fu(6,2),rHB_S_P_Fu(6,2),3 ,46,4,4, " # h_6 c c coupling " 
Write(io_L,1101) rHB_S_S_Fe(6,3),rHB_S_P_Fe(6,3), 3 ,46,15,15, " # h_6 tau tau coupling " 
Write(io_L,1101) rHB_S_S_Fe(6,2),rHB_S_P_Fe(6,2), 3 ,46,13,13, " # h_6 mu mu coupling  " 
Write(io_L,100) "Block HiggsCouplingsBosons # " 
Write(io_L,1102) rHB_S_VWm(2),3 ,25,24,24, " # h_2 W W coupling " 
Write(io_L,1102) rHB_S_VZ(2),3 ,25,23,23, " # h_2 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,25,23,22, " # h_2 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(2),dp),3 ,25,22,22, " # h_2 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(2),dp),3 ,25,21,21, " # h_2 g g coupling " 
Write(io_L,1103) 0._dp,4 ,25,21,21,23, " # h_2 g g Z coupling " 
Write(io_L,1102) rHB_S_VWm(3),3 ,35,24,24, " # h_3 W W coupling " 
Write(io_L,1102) rHB_S_VZ(3),3 ,35,23,23, " # h_3 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,35,23,22, " # h_3 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(3),dp),3 ,35,22,22, " # h_3 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(3),dp),3 ,35,21,21, " # h_3 g g coupling " 
Write(io_L,1103) 0._dp,4 ,35,21,21,23, " # h_3 g g Z coupling " 
Write(io_L,1102) rHB_S_VWm(4),3 ,36,24,24, " # h_4 W W coupling " 
Write(io_L,1102) rHB_S_VZ(4),3 ,36,23,23, " # h_4 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,36,23,22, " # h_4 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(4),dp),3 ,36,22,22, " # h_4 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(4),dp),3 ,36,21,21, " # h_4 g g coupling " 
Write(io_L,1103) 0._dp,4 ,36,21,21,23, " # h_4 g g Z coupling " 
Write(io_L,1102) rHB_S_VWm(5),3 ,45,24,24, " # h_5 W W coupling " 
Write(io_L,1102) rHB_S_VZ(5),3 ,45,23,23, " # h_5 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,45,23,22, " # h_5 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(5),dp),3 ,45,22,22, " # h_5 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(5),dp),3 ,45,21,21, " # h_5 g g coupling " 
Write(io_L,1103) 0._dp,4 ,45,21,21,23, " # h_5 g g Z coupling " 
Write(io_L,1102) rHB_S_VWm(6),3 ,46,24,24, " # h_6 W W coupling " 
Write(io_L,1102) rHB_S_VZ(6),3 ,46,23,23, " # h_6 Z Z coupling  " 
Write(io_L,1102) 0._dp ,3 ,46,23,22, " # h_6 Z gamma coupling " 
Write(io_L,1102) Real(ratioPP(6),dp),3 ,46,22,22, " # h_6 gamma gamma coupling " 
Write(io_L,1102) Real(ratioGG(6),dp),3 ,46,21,21, " # h_6 g g coupling " 
Write(io_L,1103) 0._dp,4 ,46,21,21,23, " # h_6 g g Z coupling " 
Write(io_L,1102) Real(CPL_H_H_Z(2,2), dp),3 ,25,25,23, " # h_2 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,3), dp),3 ,25,35,23, " # h_2 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,4), dp),3 ,25,36,23, " # h_2 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,5), dp),3 ,25,45,23, " # h_2 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(2,6), dp),3 ,25,46,23, " # h_2 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,2), dp),3 ,35,25,23, " # h_3 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,3), dp),3 ,35,35,23, " # h_3 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,4), dp),3 ,35,36,23, " # h_3 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,5), dp),3 ,35,45,23, " # h_3 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(3,6), dp),3 ,35,46,23, " # h_3 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,2), dp),3 ,36,25,23, " # h_4 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,3), dp),3 ,36,35,23, " # h_4 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,4), dp),3 ,36,36,23, " # h_4 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,5), dp),3 ,36,45,23, " # h_4 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(4,6), dp),3 ,36,46,23, " # h_4 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,2), dp),3 ,45,25,23, " # h_5 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,3), dp),3 ,45,35,23, " # h_5 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,4), dp),3 ,45,36,23, " # h_5 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,5), dp),3 ,45,45,23, " # h_5 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(5,6), dp),3 ,45,46,23, " # h_5 h_6 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,2), dp),3 ,46,25,23, " # h_6 h_2 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,3), dp),3 ,46,35,23, " # h_6 h_3 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,4), dp),3 ,46,36,23, " # h_6 h_4 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,5), dp),3 ,46,45,23, " # h_6 h_5 Z coupling  "
Write(io_L,1102) Real(CPL_H_H_Z(6,6), dp),3 ,46,46,23, " # h_6 h_6 Z coupling  "
End If 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,31:165)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,31:165)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,31:165)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,31:165)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,31:165)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,31:165)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRhh(4,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BRhh(4,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRhh(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRhh(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BRhh(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(5))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
...
icount = icount +1 
End if 
If ((gThh(6).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 2, 2
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRhh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BRhh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRhh(6,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
icount = icount +1 
End if 
If(gT1Lhh(6).gt.MinWidth) Then 
Write(io_L,210) INT(PDGhh(6)),gT1Lhh(6),Trim(NameParticlehh(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1Lhh(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BR1Lhh(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BR1Lhh(6,icount).Gt.BrMin) Then 
...
CurrentPDG2(1) = PDGHm(gt1) 
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BR1Lhh(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BR1Lhh(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticlehh(6))//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.C2HDMS",status="unknown")
...
Write(123,*) "Lam3= ",Lam3
Write(123,*) "Lam2= ",Lam2
Write(123,*) "Lam1p= ",Lam1p
Write(123,*) "Lam2p= ",Lam2p
Write(123,*) "L3pp= ",L3pp
Write(123,*) "L1pp_r = ",Real(L1pp,dp) 
Write(123,*) "L1pp_i = ",AImag(L1pp) 
...
Write(123,*) "L2pp_r = ",Real(L2pp,dp) 
Write(123,*) "L2pp_i = ",AImag(L2pp) 
...
Write(90,"(e16.8)",advance="No") BRHHH(2,6)/gThh(2) 
...
Write(90,"(e16.8)",advance="No") BRHHH(3,6)/gThh(3) 
...
Write(90,"(e16.8)",advance="No") BRHHH(4,6)/gThh(4) 
...
Write(90,"(e16.8)",advance="No") BRHHH(5,6)/gThh(5) 
Write(90,"(e16.8)",advance="No") BRHHH(6,2)/gThh(6) 
Write(90,"(e16.8)",advance="No") BRHHH(6,3)/gThh(6) 
Write(90,"(e16.8)",advance="No") BRHHH(6,4)/gThh(6) 
Write(90,"(e16.8)",advance="No") BRHHH(6,5)/gThh(6) 
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fd(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fd(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fu(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fu(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fd(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fd(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fu(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fu(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(5,2)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(6,2)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_S_Fe(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(5,3)**2
Write(89,"(3e16.8)",advance="No") rHB_S_P_Fe(6,3)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_VWm(6)**2
...
Write(89,"(3e16.8)",advance="No") rHB_S_VZ(6)**2
...
Write(89,"(3e16.8)",advance="No")  Real(ratioPP(6),dp)**2 
...
Write(89,"(3e16.8)",advance="No")  Real(ratioGG(6),dp)**2 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
Write(89,"(3e16.8)",advance="No") 0._dp 
...
Write(91,"(3e16.8)",advance="No")BR_HpHW(2,4)/gTHm(2) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(2,5)/gTHm(2) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(2,6)/gTHm(2) 
Write(89,"(I1)",advance="No") 1 
...
Subroutine WriteWCXF 
   Open(123,file="WC.C2HDMS_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.C2HDMS_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
L3ppIN= wert 
InputValueforL3pp= .True. 
Else If (i_par.Eq.38) Then 
If (i_c.Eq.0) L1ppIN= Cmplx(wert,Aimag(L1ppIN),dp) 
If (i_c.Eq.1) L1ppIN= Cmplx(Real(L1ppIN,dp),wert,dp) 
InputValueforL1pp= .True. 
...
If (i_c.Eq.0) L2ppIN= Cmplx(wert,Aimag(L2ppIN),dp) 
If (i_c.Eq.1) L2ppIN= Cmplx(Real(L2ppIN,dp),wert,dp) 
InputValueforL2pp= .True. 
Else If (i_par.Eq.43) Then 
...
Else If (i_par.Eq.24) Then 
If (i_c.Eq.0) mSp2IN= Cmplx(wert,Aimag(mSp2IN),dp) 
If (i_c.Eq.1) mSp2IN= Cmplx(Real(mSp2IN,dp),wert,dp) 
InputValueformSp2= .True. 
