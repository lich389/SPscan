...
Module Wrapper_OneLoopDecay_hh_C2HDMS
Use Model_Data_C2HDMS 
Use Kinematics 
Use OneLoopDecay_hh_C2HDMS 
Use Control 
Use Settings 
...
Call Amplitude_Tree_C2HDMS_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,            & 
& Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_C2HDMS_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,               & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,             & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)
...
Call Amplitude_WAVE_C2HDMS_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,           & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTocFdFd(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFdFd(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFdFd(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdhhL,        & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhTocFdFd)
 ...
 ! OS and no Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFdFd(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,            & 
& Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_C2HDMS_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,               & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,             & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,           & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTocFeFe(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,            & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexhhTocFeFe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFeFe(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,              & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFeFe(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,            & 
& Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_C2HDMS_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,               & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,             & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,           & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTocFuFu(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFuFu(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocFuFu(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_C2HDMS_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,            & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,           & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,              & 
& MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,             & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,              & 
& AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTohhhh(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTohhhh(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,           & 
& MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,cplhhhhhh,              & 
& cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplhhhhhhhh1,      & 
& cplhhhhHmcHm1,cplhhhhcVWmVWm1,cplhhhhVZVZ1,AmpVertexIRdrhhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTohhhh(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTohhVZ(cplhhhhVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhTohhVZ)

  Else 
Call Amplitude_Tree_C2HDMS_hhTohhVZ(ZcplhhhhVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhTohhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTohhVZ(MLambda,em,gs,cplhhhhVZ,MhhOS,MVZOS,MRPhhTohhVZ,      & 
& MRGhhTohhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTohhVZ(MLambda,em,gs,ZcplhhhhVZ,MhhOS,MVZOS,MRPhhTohhVZ,     & 
& MRGhhTohhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhTohhVZ(MLambda,em,gs,cplhhhhVZ,Mhh,MVZ,MRPhhTohhVZ,          & 
& MRGhhTohhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhTohhVZ(MLambda,em,gs,ZcplhhhhVZ,Mhh,MVZ,MRPhhTohhVZ,         & 
& MRGhhTohhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTohhVZ(cplhhhhVZ,ctcplhhhhVZ,Mhh,Mhh2,MVZ,               & 
& MVZ2,Zfhh,ZfVZ,AmpWavehhTohhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTohhVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTohhVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,           & 
& MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,       & 
& cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,         & 
...
& cplhhcHmVWmVZ1,AmpVertexIRdrhhTohhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTohhVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
& MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,cplcFdFdhhL,            & 
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,       & 
& cplhhhhhh,ZcplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,        & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhhhVZVZ1,cplhhHmcVWmVZ1,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTocHmHm(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)

  Else 
Call Amplitude_Tree_C2HDMS_hhTocHmHm(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,MRPhhTocHmHm,   & 
& MRGhhTocHmHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,       & 
& MRGhhTocHmHm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,      & 
& MRGhhTocHmHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTocHmHm(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,MHm,            & 
& MHm2,Zfhh,ZfHm,AmpWavehhTocHmHm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTocHmHm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocHmHm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
& cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrhhTocHmHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocHmHm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhToHmcVWm(cplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,MHm2,             & 
& MVWm2,AmpTreehhToHmcVWm)

  Else 
Call Amplitude_Tree_C2HDMS_hhToHmcVWm(ZcplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,MHm2,            & 
& MVWm2,AmpTreehhToHmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,MhhOS,MHmOS,              & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,MhhOS,MHmOS,             & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,Mhh,MHm,MVWm,             & 
& MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,Mhh,MHm,MVWm,            & 
& MRPhhToHmcVWm,MRGhhToHmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhToHmcVWm(cplhhHmcVWm,ctcplhhHmcVWm,Mhh,Mhh2,             & 
& MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWavehhToHmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToHmcVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,             & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcVWmL,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhToHmcVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
...
& AmpVertexIRdrhhToHmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhToHmcVWm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,             & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,              & 
& AmpTreehhTocVWmVWm)

  Else 
Call Amplitude_Tree_C2HDMS_hhTocVWmVWm(ZcplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,             & 
& AmpTreehhTocVWmVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,MhhOS,MVWmOS,           & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,MhhOS,MVWmOS,          & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,MVWm,               & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,Mhh,MVWm,              & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,Mhh,               & 
& Mhh2,MVWm,MVWm2,Zfhh,ZfVWm,AmpWavehhTocVWmVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTocVWmVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcVWmL,        & 
& cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFuFuhhL,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocVWmVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,             & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcVWmL,    & 
& cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgZgAhh,            & 
& cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,   & 
...
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhTocVWmVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhTocVWmVWm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,               & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_C2HDMS_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,      & 
& MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,     & 
& MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,          & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,         & 
& MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,MVZ,               & 
& MVZ2,Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToVZVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,              & 
& MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,       & 
& cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_hhToVZVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,MFd2,           & 
& MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,       & 
& cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,         & 
...
& AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_hhToVZVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
& MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,cplcFdFdhhL,            & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,              & 
& cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,             & 
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,       & 
& cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,ZcplhhVZVZ,        & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhhhVZVZ1,cplhhHmcVWmVZ1,           & 
& cplhhcHmVWmVZ1,cplHmcHmVZVZ1,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,       & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_hhToFvcFv(MFeOS,MhhOS,MHmOS,MVWmOS,MVZOS,MFe2OS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToFvcFv(MFe,Mhh,MHm,MVWm,MVZ,MFe2,Mhh2,MHm2,           & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_hhTohhVP(cplhhhhVZ,ctcplhhhhVZ,MhhOS,Mhh2OS,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_hhTohhVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_hhTohhVP(cplhhhhVZ,ctcplhhhhVZ,Mhh,Mhh2,MVP,               & 
& MVP2,MVZ,MVZ2,Zfhh,ZfVP,ZfVZVP,AmpWavehhTohhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhTohhVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_hhToVGVG(MFdOS,MFuOS,MhhOS,MVG,MFd2OS,MFu2OS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,Mhh2,MVG2,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_hhToVPVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
& MVWmOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,cplcFdFdhhL,cplcFdFdhhR,        & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,             & 
& cplcgWpCgWpChh,cplcgWpCgWpCVP,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToVPVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,              & 
& MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWpCgWpChh,cplcgWpCgWpCVP,       & 
& cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,cplHmcVWmVP,cplcHmVPVWm,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_hhToVPVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_hhToVPVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
End Module Wrapper_OneLoopDecay_hh_C2HDMS
