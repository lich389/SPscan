...
Module Wrapper_OneLoopDecay_Fu_C2HDMS
Use Model_Data_C2HDMS 
Use Kinematics 
Use OneLoopDecay_Fu_C2HDMS 
Use Control 
Use Settings 
...
Call Amplitude_Tree_C2HDMS_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,               & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)

  Else 
Call Amplitude_Tree_C2HDMS_FuToFdcHm(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,MFu,             & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FuToFdcHm(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,           & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)
...
Call Amplitude_WAVE_C2HDMS_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,        & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFuToFdcHm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
& cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrFuToFdcHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFdcHm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,MFd,MFu,            & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)

  Else 
Call Amplitude_Tree_C2HDMS_FuToFdcVWm(ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,MFd,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,          & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FuToFdcVWm(MLambda,em,gs,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,        & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,ctcplcFuFdcVWmL,    & 
& ctcplcFuFdcVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFuToFdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcVWm,               & 
& cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,AmpVertexIRdrFuToFdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFdcVWm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,             & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_C2HDMS_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,           & 
& Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,          & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,            & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFuToFuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFuhh(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,             & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,             & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_C2HDMS_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,MFu2,           & 
& MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFuOS,          & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFu,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFuToFuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FuToFuVZ(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,             & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVZL,         & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,          & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_C2HDMS_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,            & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_FuToFuVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdVGL,               & 
...
& AmpVertexFuToFuVG)
 ...
 Else 
Call Amplitude_VERTEX_C2HDMS_FuToFuVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVGL,cplcFdFdVGR,    & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplVGVGVG,AmpVertexFuToFuVG)
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFuVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,           & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_C2HDMS_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_FuToFuVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdVPL,               & 
...
& ZcplHmcVWmVP,ZcplcHmVPVWm,ZcplcVWmVPVWm,AmpVertexFuToFuVP)
 ...
 Else 
Call Amplitude_VERTEX_C2HDMS_FuToFuVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVPL,cplcFdFdVPR,    & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplHmcHmVP,cplHmcVWmVP,              & 
& cplcHmVPVWm,cplcVWmVPVWm,AmpVertexFuToFuVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FuToFuVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
...
End Module Wrapper_OneLoopDecay_Fu_C2HDMS
