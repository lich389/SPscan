...
Subroutine Amplitude_Tree_C2HDMS_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FuToFdcHm


Subroutine Gamma_Real_C2HDMS_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FuToFdcHm


Subroutine Amplitude_WAVE_C2HDMS_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,  & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFdcHm


Subroutine Amplitude_VERTEX_C2HDMS_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFdcHm


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFdcHm


Subroutine Amplitude_Tree_C2HDMS_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FuToFdcVWm


Subroutine Gamma_Real_C2HDMS_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,    & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FuToFdcVWm


Subroutine Amplitude_WAVE_C2HDMS_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFdcVWm


Subroutine Amplitude_VERTEX_C2HDMS_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,6),          & 
& cplcFuFuhhR(3,3,6),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),& 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhHmcVWm(6,2),cplhhcVWmVWm(6),cplHmcVWmVP(2),     & 
& cplHmcVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,             & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFdcVWm


Subroutine Amplitude_Tree_C2HDMS_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,            & 
& MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FuToFuhh


Subroutine Gamma_Real_C2HDMS_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FuToFuhh


Subroutine Amplitude_WAVE_C2HDMS_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFuhh


Subroutine Amplitude_VERTEX_C2HDMS_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFuhh


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuhh


Subroutine Amplitude_Tree_C2HDMS_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,            & 
& MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FuToFuVZ


Subroutine Gamma_Real_C2HDMS_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FuToFuVZ


Subroutine Amplitude_WAVE_C2HDMS_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFuVZ


Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVZ


Subroutine Amplitude_WAVE_C2HDMS_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFuVG


Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,     & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplVGVGVG,Amp)
...
Complex(dp), Intent(in) :: cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),            & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),           & 
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),               & 
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),& 
& cplcFuFuVZR(3,3),cplVGVGVG
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVG


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVG(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVGL,cplcFdFdVGR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVG


Subroutine Amplitude_WAVE_C2HDMS_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FuToFuVP


Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,     & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
...
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),               & 
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),& 
& cplcFuFuVZR(3,3),cplHmcHmVP(2,2),cplHmcVWmVP(2),cplcHmVPVWm(2),cplcVWmVPVWm
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FuToFuVP


Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVP(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVPL,cplcFdFdVPR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FuToFuVP



End Module OneLoopDecay_Fu_C2HDMS
