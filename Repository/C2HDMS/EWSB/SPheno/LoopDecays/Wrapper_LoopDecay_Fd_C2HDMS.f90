...
Module Wrapper_OneLoopDecay_Fd_C2HDMS
Use Model_Data_C2HDMS 
Use Kinematics 
Use OneLoopDecay_Fd_C2HDMS 
Use Control 
Use Settings 
...
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplVGVGVG,ctcplcFdFdhhL,ctcplcFdFdhhR,   & 
...
& cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhVZVZ(6),cplHmcHmVP(2,2),cplHmcHmVZ(2,2),       & 
& cplHmcVWmVP(2),cplHmcVWmVZ(2),cplVGVGVG,ctcplcFdFdhhL(3,3,6),ctcplcFdFdhhR(3,3,6),     & 
...
& GZcplcHmVPVWm(2),GZcplHmcVWmVP(2),ZcplcFdFdhhL(3,3,6),ZcplcFdFdhhR(3,3,6),             & 
& ZcplcFdFdVGL(3,3),ZcplcFdFdVGR(3,3),ZcplcFdFdVPL(3,3),ZcplcFdFdVPR(3,3),               & 
& ZcplcFdFdVZL(3,3),ZcplcFdFdVZR(3,3),ZcplcFdFuHmL(3,3,2),ZcplcFdFuHmR(3,3,2),           & 
& ZcplcFdFuVWmL(3,3),ZcplcFdFuVWmR(3,3),ZcplcFuFdcHmL(3,3,2),ZcplcFuFdcHmR(3,3,2),       & 
& ZcplcFuFdcVWmL(3,3),ZcplcFuFdcVWmR(3,3),ZcplcFuFuVGL(3,3),ZcplcFuFuVGR(3,3),           & 
& ZcplcFuFuVPL(3,3),ZcplcFuFuVPR(3,3),ZcplcHmVPVWm(2),ZcplcVWmVPVWm,ZcplHmcHmVP(2,2),    & 
& ZcplHmcVWmVP(2),ZcplVGVGVG
...
Real(dp) :: MRPFdToFdhh(3,3,6),MRGFdToFdhh(3,3,6), MRPZFdToFdhh(3,3,6),MRGZFdToFdhh(3,3,6) 
Real(dp) :: MVPFdToFdhh(3,3,6) 
Real(dp) :: RMsqTreeFdToFdhh(3,3,6),RMsqWaveFdToFdhh(3,3,6),RMsqVertexFdToFdhh(3,3,6) 
Complex(dp) :: AmpTreeFdToFdhh(2,3,3,6),AmpWaveFdToFdhh(2,3,3,6)=(0._dp,0._dp),AmpVertexFdToFdhh(2,3,3,6)& 
 & ,AmpVertexIRosFdToFdhh(2,3,3,6),AmpVertexIRdrFdToFdhh(2,3,3,6), AmpSumFdToFdhh(2,3,3,6), AmpSum2FdToFdhh(2,3,3,6) 
Complex(dp) :: AmpTreeZFdToFdhh(2,3,3,6),AmpWaveZFdToFdhh(2,3,3,6),AmpVertexZFdToFdhh(2,3,3,6) 
Real(dp) :: AmpSqFdToFdhh(3,3,6),  AmpSqTreeFdToFdhh(3,3,6) 
...
Call Amplitude_Tree_C2HDMS_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,             & 
& Mhh2,AmpTreeFdToFdhh)

  Else 
Call Amplitude_Tree_C2HDMS_FdToFdhh(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,           & 
& Mhh2,AmpTreeFdToFdhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,          & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,            & 
...
Call Amplitude_WAVE_C2HDMS_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,            & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWaveFdToFdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,      & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFdToFdhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFdhh(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,             & 
...
& cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFdToFdhh)

   Else 
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,ZcplcFdFdhhL,ZcplcFdFdhhR,cplcFdFdVGL,        & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,      & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFdToFdhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,MFd2,             & 
& MVZ2,AmpTreeFdToFdVZ)

  Else 
Call Amplitude_Tree_C2HDMS_FdToFdVZ(ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,MVZ,MFd2,           & 
& MVZ2,AmpTreeFdToFdVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFdOS,          & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFd,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexFdToFdVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,         & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFdVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFdVZ(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,             & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,ZcplcFdFdVZL,              & 
& ZcplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,        & 
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,               & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,         & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFdToFdVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,MFd,MFu,MHm,              & 
& MFd2,MFu2,MHm2,AmpTreeFdToFuHm)

  Else 
Call Amplitude_Tree_C2HDMS_FdToFuHm(ZcplcFdFuHmL,ZcplcFdFuHmR,MFd,MFu,MHm,            & 
& MFd2,MFu2,MHm2,AmpTreeFdToFuHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,MFdOS,          & 
& MFuOS,MHmOS,MRPFdToFuHm,MRGFdToFuHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FdToFuHm(MLambda,em,gs,ZcplcFdFuHmL,ZcplcFdFuHmR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,MFd,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,ctcplcFdFuHmL,            & 
& ctcplcFdFuHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFdToFuHm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcHm,              & 
& cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,AmpVertexIRdrFdToFuHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFuHm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,             & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,ZcplcFdFuHmL,ZcplcFdFuHmR,cplcFuFuVGL,             & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,      & 
& AmpVertexIRosFdToFuHm)
...
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,               & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,      & 
& AmpVertexIRosFdToFuHm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,MFd,MFu,               & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFdToFuVWm)

  Else 
Call Amplitude_Tree_C2HDMS_FdToFuVWm(ZcplcFdFuVWmL,ZcplcFdFuVWmR,MFd,MFu,             & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFdToFuVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_FdToFuVWm(MLambda,em,gs,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_FdToFuVWm(MLambda,em,gs,ZcplcFdFuVWmL,ZcplcFdFuVWmR,           & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,ctcplcFdFuVWmL,        & 
& ctcplcFdFuVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFdToFuVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,              & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
& cplhhcVWmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFuVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_FdToFuVWm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_FdToFdVG(ZcplcFdFdVGL,ZcplcFdFdVGR,ctcplcFdFdVGL,          & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)

 Else 
Call Amplitude_WAVE_C2HDMS_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,            & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_FdToFdVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdhhL,               & 
& ZcplcFdFdhhR,ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,         & 
& ZcplcFdFdVZR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFdFuHmL,   & 
& ZcplcFdFuHmR,ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplVGVGVG,         & 
& AmpVertexFdToFdVG)

 Else 
Call Amplitude_VERTEX_C2HDMS_FdToFdVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFdFuVWmL,cplcFdFuVWmR,cplVGVGVG,AmpVertexFdToFdVG)
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFdVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_FdToFdVP(ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,           & 
...
& MFd2OS,MVP,MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
 ...
 Else 
Call Amplitude_WAVE_C2HDMS_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_FdToFdVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,MVWmOS,         & 
& MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdhhL,               & 
& ZcplcFdFdhhR,ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,         & 
& ZcplcFdFdVZR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFdFuHmL,   & 
& ZcplcFdFuHmR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplHmcHmVP,        & 
& ZcplHmcVWmVP,ZcplcHmVPVWm,ZcplcVWmVPVWm,AmpVertexFdToFdVP)
...
& cplcHmVPVWm,cplcVWmVPVWm,AmpVertexFdToFdVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_FdToFdVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,               & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
End Module Wrapper_OneLoopDecay_Fd_C2HDMS
