...
Subroutine Amplitude_Tree_C2HDMS_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,            & 
& MFd2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FdToFdhh


Subroutine Gamma_Real_C2HDMS_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FdToFdhh


Subroutine Amplitude_WAVE_C2HDMS_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFdhh


Subroutine Amplitude_VERTEX_C2HDMS_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFdhh


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdhh


Subroutine Amplitude_Tree_C2HDMS_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,            & 
& MFd2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FdToFdVZ


Subroutine Gamma_Real_C2HDMS_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FdToFdVZ


Subroutine Amplitude_WAVE_C2HDMS_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFdVZ


Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVZ


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVZ


Subroutine Amplitude_Tree_C2HDMS_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,MFd,MFu,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FdToFuHm


Subroutine Gamma_Real_C2HDMS_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FdToFuHm


Subroutine Amplitude_WAVE_C2HDMS_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,ctcplcFdFuHmL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFuHm


Subroutine Amplitude_VERTEX_C2HDMS_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFuHm


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFuHm


Subroutine Amplitude_Tree_C2HDMS_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,MFd,             & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_C2HDMS_FdToFuVWm


Subroutine Gamma_Real_C2HDMS_FdToFuVWm(MLambda,em,gs,cplcFdFuVWmL,cplcFdFuVWmR,       & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_C2HDMS_FdToFuVWm


Subroutine Amplitude_WAVE_C2HDMS_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,ctcplcFdFuVWmL,  & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFuVWm


Subroutine Amplitude_VERTEX_C2HDMS_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFuVWm


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,              & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFuVWm


Subroutine Amplitude_WAVE_C2HDMS_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFdVG


Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVG


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVG(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVG


Subroutine Amplitude_WAVE_C2HDMS_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,        & 
& cplcFdFdVZR,ctcplcFdFdVPL,ctcplcFdFdVPR,ctcplcFdFdVZL,ctcplcFdFdVZR,MFd,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_C2HDMS_FdToFdVP


Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_C2HDMS_FdToFdVP


Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVP(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_C2HDMS_FdToFdVP



End Module OneLoopDecay_Fd_C2HDMS
