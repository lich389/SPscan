...
Module Wrapper_OneLoopDecay_Hm_C2HDMS
Use Model_Data_C2HDMS 
Use Kinematics 
Use OneLoopDecay_Hm_C2HDMS 
Use Control 
Use Settings 
...
Call Amplitude_Tree_C2HDMS_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,               & 
& MHm,MFd2,MFu2,MHm2,AmpTreeHmTocFuFd)

  Else 
Call Amplitude_Tree_C2HDMS_HmTocFuFd(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,MFu,             & 
& MHm,MFd2,MFu2,MHm2,AmpTreeHmTocFuFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmTocFuFd(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmTocFuFd(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,           & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)
...
Call Amplitude_WAVE_C2HDMS_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,        & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveHmTocFuFd)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmTocFuFd(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmTocFuFd(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
& cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrHmTocFuFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmTocFuFd(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,MFe,MHm,               & 
& MFe2,MHm2,AmpTreeHmTocFvFe)

  Else 
Call Amplitude_Tree_C2HDMS_HmTocFvFe(ZcplcFvFecHmL,ZcplcFvFecHmR,MFe,MHm,             & 
& MFe2,MHm2,AmpTreeHmTocFvFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmTocFvFe(MLambda,em,gs,cplcFvFecHmL,cplcFvFecHmR,             & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmTocFvFe(MLambda,em,gs,ZcplcFvFecHmL,ZcplcFvFecHmR,           & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,ctcplcFvFecHmL,        & 
& ctcplcFvFecHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveHmTocFvFe)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmTocFvFe(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmTocFvFe(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,              & 
...
& cplcHmVWmVZ,AmpVertexIRdrHmTocFvFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmTocFvFe(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_HmToHmhh(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)

  Else 
Call Amplitude_Tree_C2HDMS_HmToHmhh(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmToHmhh(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,MRPHmToHmhh,     & 
& MRGHmToHmhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,MRPHmToHmhh,    & 
& MRGHmToHmhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_HmToHmhh(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPHmToHmhh,         & 
& MRGHmToHmhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPHmToHmhh,        & 
& MRGHmToHmhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_HmToHmhh(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,MHm,             & 
& MHm2,Zfhh,ZfHm,AmpWaveHmToHmhh)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmToHmhh(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmToHmhh(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFuFuhhL,            & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,cplcgWmgWmhh,              & 
& cplcgZgWmcHm,cplcgWpCgWpChh,cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpCgZcHm,         & 
...
& cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrHmToHmhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmToHmhh(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_HmTohhVWm(cplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,MHm2,              & 
& MVWm2,AmpTreeHmTohhVWm)

  Else 
Call Amplitude_Tree_C2HDMS_HmTohhVWm(ZcplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,MHm2,             & 
& MVWm2,AmpTreeHmTohhVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,MhhOS,MHmOS,               & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,MhhOS,MHmOS,              & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,Mhh,MHm,MVWm,              & 
& MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,Mhh,MHm,MVWm,             & 
& MRPHmTohhVWm,MRGHmTohhVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_HmTohhVWm(cplhhcHmVWm,ctcplhhcHmVWm,Mhh,Mhh2,              & 
& MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWaveHmTohhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmTohhVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,              & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFuFuhhL,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmTohhVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
& AmpVertexIRdrHmTohhVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmTohhVWm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,              & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,               & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_HmToHmVZ(cplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)

  Else 
Call Amplitude_Tree_C2HDMS_HmToHmVZ(ZcplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHmOS,MVZOS,MRPHmToHmVZ,     & 
& MRGHmToHmVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHmOS,MVZOS,MRPHmToHmVZ,    & 
& MRGHmToHmVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,         & 
& MRGHmToHmVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,        & 
& MRGHmToHmVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_HmToHmVZ(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,               & 
& ctcplHmcHmVZ,MHm,MHm2,MVP,MVP2,MVZ,MVZ2,ZfHm,ZfVPVZ,ZfVZ,AmpWaveHmToHmVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmToHmVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmToHmVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,            & 
& cplcFdFuHmR,cplcFuFuVZL,cplcFuFuVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFvFvVZL,               & 
& cplcFvFvVZR,cplcgWmgWmVZ,cplcgZgWmcHm,cplcgZgWpCHm,cplcgWpCgWpCVZ,cplcgWmgZHm,         & 
...
& cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,AmpVertexIRdrHmToHmVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmToHmVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_C2HDMS_HmToVZVWm(cplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,MVWm2,             & 
& MVZ2,AmpTreeHmToVZVWm)

  Else 
Call Amplitude_Tree_C2HDMS_HmToVZVWm(ZcplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,MVWm2,            & 
& MVZ2,AmpTreeHmToVZVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_C2HDMS_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHmOS,MVWmOS,              & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_C2HDMS_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHmOS,MVWmOS,             & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_C2HDMS_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHm,MVWm,MVZ,              & 
& MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_C2HDMS_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHm,MVWm,MVZ,             & 
& MRPHmToVZVWm,MRGHmToVZVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_C2HDMS_HmToVZVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,           & 
& ctcplcHmVWmVZ,MHm,MHm2,MVP,MVP2,MVWm,MVWm2,MVZ,MVZ2,ZfHm,ZfVWm,ZfVZ,AmpWaveHmToVZVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmToVZVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,              & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_C2HDMS_HmToVZVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
& cplcVWmVWmVZVZ1Q,AmpVertexIRdrHmToVZVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_C2HDMS_HmToVZVWm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,              & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFeVZL,cplcFeFeVZR,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_HmToHmVP(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_HmToHmVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmToHmVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_C2HDMS_HmToVPVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_C2HDMS_HmToVPVWm(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,             & 
& MVWmOS,MVZOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,           & 
& cplcFeFvVWmR,cplcgWpCgAcHm,cplcgWmgWmVP,cplcgZgWmcHm,cplcgWpCgWpCVP,cplcgAgWpCVWm,     & 
& cplcgZgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,cplhhcVWmVWm,          & 
& cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,   & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_C2HDMS_HmToVPVWm(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,              & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,         & 
...
End Module Wrapper_OneLoopDecay_Hm_C2HDMS
