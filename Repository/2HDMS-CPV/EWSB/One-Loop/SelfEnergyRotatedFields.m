{2*(-1/2*rMS + B0[p^2, Mass2[VZ], Mass2[VZ]])*conj[Cp[Uhh[{gO2}], VZ, VZ]]*
   Cp[Uhh[{gO1}], VZ, VZ] + 4*(-1/2*rMS + B0[p^2, Mass2[VWm], Mass2[VWm]])*
  ...
  3*sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fu[{gI1}]], Mass2[Fu[{gI2}]]]*
      (conj[Cp[Uhh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PL]]*
       ...
       conj[Cp[Uhh[{gO2}], bar[Fu[{gI1}]], Fu[{gI2}]][PR]]*
        Cp[Uhh[{gO1}], bar[Fu[{gI1}]], Fu[{gI2}]][PR])]] - 
  sum[gI1, 1, 6, A0[Mass2[hh[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], hh[{gI1}], 
      hh[{gI1}]]]/2 + 
  sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[hh[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  2*sum[gI2, 1, 2, conj[Cp[Uhh[{gO2}], conj[VWm], Hm[{gI2}]]]*
     Cp[Uhh[{gO1}], conj[VWm], Hm[{gI2}]]*F0[p^2, Mass2[Hm[{gI2}]], 
      Mass2[VWm]]] + sum[gI2, 1, 6, conj[Cp[Uhh[{gO2}], VZ, hh[{gI2}]]]*
    Cp[Uhh[{gO1}], VZ, hh[{gI2}]]*F0[p^2, Mass2[hh[{gI2}]], Mass2[VZ]]], 
 4*(-1/2*rMS + B0[p^2, 0, Mass2[VWm]])*conj[Cp[conj[UHm[{gO2}]], VWm, VP]]*
  ...
  sum[gI1, 1, 2, sum[gI2, 1, 6, B0[p^2, Mass2[Hm[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 3, G0[p^2, Mass2[Fv[{gI1}]], Mass2[Fe[{gI2}]]]*
     (conj[Cp[conj[UHm[{gO2}]], bar[Fv[{gI1}]], Fe[{gI2}]][PL]]*
      ...
      conj[Cp[conj[UHm[{gO2}]], bar[Fv[{gI1}]], Fe[{gI2}]][PR]]*
       Cp[conj[UHm[{gO1}]], bar[Fv[{gI1}]], Fe[{gI2}]][PR])]] - 
  sum[gI1, 1, 6, A0[Mass2[hh[{gI1}]]]*Cp[UHm[{gO1}], conj[UHm[{gO2}]], 
      hh[{gI1}], hh[{gI1}]]]/2 + sum[gI2, 1, 2, 
   conj[Cp[conj[UHm[{gO2}]], VP, Hm[{gI2}]]]*Cp[conj[UHm[{gO1}]], VP, 
     Hm[{gI2}]]*F0[p^2, Mass2[Hm[{gI2}]], 0]] + 
  sum[gI2, 1, 2, conj[Cp[conj[UHm[{gO2}]], VZ, Hm[{gI2}]]]*
    Cp[conj[UHm[{gO1}]], VZ, Hm[{gI2}]]*F0[p^2, Mass2[Hm[{gI2}]], 
     Mass2[VZ]]] + sum[gI2, 1, 6, conj[Cp[conj[UHm[{gO2}]], VWm, hh[{gI2}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], Mass2[Hm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hm[{gI1}], Fu[{gI2}]][PR]]*
       Cp[bar[UFd[{gO1}]], Hm[{gI1}], Fu[{gI2}]][PR]]] - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], 
       ...
       Cp[bar[UFd[{gO1}]], Hm[{gI1}], Fu[{gI2}]][PL]]] - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[hh[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], Mass2[Hm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], Mass2[hh[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], Mass2[Hm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hm[{gI1}], Fv[{gI2}]][PR]]*
       Cp[bar[UFe[{gO1}]], Hm[{gI1}], Fv[{gI2}]][PR]]] - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], 
       ...
       Cp[bar[UFe[{gO1}]], Hm[{gI1}], Fv[{gI2}]][PL]]] - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
