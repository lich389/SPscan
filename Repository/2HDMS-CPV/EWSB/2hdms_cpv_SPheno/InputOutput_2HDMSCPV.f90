...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - 2HDMS-CPV Spectrum + Decays + Flavour Observables"
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.2HDMSCPV",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.2HDMSCPV_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.2HDMSCPV_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
End Module InputOutput_2HDMSCPV 
