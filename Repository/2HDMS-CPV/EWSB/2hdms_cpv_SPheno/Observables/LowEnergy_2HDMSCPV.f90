...
Use StandardModel 
Use RunSM_2HDMSCPV
Use FlavorKit_LFV_2HDMSCPV
Use FlavorKit_QFV_2HDMSCPV
Use FlavorKit_Observables_2HDMSCPV
...
Subroutine Gminus2(Ifermion,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,cplcFeFehhL,cplcFeFehhR,       & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFeFvHmL,cplcFeFvHmR,             & 
& cplHmcHmVP,a_mu)

Real(dp),Intent(in)  :: MFe(3),MFe2(3),Mhh(6),Mhh2(6),MHm(2),MHm2(2)
...
Subroutine LeptonEDM(Ifermion,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,              & 
...
Subroutine DeltaRho(MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,          & 
& MVZ,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,  & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcVWmVWm,cplhhhhcVWmVWm,cplhhhhVZ,cplhhhhVZVZ,     & 
...
Complex(dp),Intent(in)  :: cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFdcVWmL(3,3),& 
& cplcFuFdcVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFvFecVWmL(3,3),               & 
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVZ,       & 
& cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,         & 
...
& cplhhcVWmVWm(6),cplhhhhcVWmVWm(6,6),cplhhhhVZ(6,6),cplhhhhVZVZ(6,6),cplhhHmcVWm(6,2),  & 
& cplhhVZVZ(6),cplHmcHmcVWmVWm(2,2),cplHmcHmVZ(2,2),cplHmcHmVZVZ(2,2),cplHmcVWmVP(2),    & 
& cplHmcVWmVZ(2)
...
Call Pi1LoopVZ(0._dp,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MVZ,MVZ2,MHm,MHm2,           & 
...
Subroutine STUparameter(vSM,g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,MFd,MFd2,MFe,               & 
...
Call Pi1LoopVZ(MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MVZ,MVZ2,MHm,MHm2,            & 
& MVWm,MVWm2,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,    & 
& cplcFvFvVZL,cplcFvFvVZR,cplcgWmgWmVZ,cplcgWpCgWpCVZ,cplhhhhVZ,cplhhVZVZ,               & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVWmVZ,cplhhhhVZVZ,cplHmcHmVZVZ,cplcVWmVWmVZVZ1,          & 
...
Call Pi1LoopVWm(MVWm2,MFu,MFu2,MFd,MFd2,MFe,MFe2,MHm,MHm2,Mhh,Mhh2,MVWm,              & 
& MVWm2,MVZ,MVZ2,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcgWpCgAcVWm, & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgZcVWm,cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVP,       & 
& cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhhhcVWmVWm,cplHmcHmcVWmVWm,cplcVWmVPVPVWm3,  & 
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplcVWmcVWmVWmVWm1,& 
...
& Lam5input,Lam7input,Lam1input,Lam4input,Lam3input,Lam2input,Lam1pinput,Lam2pinput,     & 
& L3ppinput,L1ppinput,Lam4pinput,Lam6pinput,Lam7pinput,Lam5pinput,L2ppinput,             & 
& Lam3pinput,Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,mus1input,            & 
& mu11input,mu12input,mu21input,mu22input,mus2input,M122input,M112input,M222input,       & 
& mS2input,mSp2input,vdinput,vuinput,vSinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,            & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,Lam1input,Lam4input,Lam3input,Lam2input,Lam1pinput,           & 
& Lam2pinput,L3ppinput,M112input,M222input,mS2input,vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Lam6input,Lam5input,Lam7input,L1ppinput,Lam4pinput,Lam6pinput,Lam7pinput,             & 
...
Complex(dp) :: cplcFdFdhhL(3,3,6),cplcFdFdhhR(3,3,6),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),              & 
...
& cplcFvFvVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpCgAcVWm,               & 
& cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,cplcHmVPVWm(2),             & 
...
& cplcVWmVWmVZVZ3,cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhhhcVWmVWm(6,6),cplhhhhhh(6,6,6), & 
& cplhhhhVZ(6,6),cplhhhhVZVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhVZVZ(6),       & 
...
& OA2lSLSM(3,3),OA2lSRSM(3,3),OA1LSM(3,3),OA1RSM(3,3),OH2lSLSM(3,3,6),OH2lSRSM(3,3,6),   & 
...
& OH2lSR(3,3,6),DP2lSL(3,3),DP2lSR(3,3),OZ2lSL(3,3),OZ2lSR(3,3),OZ2lVL(3,3),             & 
& OZ2lVR(3,3)
...
& OAh2qSLSM(3,3,99),OAh2qSRSM(3,3,99),OA2qSLSM(3,3),OA2qSRSM(3,3),OA2qVLSM(3,3),         & 
...
& BO4dTRL(3,3,3,3),BO4dTRR(3,3,3,3),OAh2qSL(3,3,99),OAh2qSR(3,3,99),OA2qSL(3,3),         & 
...
& OH2lSRcheck(3,3,6),DP2lSLcheck(3,3),DP2lSRcheck(3,3),OZ2lSLcheck(3,3),OZ2lSRcheck(3,3),& 
...
& OAh2qSLcheck(3,3,99),OAh2qSRcheck(3,3,99),OA2qSLcheck(3,3),OA2qSRcheck(3,3),           & 
...
& Lam7input,Lam1input,Lam4input,Lam3input,Lam2input,Lam1pinput,Lam2pinput,               & 
& L3ppinput,L1ppinput,Lam4pinput,Lam6pinput,Lam7pinput,Lam5pinput,L2ppinput,             & 
& Lam3pinput,Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,mus1input,            & 
& mu11input,mu12input,mu21input,mu22input,mus2input,M122input,M112input,M222input,       & 
& mS2input,mSp2input,vdinput,vuinput,vSinput,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,               & 
& Lam4,Lam3,Lam2,Lam1p,Lam2p,L3pp,L1pp,Lam4p,Lam6p,Lam7p,Lam5p,L2pp,Lam3p,               & 
& Yu,epsU,Yd,Ye,epsD,epsE,mus1,mu11,mu12,mu21,mu22,mus2,M122,M112,M222,mS2,              & 
& mSp2,vd,vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,Lam1p,Lam2p,L3pp,mus1,           & 
& mu11,mu12,mu21,mu22,mus2,L1pp,Lam4p,Lam6p,Lam7p,Lam5p,L2pp,Lam3p,eta,zeta,             & 
& vd,vu,vS,ZH,ZP,g1,g2,TW,g3,Yd,epsD,ZDL,ZDR,Yu,epsU,ZUL,ZUR,Ye,epsE,ZEL,ZER,            & 
& cplhhhhhh,cplhhHmcHm,cplhhhhVZ,cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcHmVZ,          & 
& cplhhcVWmVWm,cplhhVZVZ,cplHmcVWmVP,cplHmcVWmVZ,cplcHmVPVWm,cplcHmVWmVZ,cplVGVGVG,      & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,           & 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
...
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,        & 
& cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFeVZL,             & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,TSOddvvVRR(gt1,gt2,gt3,gt4)    & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,TVOddvvVRR(gt1,gt2,gt3,gt4)    & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,             & 
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,          & 
...
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4dSLL(gt1,gt2,gt3,gt4),               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,             & 
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,          & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4dSLL(gt1,gt2,gt3,gt4),               & 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,             & 
& cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFehhL,             & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,              & 
& cplcFeFvVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,        & 
...
& cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TSOdulvSLL(gt1,gt2,gt3,gt4) & 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,           & 
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,            & 
& cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TVOdulvSLL(gt1,gt2,gt3,gt4) & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,BOddvvVRR(gt1,gt2,gt3,gt4)     & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,PSOddvvVRR(gt1,gt2,gt3,gt4)    & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,PVOddvvVRR(gt1,gt2,gt3,gt4)    & 
...
Call CalculateBox4d(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,               & 
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,          & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4)& 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,         & 
& cplcHmVPVWm,cplcVWmVPVWm,cplHmcHmVP,cplHmcVWmVP,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2)        & 
& ,OA2qVL(gt1,gt2),OA2qVR(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,         & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,6 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.False.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,            & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,       & 
...
& cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,OH2qSL(gt1,gt2,gt3),OH2qSR(gt1,gt2,gt3))
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,TSOddvvVRRSM(gt1,gt2,gt3,gt4)  & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,TVOddvvVRRSM(gt1,gt2,gt3,gt4)  & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,              & 
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,          & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4dSLLSM(gt1,gt2,gt3,gt4)              & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,              & 
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,          & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4dSLLSM(gt1,gt2,gt3,gt4)              & 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,           & 
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,            & 
& cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TSOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,           & 
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,            & 
& cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TVOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,BOddvvVRRSM(gt1,gt2,gt3,gt4)   & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,PSOddvvVRRSM(gt1,gt2,gt3,gt4)  & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,         & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,PVOddvvVRRSM(gt1,gt2,gt3,gt4)  & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4d(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,            & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,              & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4dSLLSM(gt1,gt2,gt3,gt4)               & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,         & 
& cplcHmVPVWm,cplcVWmVPVWm,cplHmcHmVP,cplHmcVWmVP,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2)    & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,         & 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,6 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.true.,MFd,MFd2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,             & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,       & 
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,         & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,              & 
& cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,OH2qSLSM(gt1,gt2,gt3),OH2qSRSM(gt1,gt2,gt3))
...
& Lam4,Lam3,Lam2,Lam1p,Lam2p,L3pp,L1pp,Lam4p,Lam6p,Lam7p,Lam5p,L2pp,Lam3p,               & 
& Yu,epsU,Yd,Ye,epsD,epsE,mus1,mu11,mu12,mu21,mu22,mus2,M122,M112,M222,mS2,              & 
& mSp2,vd,vu,vS,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeS2L2d(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOllddSLLSM(gt1,gt2,gt3,gt4),TSOllddSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeV2L2d(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOllddSLLSM(gt1,gt2,gt3,gt4),TVOllddSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeS2L2u(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOlluuSLLSM(gt1,gt2,gt3,gt4),TSOlluuSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeV2L2u(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOlluuSLLSM(gt1,gt2,gt3,gt4),TVOlluuSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4L(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,             & 
...
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,TSO4lSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeS4L(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,              & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,TSO4lSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4L(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,             & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,TVO4lSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculateTreeV4L(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,              & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,TVO4lSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4Lcross(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,             & 
...
Call CalculateTreeS4Lcross(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
& cplhhVZVZ,TSO4lSLLcrossSM(gt1,gt2,gt3,gt4),TSO4lSRRcrossSM(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4Lcross(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
...
Call CalculateTreeV4Lcross(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
& cplhhVZVZ,TVO4lSLLcrossSM(gt1,gt2,gt3,gt4),TVO4lSRRcrossSM(gt1,gt2,gt3,gt4)            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox2L2d(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,              & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOllddSLLSM(gt1,gt2,gt3,gt4),BOllddSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengS2L2d(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOllddSLLSM(gt1,gt2,gt3,gt4),PSOllddSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengV2L2d(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOllddSLLSM(gt1,gt2,gt3,gt4),PVOllddSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox2L2u(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,              & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOlluuSLLSM(gt1,gt2,gt3,gt4),BOlluuSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengS2L2u(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOlluuSLLSM(gt1,gt2,gt3,gt4),PSOlluuSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengV2L2u(gt1,gt2,gt3,gt4,.True.,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,             & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,            & 
...
& cplcFvFecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,           & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOlluuSLLSM(gt1,gt2,gt3,gt4),PVOlluuSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4L(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,               & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,BO4lSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox4L(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,           & 
& MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,            & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,BO4lSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS4L(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,             & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,PSO4lSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengS4L(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,              & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,PSO4lSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV4L(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,             & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,PVO4lSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculatePengV4L(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,              & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,PVO4lSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4Lcross(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,               & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
...
Call CalculateBox4Lcross(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,           & 
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,cplhhVZVZ,BO4lSLLcrossSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS4Lcross(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
...
Call CalculatePengS4Lcross(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
& cplhhVZVZ,PSO4lSLLcrossSM(gt1,gt2,gt3,gt4),PSO4lSRRcrossSM(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV4Lcross(gt1,gt2,gt3,gt4,.False.,MFe,MFe2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
...
Call CalculatePengV4Lcross(gt1,gt2,gt3,gt4,.True.,MFe,MFe2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhVZ,             & 
& cplhhVZVZ,PVO4lSLLcrossSM(gt1,gt2,gt3,gt4),PVO4lSRRcrossSM(gt1,gt2,gt3,gt4)            & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2l(gt1,gt2,gt3,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,            & 
& MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,            & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
...
Call CalculateGamma2l(gt1,gt2,gt3,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,             & 
& MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,            & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcHmVPVWm,cplcVWmVPVWm,cplHmcHmVP,          & 
& cplHmcVWmVP,OA2lSLSM(gt1,gt2),OA2lSRSM(gt1,gt2),OA1LSM(gt1,gt2),OA1RSM(gt1,gt2))
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,6 
  gt3=i2 
Call CalculateH2l(gt1,gt2,gt3,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,          & 
& MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,      & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
& OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))

Call CalculateH2l(gt1,gt2,gt3,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,           & 
& MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,      & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhVZVZ,         & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateLeptonEDMgminus2(gt1,gt2,gt3,.False.,MFe,MFe2,Mhh,Mhh2,MHm,             & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcHmVPVWm,cplcVWmVPVWm,        & 
& cplHmcHmVP,cplHmcVWmVP,DP2lSL(gt1,gt2),DP2lSR(gt1,gt2))

Call CalculateLeptonEDMgminus2(gt1,gt2,gt3,.True.,MFe,MFe2,Mhh,Mhh2,MHm,              & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcHmVPVWm,cplcVWmVPVWm,        & 
& cplHmcHmVP,cplHmcVWmVP,DP2lSLSM(gt1,gt2),DP2lSRSM(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateZ2l(gt1,gt2,gt3,.False.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,          & 
& MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,      & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,       & 
& cplHmcVWmVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))

Call CalculateZ2l(gt1,gt2,gt3,.True.,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,           & 
& MVZ,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,      & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,       & 
& cplHmcVWmVZ,OZ2lSLSM(gt1,gt2),OZ2lSRSM(gt1,gt2),OZ2lVLSM(gt1,gt2),OZ2lVRSM(gt1,gt2))
...
Call DeltaRho(MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,            & 
& MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,      & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,           & 
& cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,               & 
& cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,& 
& cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZVZ1,             & 
...
Call STUparameter(vSM,g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,MFd,MFd2,MFe,MFe2,MFu,            & 
& MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,        & 
