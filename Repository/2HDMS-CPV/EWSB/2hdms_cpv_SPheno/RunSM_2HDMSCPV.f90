...
& mSp2,vd,vu,vS,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(160), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG160(g1input,g2input,g3input,Lam6input,Lam5input,Lam7input,          & 
& Lam1input,Lam4input,Lam3input,Lam2input,Lam1pinput,Lam2pinput,L3ppinput,               & 
& L1ppinput,Lam4pinput,Lam6pinput,Lam7pinput,Lam5pinput,L2ppinput,Lam3pinput,            & 
& Yuinput,epsUinput,Ydinput,Yeinput,epsDinput,epsEinput,mus1input,mu11input,             & 
& mu12input,mu21input,mu22input,mus2input,M122input,M112input,M222input,mS2input,        & 
& mSp2input,vdinput,vuinput,vSinput,g1D)

Call GToParameters160(g1D,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,Lam1p,          & 
