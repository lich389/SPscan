...
Module OneLoopDecay_Fe_2HDMSCPV
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_2HDMSCPV_FeToFehh(cplcFeFehhL,cplcFeFehhR,MFe,              & 
& Mhh,MFe2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_FeToFehh


Subroutine Gamma_Real_2HDMSCPV_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,        & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_FeToFehh


Subroutine Amplitude_WAVE_2HDMSCPV_FeToFehh(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_FeToFehh


Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFehh(MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFehh


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFehh(MFe,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,      & 
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFehh


Subroutine Amplitude_Tree_2HDMSCPV_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,MFe,              & 
& MVZ,MFe2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_FeToFeVZ


Subroutine Gamma_Real_2HDMSCPV_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,        & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_FeToFeVZ


Subroutine Amplitude_WAVE_2HDMSCPV_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_FeToFeVZ


Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFeVZ(MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),             & 
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),           & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplhhhhVZ(6,6),  & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFeVZ


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVZ(MFe,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVZ


Subroutine Amplitude_Tree_2HDMSCPV_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,MFe,              & 
& MHm,MFe2,MHm2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_FeToFvHm


Subroutine Gamma_Real_2HDMSCPV_FeToFvHm(MLambda,em,gs,cplcFeFvHmL,cplcFeFvHmR,        & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_FeToFvHm


Subroutine Amplitude_WAVE_2HDMSCPV_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,ctcplcFeFvHmL,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_FeToFvHm


Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFvHm(MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
...
& cplhhHmcVWm(6,2),cplHmcHmVP(2,2),cplHmcVWmVP(2),cplHmcHmVZ(2,2),cplHmcVWmVZ(2)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFvHm


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFvHm(MFe,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,      & 
& cplHmcVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFvHm


Subroutine Amplitude_Tree_2HDMSCPV_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_FeToFvVWm


Subroutine Gamma_Real_2HDMSCPV_FeToFvVWm(MLambda,em,gs,cplcFeFvVWmL,cplcFeFvVWmR,     & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_FeToFvVWm


Subroutine Amplitude_WAVE_2HDMSCPV_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_FeToFvVWm


Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFvVWm(MFe,Mhh,MHm,MVP,MVWm,MVZ,              & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
...
Complex(dp), Intent(in) :: cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),              & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),               & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplhhcHmVWm(6,2),& 
& cplhhcVWmVWm(6),cplcHmVPVWm(2),cplcVWmVPVWm,cplcHmVWmVZ(2),cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFvVWm


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFvVWm(MFe,Mhh,MHm,MVP,MVWm,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFvVWm


Subroutine Amplitude_WAVE_2HDMSCPV_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
& cplcFeFeVZR,ctcplcFeFeVPL,ctcplcFeFeVPR,ctcplcFeFeVZL,ctcplcFeFeVZR,MFe,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_FeToFeVP


Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFeVP(MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_FeToFeVP


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVP(MFe,Mhh,MHm,MVP,MVWm,MVZ,            & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHmcHmVP,cplHmcVWmVP,              & 
& cplcHmVPVWm,cplcVWmVPVWm,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVP



End Module OneLoopDecay_Fe_2HDMSCPV
