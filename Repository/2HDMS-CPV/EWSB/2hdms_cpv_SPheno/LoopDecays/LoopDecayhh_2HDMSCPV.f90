...
Module OneLoopDecay_hh_2HDMSCPV
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_2HDMSCPV_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,             & 
& Mhh,MFd2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTocFdFd


Subroutine Gamma_Real_2HDMSCPV_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTocFdFd


Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFdFd


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFdFd(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFdFd


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFdFd(MFd,MFu,Mhh,MHm,MVG,MVP,            & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFdFd


Subroutine Amplitude_Tree_2HDMSCPV_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,             & 
& Mhh,MFe2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTocFeFe


Subroutine Gamma_Real_2HDMSCPV_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTocFeFe


Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,   & 
...
Complex(dp), Intent(in) :: ZfEL(3,3),ZfER(3,3),Zfhh(6,6)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFeFe


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFeFe(MFe,Mhh,MHm,MVP,MVWm,MVZ,              & 
...
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplhhhhhh(6,6,6),cplhhhhVZ(6,6),cplhhHmcHm(6,2,2), & 
& cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhVZVZ(6)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFeFe


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFeFe(MFe,Mhh,MHm,MVP,MVWm,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFeFe


Subroutine Amplitude_Tree_2HDMSCPV_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,             & 
& Mhh,MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTocFuFu


Subroutine Gamma_Real_2HDMSCPV_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTocFuFu


Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,   & 
...
Complex(dp), Intent(in) :: Zfhh(6,6),ZfUL(3,3),ZfUR(3,3)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTocFuFu


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFuFu(MFd,MFu,Mhh,MHm,MVG,MVP,               & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,      & 
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,Amp)
...
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),           & 
...
& cplcFuFuVZR(3,3),cplhhhhhh(6,6,6),cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),   & 
& cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhVZVZ(6)
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocFuFu


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFuFu(MFd,MFu,Mhh,MHm,MVG,MVP,            & 
& MVWm,MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocFuFu


Subroutine Amplitude_Tree_2HDMSCPV_hhTohhhh(cplhhhhhh,Mhh,Mhh2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTohhhh


Subroutine Gamma_Real_2HDMSCPV_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,GammarealPhoton,  & 
& GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTohhhh


Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhhh


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhhh(MFd,MFe,MFu,Mhh,MHm,MVWm,               & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,           & 
...
& cplhhhhhhhh1,cplhhhhHmcHm1,cplhhhhcVWmVWm1,cplhhhhVZVZ1,Amp)

Implicit None

Real(dp), Intent(in) :: MFd(3),MFe(3),MFu(3),Mhh(6),MHm(2),MVWm,MVZ,MFd2(3),MFe2(3),MFu2(3),Mhh2(6),          & 
& MHm2(2),MVWm2,MVZ2

Complex(dp), Intent(in) :: cplcFdFdhhL(3,3,6),cplcFdFdhhR(3,3,6),cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),          & 
& cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcgWmgWmhh(6),cplcgWpCgWpChh(6),               & 
& cplcgZgZhh(6),cplhhhhhh(6,6,6),cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),      & 
& cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhVZVZ(6),cplhhhhhhhh1(6,6,6,6),cplhhhhHmcHm1(6,6,2,2),& 
& cplhhhhcVWmVWm1(6,6),cplhhhhVZVZ1(6,6)
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhhh


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhhh(MFd,MFe,MFu,Mhh,MHm,MVWm,            & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,           & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,            & 
& cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,         & 
& cplhhhhhhhh1,cplhhhhHmcHm1,cplhhhhcVWmVWm1,cplhhhhVZVZ1,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhhh


Subroutine Amplitude_Tree_2HDMSCPV_hhTohhVZ(cplhhhhVZ,Mhh,MVZ,Mhh2,MVZ2,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(6),MVZ,Mhh2(6),MVZ2

Complex(dp), Intent(in) :: cplhhhhVZ(6,6)
...
Mex3 = MVZ 
! Tree-Level Vertex 
coupT1 = cplhhhhVZ(gt1,gt2)
Call TreeAmp_StoSV(Mex1,Mex2,Mex3,coupT1,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTohhVZ


Subroutine Gamma_Real_2HDMSCPV_hhTohhVZ(MLambda,em,gs,cplhhhhVZ,Mhh,MVZ,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTohhVZ


Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhVZ(cplhhhhVZ,ctcplhhhhVZ,Mhh,Mhh2,           & 
...
Complex(dp), Intent(in) :: ctcplhhhhVZ(6,6)
...
! Coupling counter term 
!----------------------------- 
ZcoupT1 = ctcplhhhhVZ(gt1,gt2) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,6
ZcoupT1 = ZcoupT1 + 0.5_dp*Zfhh(i1,gt1)*cplhhhhVZ(i1,gt2)
End Do


! External Field 2 
Do i1=1,6
ZcoupT1 = ZcoupT1 + 0.5_dp*Zfhh(i1,gt2)*cplhhhhVZ(gt1,i1)
End Do


! External Field 3 
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZ*cplhhhhVZ(gt1,gt2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhVZ


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,               & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
...
& cplcgWmgWmhh(6),cplcgWmgWmVZ,cplcgWpCgWpChh(6),cplcgWpCgWpCVZ,cplhhhhhh(6,6,6),        & 
& cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),    & 
& cplhhVZVZ(6),cplHmcHmVZ(2,2),cplHmcVWmVZ(2),cplcHmVWmVZ(2),cplcVWmVWmVZ,               & 
& cplhhhhVZVZ1(6,6),cplhhHmcVWmVZ1(6,2),cplhhcHmVWmVZ1(6,2)
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhVZ


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,            & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVZ,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,    & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhVZ


Subroutine Amplitude_Tree_2HDMSCPV_hhTocHmHm(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTocHmHm


Subroutine Gamma_Real_2HDMSCPV_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTocHmHm


Subroutine Amplitude_WAVE_2HDMSCPV_hhTocHmHm(cplhhHmcHm,ctcplhhHmcHm,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTocHmHm


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocHmHm(MFd,MFe,MFu,Mhh,MHm,MVP,               & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocHmHm


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocHmHm(MFd,MFe,MFu,Mhh,MHm,MVP,            & 
& MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,           & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,               & 
& cplcgWmgWmhh,cplcgZgWmcHm,cplcgWpCgWpChh,cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocHmHm


Subroutine Amplitude_Tree_2HDMSCPV_hhToHmcVWm(cplhhHmcVWm,Mhh,MHm,MVWm,               & 
& Mhh2,MHm2,MVWm2,Amp)
...
Complex(dp), Intent(in) :: cplhhHmcVWm(6,2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhToHmcVWm


Subroutine Gamma_Real_2HDMSCPV_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,Mhh,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhToHmcVWm


Subroutine Amplitude_WAVE_2HDMSCPV_hhToHmcVWm(cplhhHmcVWm,ctcplhhHmcVWm,              & 
...
Complex(dp), Intent(in) :: ctcplhhHmcVWm(6,2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToHmcVWm


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToHmcVWm(MFd,MFe,MFu,Mhh,MHm,MVP,              & 
& MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpCgZcVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,     & 
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,      & 
& cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,   & 
...
Complex(dp), Intent(in) :: cplcFdFdhhL(3,3,6),cplcFdFdhhR(3,3,6),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),          & 
& cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),           & 
& cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),           & 
& cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),cplcgZgAhh(6),cplcgWmgAHm(2),cplcgWmgWmhh(6),    & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh(6),cplcgZgWpCHm(2),cplcgZgZhh(6),           & 
& cplcgWmgZHm(2),cplcgWpCgZcVWm,cplhhhhhh(6,6,6),cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),       & 
& cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhVZVZ(6),cplHmcHmVP(2,2),        & 
& cplHmcVWmVP(2),cplHmcHmVZ(2,2),cplHmcVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,               & 
& cplhhhhcVWmVWm1(6,6),cplhhHmcVWmVP1(6,2),cplhhHmcVWmVZ1(6,2),cplHmcHmcVWmVWm1(2,2)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToHmcVWm


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToHmcVWm(MFd,MFe,MFu,Mhh,MHm,               & 
& MVP,MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,         & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,               & 
& cplcgZgAhh,cplcgWmgAHm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,        & 
& cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpCgZcVWm,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToHmcVWm


Subroutine Amplitude_Tree_2HDMSCPV_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,            & 
& MVWm2,Amp)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhTocVWmVWm


Subroutine Gamma_Real_2HDMSCPV_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,            & 
...
End if 
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhTocVWmVWm


Subroutine Amplitude_WAVE_2HDMSCPV_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,           & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTocVWmVWm


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocVWmVWm(MFd,MFe,MFu,Mhh,MHm,MVP,             & 
& MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
...
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcgZgAhh(6),cplcgWmgAVWm,cplcgWpCgAcVWm,         & 
& cplcgWmgWmhh(6),cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh(6),cplcgAgWpCVWm,           & 
& cplcgZgWpCVWm,cplcgZgZhh(6),cplcgWmgZVWm,cplcgWpCgZcVWm,cplhhhhhh(6,6,6),              & 
& cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),    & 
& cplhhVZVZ(6),cplHmcVWmVP(2),cplHmcVWmVZ(2),cplcHmVPVWm(2),cplcVWmVPVWm,cplcHmVWmVZ(2), & 
& cplcVWmVWmVZ,cplhhhhcVWmVWm1(6,6),cplhhHmcVWmVP1(6,2),cplhhHmcVWmVZ1(6,2),             & 
& cplhhcHmVPVWm1(6,2),cplhhcHmVWmVZ1(6,2),cplHmcHmcVWmVWm1(2,2),cplcVWmcVWmVWmVWm1Q,     & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTocVWmVWm


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocVWmVWm(MFd,MFe,MFu,Mhh,MHm,              & 
& MVP,MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,         & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,           & 
& cplcgZgAhh,cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTocVWmVWm


Subroutine Amplitude_Tree_2HDMSCPV_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,Amp)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_2HDMSCPV_hhToVZVZ


Subroutine Gamma_Real_2HDMSCPV_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,              & 
& GammarealPhoton,GammarealGluon)
...
End if 
End Do
End Subroutine Gamma_Real_2HDMSCPV_hhToVZVZ


Subroutine Amplitude_WAVE_2HDMSCPV_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,           & 
& MVZ,MVZ2,Zfhh,ZfVZ,Amp)
...
Complex(dp), Intent(in) :: ctcplhhVZVZ(6)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToVZVZ


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVZVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,               & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVZ,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,    & 
& cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhhhVZVZ1,cplhhHmcVWmVZ1, & 
& cplhhcHmVWmVZ1,cplHmcHmVZVZ1,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,Amp)
...
& cplhhhhVZ(6,6),cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),    & 
& cplhhVZVZ(6),cplHmcHmVZ(2,2),cplHmcVWmVZ(2),cplcHmVWmVZ(2),cplcVWmVWmVZ,               & 
& cplhhhhVZVZ1(6,6),cplhhHmcVWmVZ1(6,2),cplhhcHmVWmVZ1(6,2),cplHmcHmVZVZ1(2,2),          & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVZVZ


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVZVZ(MFd,MFe,MFu,Mhh,MHm,MVWm,            & 
& MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVZ,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,    & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVZVZ


Subroutine Amplitude_WAVE_2HDMSCPV_hhToFvcFv(Mhh,Mhh2,Zfhh,ZfvL,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(6),Mhh2(6)

Complex(dp), Intent(in) :: Zfhh(6,6),ZfvL(3,3)
...
Amp(:,gt1, gt2, gt3) = 0._dp
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToFvcFv


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToFvcFv(MFe,Mhh,MHm,MVWm,MVZ,MFe2,             & 
...
Real(dp), Intent(in) :: MFe(3),Mhh(6),MHm(2),MVWm,MVZ,MFe2(3),Mhh2(6),MHm2(2),MVWm2,MVZ2

Complex(dp), Intent(in) :: cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),        & 
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),           & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplhhHmcHm(6,2,2),& 
& cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplhhVZVZ(6)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToFvcFv


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToFvcFv(MFe,Mhh,MHm,MVWm,MVZ,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToFvcFv


Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhVP(cplhhhhVZ,ctcplhhhhVZ,Mhh,Mhh2,           & 
& MVP,MVP2,MVZ,MVZ2,Zfhh,ZfVP,ZfVZVP,Amp)
...
Complex(dp), Intent(in) :: Zfhh(6,6),ZfVP,ZfVZVP
...
! External Field 3 
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZVP*cplhhhhVZ(gt1,gt2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhTohhVP


Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
...
Real(dp), Intent(in) :: MFd(3),MFe(3),MFu(3),Mhh(6),MHm(2),MVP,MVWm,MFd2(3),MFe2(3),MFu2(3),Mhh2(6),          & 
& MHm2(2),MVP2,MVWm2
...
& cplcgWmgWmhh(6),cplcgWmgWmVP,cplcgWpCgWpChh(6),cplcgWpCgWpCVP,cplhhHmcHm(6,2,2),       & 
& cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplHmcHmVP(2,2),cplHmcVWmVP(2),      & 
& cplcHmVPVWm(2),cplcVWmVPVWm,cplhhHmcVWmVP1(6,2),cplhhcHmVPVWm1(6,2)
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhTohhVP


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhVP(MFd,MFe,MFu,Mhh,MHm,MVP,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhTohhVP


Subroutine Amplitude_WAVE_2HDMSCPV_hhToVGVG(Mhh,Mhh2,MVG,MVG2,Zfhh,ZfVG,Amp)
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToVGVG


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,              & 
& Mhh2,MVG2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuhhL,cplcFuFuhhR,     & 
& cplcFuFuVGL,cplcFuFuVGR,Amp)

Implicit None

Real(dp), Intent(in) :: MFd(3),MFu(3),Mhh(6),MVG,MFd2(3),MFu2(3),Mhh2(6),MVG2
...
End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVGVG


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,           & 
& Mhh2,MVG2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuhhL,cplcFuFuhhR,     & 
& cplcFuFuVGL,cplcFuFuVGR,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVGVG


Subroutine Amplitude_WAVE_2HDMSCPV_hhToVPVP(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,           & 
...
Complex(dp), Intent(in) :: Zfhh(6,6),ZfVP,ZfVPVZ,ZfVZVP
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToVPVP


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVPVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVP,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,             & 
...
& cplcgWmgWmhh(6),cplcgWmgWmVP,cplcgWpCgWpChh(6),cplcgWpCgWpCVP,cplhhHmcHm(6,2,2),       & 
& cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),cplHmcHmVP(2,2),cplHmcVWmVP(2),      & 
& cplcHmVPVWm(2),cplcVWmVPVWm,cplhhHmcVWmVP1(6,2),cplhhcHmVPVWm1(6,2),cplHmcHmVPVP1(2,2),& 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVPVP


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVPVP(MFd,MFe,MFu,Mhh,MHm,MVP,             & 
& MVWm,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,          & 
& cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWpCgWpChh,          & 
& cplcgWpCgWpCVP,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVPVP


Subroutine Amplitude_WAVE_2HDMSCPV_hhToVPVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,           & 
...
Complex(dp), Intent(in) :: Zfhh(6,6),ZfVP,ZfVZ
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_2HDMSCPV_hhToVPVZ


Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVPVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
...
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuhhL(3,3,6),& 
& cplcFuFuhhR(3,3,6),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),& 
& cplcgWmgWmhh(6),cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpCgWpChh(6),cplcgWpCgWpCVP,            & 
& cplcgWpCgWpCVZ,cplhhHmcHm(6,2,2),cplhhHmcVWm(6,2),cplhhcHmVWm(6,2),cplhhcVWmVWm(6),    & 
& cplHmcHmVP(2,2),cplHmcVWmVP(2),cplHmcHmVZ(2,2),cplHmcVWmVZ(2),cplcHmVPVWm(2),          & 
& cplcVWmVPVWm,cplcHmVWmVZ(2),cplcVWmVWmVZ,cplhhHmcVWmVP1(6,2),cplhhHmcVWmVZ1(6,2),      & 
& cplhhcHmVPVWm1(6,2),cplhhcHmVWmVZ1(6,2),cplHmcHmVPVZ1(2,2),cplcVWmVPVWmVZ3Q,           & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_2HDMSCPV_hhToVPVZ


Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVPVZ(MFd,MFe,MFu,Mhh,MHm,MVP,             & 
& MVWm,MVZ,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_2HDMSCPV_hhToVPVZ



End Module OneLoopDecay_hh_2HDMSCPV
