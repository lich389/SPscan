...
Module Wrapper_OneLoopDecay_Fd_2HDMSCPV
Use Model_Data_2HDMSCPV 
Use Kinematics 
Use OneLoopDecay_Fd_2HDMSCPV 
Use Control 
Use Settings 
...
Call Amplitude_Tree_2HDMSCPV_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,           & 
& Mhh2,AmpTreeFdToFdhh)

  Else 
Call Amplitude_Tree_2HDMSCPV_FdToFdhh(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,              & 
& MFdOS,MhhOS,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,            & 
& MFdOS,MhhOS,MRPFdToFdhh,MRGFdToFdhh)
...
Call Amplitude_WAVE_2HDMSCPV_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,          & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWaveFdToFdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFdhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFdToFdhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFdhh(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,MFd2,           & 
& MVZ2,AmpTreeFdToFdVZ)

  Else 
Call Amplitude_Tree_2HDMSCPV_FdToFdVZ(ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,MVZ,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,              & 
& MFdOS,MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,            & 
& MFdOS,MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFdVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,         & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFdVZ(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,     & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,MFd,MFu,MHm,            & 
& MFd2,MFu2,MHm2,AmpTreeFdToFuHm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FdToFuHm(ZcplcFdFuHmL,ZcplcFdFuHmR,MFd,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,              & 
& MFdOS,MFuOS,MHmOS,MRPFdToFuHm,MRGFdToFuHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFuHm(MLambda,em,gs,ZcplcFdFuHmL,ZcplcFdFuHmR,            & 
& MFdOS,MFuOS,MHmOS,MRPFdToFuHm,MRGFdToFuHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,ctcplcFdFuHmL,          & 
& ctcplcFdFuHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFdToFuHm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFuHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcHm,              & 
& cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,AmpVertexIRdrFdToFuHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFuHm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,MFd,MFu,             & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFdToFuVWm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FdToFuVWm(ZcplcFdFuVWmL,ZcplcFdFuVWmR,MFd,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFuVWm(MLambda,em,gs,cplcFdFuVWmL,cplcFdFuVWmR,           & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FdToFuVWm(MLambda,em,gs,ZcplcFdFuVWmL,ZcplcFdFuVWmR,         & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,ctcplcFdFuVWmL,      & 
& ctcplcFdFuVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFdToFuVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFuVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFuVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FdToFuVWm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_2HDMSCPV_FdToFdVG(ZcplcFdFdVGL,ZcplcFdFdVGR,ctcplcFdFdVGL,        & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)

 Else 
Call Amplitude_WAVE_2HDMSCPV_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,          & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,         & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFdFuVWmL,cplcFdFuVWmR,cplVGVGVG,               & 
& AmpVertexFdToFdVG)
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_2HDMSCPV_FdToFdVP(ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,         & 
...
& MFd2OS,MVP,MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
 ...
 Else 
Call Amplitude_WAVE_2HDMSCPV_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdhhL,        & 
& ZcplcFdFdhhR,ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,         & 
& ZcplcFdFdVZR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFdFuHmL,   & 
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,         & 
& cplcFdFuHmR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplHmcHmVP,              & 
& cplHmcVWmVP,cplcHmVPVWm,cplcVWmVPVWm,AmpVertexFdToFdVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FdToFdVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
...
End Module Wrapper_OneLoopDecay_Fd_2HDMSCPV
