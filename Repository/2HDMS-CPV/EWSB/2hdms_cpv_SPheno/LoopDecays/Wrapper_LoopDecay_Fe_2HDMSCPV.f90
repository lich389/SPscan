...
Module Wrapper_OneLoopDecay_Fe_2HDMSCPV
Use Model_Data_2HDMSCPV 
Use Kinematics 
Use OneLoopDecay_Fe_2HDMSCPV 
Use Control 
Use Settings 
...
Call Amplitude_Tree_2HDMSCPV_FeToFehh(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,           & 
& Mhh2,AmpTreeFeToFehh)

  Else 
Call Amplitude_Tree_2HDMSCPV_FeToFehh(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,              & 
& MFeOS,MhhOS,MRPFeToFehh,MRGFeToFehh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFehh(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,            & 
& MFeOS,MhhOS,MRPFeToFehh,MRGFeToFehh)
...
Call Amplitude_WAVE_2HDMSCPV_FeToFehh(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,          & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWaveFeToFehh)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FeToFehh(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFehh(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,             & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFeToFehh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFehh(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,MFe,MVZ,MFe2,           & 
& MVZ2,AmpTreeFeToFeVZ)

  Else 
Call Amplitude_Tree_2HDMSCPV_FeToFeVZ(ZcplcFeFeVZL,ZcplcFeFeVZR,MFe,MVZ,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,              & 
& MFeOS,MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFeVZ(MLambda,em,gs,ZcplcFeFeVZL,ZcplcFeFeVZR,            & 
& MFeOS,MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FeToFeVZ(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,           & 
& MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
& cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVZ(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,             & 
& Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
...
& cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFeToFeVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFeVZ(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,              & 
& MVZOS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,    & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,MFe,MHm,MFe2,           & 
& MHm2,AmpTreeFeToFvHm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FeToFvHm(ZcplcFeFvHmL,ZcplcFeFvHmR,MFe,MHm,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFvHm(MLambda,em,gs,cplcFeFvHmL,cplcFeFvHmR,              & 
& MFeOS,MHmOS,MRPFeToFvHm,MRGFeToFvHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFvHm(MLambda,em,gs,ZcplcFeFvHmL,ZcplcFeFvHmR,            & 
& MFeOS,MHmOS,MRPFeToFvHm,MRGFeToFvHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,ctcplcFeFvHmL,          & 
& ctcplcFeFvHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveFeToFvHm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FeToFvHm(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,           & 
& MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFvHm(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,             & 
& Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
...
& cplHmcVWmVZ,AmpVertexIRdrFeToFvHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFvHm(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,              & 
& MVZOS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,    & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,MFe,MVWm,            & 
& MFe2,MVWm2,AmpTreeFeToFvVWm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FeToFvVWm(ZcplcFeFvVWmL,ZcplcFeFvVWmR,MFe,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFvVWm(MLambda,em,gs,cplcFeFvVWmL,cplcFeFvVWmR,           & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FeToFvVWm(MLambda,em,gs,ZcplcFeFvVWmL,ZcplcFeFvVWmR,         & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,ctcplcFeFvVWmL,      & 
& ctcplcFeFvVWmR,MFe,MFe2,MVWm,MVWm2,ZfEL,ZfER,ZfvL,ZfVWm,AmpWaveFeToFvVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FeToFvVWm(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,               & 
& Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplcHmVPVWm,cplcVWmVPVWm,             & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexFeToFvVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFvVWm(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,            & 
& Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplcHmVPVWm,cplcVWmVPVWm,             & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFeToFvVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FeToFvVWm(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,             & 
& MVZOS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,    & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_2HDMSCPV_FeToFeVP(ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,         & 
...
& MFe2OS,MVP,MVP2,ZfEL,ZfER,ZfVP,ZfVZVP,AmpWaveFeToFeVP)
 ...
 Else 
Call Amplitude_WAVE_2HDMSCPV_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_2HDMSCPV_FeToFeVP(MFeOS,MhhOS,MHmOS,MVP,MVWmOS,MVZOS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FeToFeVP(MFe,Mhh,MHm,MVP,MVWm,MVZ,MFe2,Mhh2,           & 
& MHm2,MVP2,MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
& cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,         & 
...
End Module Wrapper_OneLoopDecay_Fe_2HDMSCPV
