...
Module Wrapper_OneLoopDecay_Fu_2HDMSCPV
Use Model_Data_2HDMSCPV 
Use Kinematics 
Use OneLoopDecay_Fu_2HDMSCPV 
Use Control 
Use Settings 
...
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplVGVGVG,ctcplcFuFdcHmL,ctcplcFuFdcHmR, & 
...
& cplHmcVWmVP(2),cplHmcVWmVZ(2),cplVGVGVG,ctcplcFuFdcHmL(3,3,2),ctcplcFuFdcHmR(3,3,2),   & 
& ctcplcFuFdcVWmL(3,3),ctcplcFuFdcVWmR(3,3),ctcplcFuFuhhL(3,3,6),ctcplcFuFuhhR(3,3,6),   & 
...
& ZcplcFuFdcVWmR(3,3),ZcplcFuFuhhL(3,3,6),ZcplcFuFuhhR(3,3,6),ZcplcFuFuVGL(3,3),         & 
& ZcplcFuFuVGR(3,3),ZcplcFuFuVPL(3,3),ZcplcFuFuVPR(3,3),ZcplcFuFuVZL(3,3),               & 
& ZcplcFuFuVZR(3,3),ZcplcHmVPVWm(2),ZcplcVWmVPVWm,ZcplHmcHmVP(2,2),ZcplHmcVWmVP(2),      & 
& ZcplVGVGVG
...
Call Amplitude_Tree_2HDMSCPV_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,             & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FuToFdcHm(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,           & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFdcHm(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,         & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)
...
Call Amplitude_WAVE_2HDMSCPV_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,      & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFuToFdcHm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFdcHm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
...
& cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrFuToFdcHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFdcHm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,MFd,              & 
& MFu,MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)

  Else 
Call Amplitude_Tree_2HDMSCPV_FuToFdcVWm(ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,MFd,            & 
& MFu,MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,        & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFdcVWm(MLambda,em,gs,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,      & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,ctcplcFuFdcVWmL,  & 
& ctcplcFuFdcVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFuToFdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFdcVWm(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,      & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcVWm,               & 
& cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,AmpVertexIRdrFuToFdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFdcVWm(MFdOS,MFuOS,MhhOS,MHmOS,MVG,             & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,           & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_2HDMSCPV_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,              & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,            & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,          & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFuhh(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,     & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFuToFuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFuhh(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdhhL,     & 
...
& cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhVZ,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_2HDMSCPV_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,           & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_2HDMSCPV_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,              & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_2HDMSCPV_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,            & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_2HDMSCPV_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexFuToFuVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFuVZ(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,     & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFuToFuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_2HDMSCPV_FuToFuVZ(MFdOS,MFuOS,MhhOS,MHmOS,MVG,               & 
& MVP,MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVZL,     & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,cplhhhhVZ,             & 
& cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFuToFuVZ)
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,cplhhhhVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,     & 
...
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhVZ,               & 
& cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFuToFuVZ)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_2HDMSCPV_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,        & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_2HDMSCPV_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,          & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdVGL,        & 
& ZcplcFdFdVGR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFuFuhhL,   & 
& ZcplcFuFuhhR,ZcplcFdFuHmL,ZcplcFdFuHmR,ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFuFuVPL,         & 
& ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,ZcplVGVGVG,         & 
& AmpVertexFuToFuVG)

 Else 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVG(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVGL,         & 
& cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplVGVGVG,               & 
& AmpVertexFuToFuVG)
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVG(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_2HDMSCPV_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,         & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_2HDMSCPV_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFdFdVPL,        & 
& ZcplcFdFdVPR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFuFuhhL,   & 
& ZcplcFuFuhhR,ZcplcFdFuHmL,ZcplcFdFuHmR,ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFuFuVPL,         & 
& ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,ZcplHmcHmVP,        & 
& ZcplHmcVWmVP,ZcplcHmVPVWm,ZcplcVWmVPVWm,AmpVertexFuToFuVP)

 Else 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVP(MFdOS,MFuOS,MhhOS,MHmOS,MVG,MVP,              & 
& MVWmOS,MVZOS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdVPL,         & 
& cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplHmcHmVP,              & 
& cplHmcVWmVP,cplcHmVPVWm,cplcVWmVPVWm,AmpVertexFuToFuVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_2HDMSCPV_FuToFuVP(MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,MVZ,             & 
& MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,          & 
& cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,              & 
...
End Module Wrapper_OneLoopDecay_Fu_2HDMSCPV
