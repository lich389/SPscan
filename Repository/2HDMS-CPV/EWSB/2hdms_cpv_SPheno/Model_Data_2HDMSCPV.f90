...
Real(dp) :: g1IN,g2IN,g3IN,Lam1IN,Lam4IN,Lam3IN,Lam2IN,Lam1pIN,Lam2pIN,L3ppIN,M112IN,             & 
& M222IN,mS2IN

Complex(dp) :: Lam6IN,Lam5IN,Lam7IN,L1ppIN,Lam4pIN,Lam6pIN,Lam7pIN,Lam5pIN,L2ppIN,Lam3pIN,           & 
& YuIN(3,3),epsUIN(3,3),YdIN(3,3),YeIN(3,3),epsDIN(3,3),epsEIN(3,3),mus1IN,              & 
& mu11IN,mu12IN,mu21IN,mu22IN,mus2IN,M122IN,mSp2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,Lam1MZ,Lam4MZ,Lam3MZ,Lam2MZ,Lam1pMZ,Lam2pMZ,L3ppMZ,M112MZ,             & 
& M222MZ,mS2MZ

Complex(dp) :: Lam6MZ,Lam5MZ,Lam7MZ,L1ppMZ,Lam4pMZ,Lam6pMZ,Lam7pMZ,Lam5pMZ,L2ppMZ,Lam3pMZ,           & 
& YuMZ(3,3),epsUMZ(3,3),YdMZ(3,3),YeMZ(3,3),epsDMZ(3,3),epsEMZ(3,3),mus1MZ,              & 
& mu11MZ,mu12MZ,mu21MZ,mu22MZ,mus2MZ,M122MZ,mSp2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,Lam1GUT,Lam4GUT,Lam3GUT,Lam2GUT,Lam1pGUT,Lam2pGUT,L3ppGUT,          & 
& M112GUT,M222GUT,mS2GUT

Complex(dp) :: Lam6GUT,Lam5GUT,Lam7GUT,L1ppGUT,Lam4pGUT,Lam6pGUT,Lam7pGUT,Lam5pGUT,L2ppGUT,          & 
& Lam3pGUT,YuGUT(3,3),epsUGUT(3,3),YdGUT(3,3),YeGUT(3,3),epsDGUT(3,3),epsEGUT(3,3),      & 
& mus1GUT,mu11GUT,mu12GUT,mu21GUT,mu22GUT,mus2GUT,M122GUT,mSp2GUT
...
Real(dp) :: gPFu(3,165),gTFu(3),BRFu(3,165),gPFe(3,162),gTFe(3),BRFe(3,162),gPFd(3,165),          & 
& gTFd(3),BRFd(3,165),gPhh(6,72),gThh(6),BRhh(6,72),gPHm(2,32),gTHm(2),BRHm(2,32)

Real(dp) :: gP1LFu(3,30),gT1LFu(3),BR1LFu(3,30),gP1LFe(3,27),gT1LFe(3),BR1LFe(3,27),              & 
& gP1LFd(3,30),gT1LFd(3),BR1LFd(3,30),gP1Lhh(6,72),gT1Lhh(6),BR1Lhh(6,72),               & 
& gP1LHm(2,32),gT1LHm(2),BR1LHm(2,32)

Real(dp) :: ratioFd(6,3),ratioFe(6,3),ratioFu(6,3),ratioHm(6,2),ratioVWm(6)

Complex(dp) :: ratioGG(6),ratioPP(6)

Real(dp) :: ratioPFd(99,3),ratioPFe(99,3),ratioPFu(99,3),ratioPHm(99,2),ratioPVWm(99)

Complex(dp) :: ratioPGG(99),ratioPPP(99)

Real(dp) :: TanBetaQ
Real(dp) :: gForTadpoles(160)
Complex(dp) :: tForTadpoles(5)
Real(dp) :: g1_saveEP 
Real(dp) :: g2_saveEP 
...
Real(dp) :: CS_PHiggs_LHC(5,99,5) 
 
Real (dp) :: MhhL(6), Mhh2L(6) 
Real (dp) :: Mhh_s(6), Mhh2_s(6) 
Real (dp) :: MAhL(99), MAh2L(99) 
Real (dp) :: MAh_s(99), MAh2_s(99) 
...
Logical, save :: InputValueforLam1p =.False. 
Logical, save :: InputValueforLam2p =.False. 
Logical, save :: InputValueforL3pp =.False. 
Logical, save :: InputValueforL1pp =.False. 
Logical, save :: InputValueforLam4p =.False. 
Logical, save :: InputValueforLam6p =.False. 
Logical, save :: InputValueforLam7p =.False. 
Logical, save :: InputValueforLam5p =.False. 
Logical, save :: InputValueforL2pp =.False. 
Logical, save :: InputValueforLam3p =.False. 
...
Logical, save :: InputValueformus1 =.False. 
Logical, save :: InputValueformu11 =.False. 
Logical, save :: InputValueformu12 =.False. 
Logical, save :: InputValueformu21 =.False. 
Logical, save :: InputValueformu22 =.False. 
Logical, save :: InputValueformus2 =.False. 
...
Logical, save :: InputValueformSp2 =.False. 
...
Complex(dp) :: Lambda3ppInput
Complex(dp) :: Lambda1pInput
Complex(dp) :: Lambda2pInput
Complex(dp) :: M122Input
Complex(dp) :: mSp2Input
Real(dp) :: TanBeta
Complex(dp) :: vSInput
Complex(dp) :: zUrInput
Complex(dp) :: zDrInput
...
Real(dp) :: etaInput
Real(dp) :: zetaInput
Complex(dp) :: Lambda1pprInput
Complex(dp) :: Lambda2pprInput
Complex(dp) :: Lambda3prInput
Complex(dp) :: Lambda4prInput
Complex(dp) :: Lambda5prInput
Complex(dp) :: Lambda6prInput
Complex(dp) :: Lambda7prInput
Complex(dp) :: Lambda5rInput
Complex(dp) :: Lambda6rInput
Complex(dp) :: Lambda7rInput
Complex(dp) :: Lambda1ppiInput
Complex(dp) :: Lambda2ppiInput
Complex(dp) :: Lambda3piInput
Complex(dp) :: Lambda4piInput
Complex(dp) :: Lambda5piInput
Complex(dp) :: Lambda6piInput
Complex(dp) :: Lambda7piInput
Complex(dp) :: Lambda5iInput
Complex(dp) :: Lambda6iInput
Complex(dp) :: Lambda7iInput
Complex(dp) :: mu11rInput
Complex(dp) :: mu12rInput
Complex(dp) :: mu21rInput
Complex(dp) :: mu22rInput
Complex(dp) :: mus1rInput
Complex(dp) :: mus2rInput
Complex(dp) :: mu11iInput
Complex(dp) :: mu12iInput
Complex(dp) :: mu21iInput
Complex(dp) :: mu22iInput
Complex(dp) :: mus1iInput
Complex(dp) :: mus2iInput
Complex(dp) :: zUiInput
Complex(dp) :: zDiInput
Complex(dp) :: zEiInput
Real(dp) :: vdMZ 
...
Real(dp) :: BRAll(99,3,3)   = 0._dp 
 Real(dp) :: BRHHH(6,6)=0._dp
Real(dp) :: BRHAA(6,99)= 0._dp 
 Real(dp) :: BRAHH(99,6)=0._dp
Real(dp) :: BRAAA(99,99)  = 0._dp 
 Real(dp) :: BRHHHijk(6,6,6)=0._dp
Real(dp) :: BRHHAijk(6,6,99)=0._dp
Real(dp) :: BRHAAijk(6,99,99)  = 0._dp 
 Real(dp) :: BRAHHijk(99,6,6)=0._dp
Real(dp) :: BRAHAijk(99,6,99)=0._dp
Real(dp) ::  BRAAAijk(99,99,99)  = 0._dp 
 Real(dp) :: BRHHZ(6,6)=0._dp
Real(dp) :: BRHAZ(6,99)  = 0._dp 
 Real(dp) :: BRAHZ(99,6) =0._dp
Real(dp) :: BRAAZ(99,99)  = 0._dp 
 Real(dp) :: BRAHpW(99,2)=0._dp
Real(dp) :: BRHHpW(6,2)  = 0._dp 
 Real(dp) :: BRinvH(6), BRinvA(99)  = 0._dp 
Real(dp) :: rHB_P_VP(99),rHB_S_VP(6)
Real(dp) :: rHB_P_VZ(99),rHB_S_VZ(6)
Real(dp) :: rHB_P_VG(99),rHB_S_VG(6)
Real(dp) :: rHB_P_VWm(99),rHB_S_VWm(6)
Real(dp) :: rHB_P_P_Fd(99,3),rHB_P_S_Fd(99,3),rHB_S_S_Fd(6,3),rHB_S_P_Fd(6,3)
Real(dp) :: rHB_P_P_Fu(99,3),rHB_P_S_Fu(99,3),rHB_S_S_Fu(6,3),rHB_S_P_Fu(6,3)
Real(dp) :: rHB_P_P_Fe(99,3),rHB_P_S_Fe(99,3),rHB_S_S_Fe(6,3),rHB_S_P_Fe(6,3)
Real(dp) :: rHB_P_P_Fv(99),rHB_P_S_Fv(99),rHB_S_S_Fv(6),rHB_S_P_Fv(6)
Complex(dp) :: CPL_H_H_Z(6,6) =0._dp 
 Complex(dp) :: CoupHPP(6), CoupHGG(6) =0._dp 
Real(dp) :: HPPloopVWm(6)
Real(dp) :: HPPloopHm(2,6)
...
Lambda3ppInput=(0._dp,0._dp) 
Lambda1pInput=(0._dp,0._dp) 
Lambda2pInput=(0._dp,0._dp) 
M122Input=(0._dp,0._dp) 
mSp2Input=(0._dp,0._dp) 
TanBeta= 0._dp 
vSInput=(0._dp,0._dp) 
zUrInput=(0._dp,0._dp) 
zDrInput=(0._dp,0._dp) 
zErInput=(0._dp,0._dp) 
etaInput= 0._dp 
zetaInput= 0._dp 
Lambda1pprInput=(0._dp,0._dp)
Lambda2pprInput=(0._dp,0._dp)
Lambda3prInput=(0._dp,0._dp)
Lambda4prInput=(0._dp,0._dp)
Lambda5prInput=(0._dp,0._dp)
Lambda6prInput=(0._dp,0._dp)
Lambda7prInput=(0._dp,0._dp)
Lambda5rInput=(0._dp,0._dp)
Lambda6rInput=(0._dp,0._dp)
Lambda7rInput=(0._dp,0._dp)
Lambda1ppiInput=(0._dp,0._dp)
Lambda2ppiInput=(0._dp,0._dp)
Lambda3piInput=(0._dp,0._dp)
Lambda4piInput=(0._dp,0._dp)
Lambda5piInput=(0._dp,0._dp)
Lambda6piInput=(0._dp,0._dp)
Lambda7piInput=(0._dp,0._dp)
Lambda5iInput=(0._dp,0._dp)
Lambda6iInput=(0._dp,0._dp)
Lambda7iInput=(0._dp,0._dp)
mu11rInput=(0._dp,0._dp)
mu12rInput=(0._dp,0._dp)
mu21rInput=(0._dp,0._dp)
mu22rInput=(0._dp,0._dp)
mus1rInput=(0._dp,0._dp)
mus2rInput=(0._dp,0._dp)
mu11iInput=(0._dp,0._dp)
mu12iInput=(0._dp,0._dp)
mu21iInput=(0._dp,0._dp)
mu22iInput=(0._dp,0._dp)
mus1iInput=(0._dp,0._dp)
mus2iInput=(0._dp,0._dp)
zUiInput=(0._dp,0._dp)
zDiInput=(0._dp,0._dp)
zEiInput=(0._dp,0._dp)
...
& mu22,mus2,M122,M112,M222,mS2,mSp2,MZsuffix)
...
If (MZsuffix) Then 
  ...
  YeMZ = (YeSM*(vd - vu*((0._dp,1._dp)*zEiInput + zErInput))*(Cos(etaInput) + (0._dp,1._dp)*Sin(etaInput)))/vSM 
  YdMZ = (YdSM*(vd - vu*((0._dp,1._dp)*zDiInput + zDrInput))*(Cos(etaInput) + (0._dp,1._dp)*Sin(etaInput)))/vSM 
  YuMZ = (YuSM*(vd - vu*((0._dp,1._dp)*zUiInput + zUrInput))*(Cos(etaInput) - (0._dp,1._dp)*Sin(etaInput)))/vSM 
  epsEMZ = (YeSM*(vu + vd*((0._dp,1._dp)*zEiInput + zErInput)))/vSM 
  epsDMZ = (YdSM*(vu + vd*((0._dp,1._dp)*zDiInput + zDrInput)))/vSM 
  epsUMZ = (YuSM*(vu + vd*((0._dp,1._dp)*zUiInput + zUrInput)))/vSM 
  g1MZ = g1SM 
  g2MZ = g2SM 
  g3MZ = g3SM 
Else 
  ...
  epsE = (YeSM*(vu + vd*((0._dp,1._dp)*zEiInput + zErInput)))/vSM 
  epsD = (YdSM*(vu + vd*((0._dp,1._dp)*zDiInput + zDrInput)))/vSM 
  epsU = (YuSM*(vu + vd*((0._dp,1._dp)*zUiInput + zUrInput)))/vSM 
  g1 = g1SM 
  g2 = g2SM 
  g3 = g3SM 
End if 
End Subroutine SetMatchingConditions 
End Module Model_Data_2HDMSCPV