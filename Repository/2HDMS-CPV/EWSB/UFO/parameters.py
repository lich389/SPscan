...
# ----------------------------------------------------------------------  
# File created at 10:19 on 20.6.2025   
# ----------------------------------------------------------------------  
...
L1pp = 	 Parameter(name='L1pp', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rL1pp + complex(0,1)*iL1pp', 
	 texname = '\\text{L1pp}' ) 
...
L2pp = 	 Parameter(name='L2pp', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rL2pp + complex(0,1)*iL2pp', 
	 texname = '\\text{L2pp}' ) 
