...
Complex(dp) :: Lam5IN,Lam6IN,Lam7IN,Lam1IN,Lam3IN,Lam4IN,Lam8IN,Lam2IN,YuIN(3,3),YdIN(3,3),          & 
& YeIN(3,3),M12IN,MS2IN,M112IN,M222IN

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: Lam5MZ,Lam6MZ,Lam7MZ,Lam1MZ,Lam3MZ,Lam4MZ,Lam8MZ,Lam2MZ,YuMZ(3,3),YdMZ(3,3),          & 
& YeMZ(3,3),M12MZ,MS2MZ,M112MZ,M222MZ

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: Lam5GUT,Lam6GUT,Lam7GUT,Lam1GUT,Lam3GUT,Lam4GUT,Lam8GUT,Lam2GUT,YuGUT(3,3),           & 
& YdGUT(3,3),YeGUT(3,3),M12GUT,MS2GUT,M112GUT,M222GUT
...
Real(dp) :: gP1LFu(3,21),gT1LFu(3),BR1LFu(3,21),gP1LFe(3,21),gT1LFe(3),BR1LFe(3,21),              & 
& gP1LFd(3,21),gT1LFd(3),BR1LFd(3,21),gP1Lhh(3,46),gT1Lhh(3),BR1Lhh(3,46),               & 
& gP1LAh(2,44),gT1LAh(2),BR1LAh(2,44),gP1LHm(2,28),gT1LHm(2),BR1LHm(2,28)
...
Real(dp) :: BRHAA(3,2)= 0._dp 
 Real(dp) :: BRAHH(2,3)=0._dp
Real(dp) :: BRAAA(2,2)  = 0._dp 
 Real(dp) :: BRHHHijk(3,3,3)=0._dp
Real(dp) :: BRHHAijk(3,3,2)=0._dp
Real(dp) :: BRHAAijk(3,2,2)  = 0._dp 
 Real(dp) :: BRAHHijk(2,3,3)=0._dp
Real(dp) :: BRAHAijk(2,3,2)=0._dp
Real(dp) ::  BRAAAijk(2,2,2)  = 0._dp 
 Real(dp) :: BRHHZ(3,3)=0._dp
Real(dp) :: BRHAZ(3,2)  = 0._dp 
 Real(dp) :: BRAHZ(2,3) =0._dp
Real(dp) :: BRAAZ(2,2)  = 0._dp 
 Real(dp) :: BRAHpW(3,2)=0._dp
Real(dp) :: BRHhpW(2,2)  = 0._dp 
 Real(dp) :: BRinvH(3), BRinvA(2)  = 0._dp 
Real(dp) :: rHB_P_VP(2),rHB_S_VP(3)
Real(dp) :: rHB_P_VZ(2),rHB_S_VZ(3)
Real(dp) :: rHB_P_VG(2),rHB_S_VG(3)
Real(dp) :: rHB_P_VWm(2),rHB_S_VWm(3)
Real(dp) :: rHB_P_P_Fd(2,3),rHB_P_S_Fd(2,3),rHB_S_S_Fd(3,3),rHB_S_P_Fd(3,3)
Real(dp) :: rHB_P_P_Fu(2,3),rHB_P_S_Fu(2,3),rHB_S_S_Fu(3,3),rHB_S_P_Fu(3,3)
Real(dp) :: rHB_P_P_Fe(2,3),rHB_P_S_Fe(2,3),rHB_S_S_Fe(3,3),rHB_S_P_Fe(3,3)
Real(dp) :: rHB_P_P_Fv(2),rHB_P_S_Fv(2),rHB_S_S_Fv(3),rHB_S_P_Fv(3)
Complex(dp) :: CPL_A_H_Z(2,3)  =0._dp 
...
& vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,             & 
& M222,MZsuffix)
