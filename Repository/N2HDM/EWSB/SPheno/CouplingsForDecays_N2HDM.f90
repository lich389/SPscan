...
Module CouplingsForDecays_N2HDM
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplcFuFuAhL,             & 
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplcFeFeAhL,             & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,               & 
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,deltaM)
...
Complex(dp),Intent(out) :: cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),          & 
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplcFdFdAhL,             & 
...
Complex(dp),Intent(out) :: cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),          & 
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplHiggsPP,              & 
...
Complex(dp),Intent(out) :: cplHiggsPP(3),cplHiggsGG(3),cplHiggsZZvirt(3),cplHiggsWWvirt(3),cplAhAhhh(2,2,3),     & 
& cplAhhhhh(2,3,3),cplAhhhVZ(2,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFeFehhL(3,3,3),& 
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplPseudoHiggsPP,        & 
...
Complex(dp),Intent(out) :: cplPseudoHiggsPP(2),cplPseudoHiggsGG(2),cplAhAhAh(2,2,2),cplAhAhhh(2,2,3),            & 
& cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),           & 
& cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplAhhhhh(2,3,3),cplAhhhVZ(2,3),cplAhHmcHm(2,2,2),& 
& cplAhHmcVWm(2,2)
...
& ZZinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam6input,Lam7input,              & 
& Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,Yeinput,             & 
& M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,cplAhHmcHm,              & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplhhHmcHm,            & 
& cplhhcHmVWm,cplHmcHmVZ,cplcHmVWmVZ,deltaM)
...
End Module CouplingsForDecays_N2HDM
