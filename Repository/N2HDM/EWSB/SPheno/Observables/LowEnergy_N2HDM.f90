...
Use StandardModel 
Use RunSM_N2HDM
Use FlavorKit_LFV_N2HDM
Use FlavorKit_QFV_N2HDM
Use FlavorKit_Observables_N2HDM
...
Real(dp),Intent(in)  :: MAh(2),MAh2(2),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2)

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),          & 
...
Implicit None
Real(dp),Intent(in)  :: MAh(2),MAh2(2),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2),MVWm,MVWm2,MVZ,MVZ2
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(2,2),cplAhAhVZVZ(2,2),cplAhhhVZ(2,3),cplAhHmcVWm(2,2),cplcFdFdVZL(3,3),& 
...
& cplhhhhcVWmVWm(3,3),cplhhhhVZVZ(3,3),cplhhHmcVWm(3,2),cplhhVZVZ(3),cplHmcHmcVWmVWm(2,2),& 
...
& Ydinput,Yeinput,M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,         & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Lam5input,Lam6input,Lam7input,Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,      & 
...
Complex(dp) :: cplAhAhAh(2,2,2),cplAhAhcVWmVWm(2,2),cplAhAhhh(2,2,3),cplAhAhVZVZ(2,2),               & 
& cplAhcHmVWm(2,2),cplAhhhhh(2,3,3),cplAhhhVZ(2,3),cplAhHmcHm(2,2,2),cplAhHmcVWm(2,2),   & 
& cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),           & 
...
& cplcFdFuVWmR(3,3),cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplcFeFehhL(3,3,3),            & 
...
& cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),           & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcHmVWm(3,2),cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),  & 
& cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVZVZ(3),     & 
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,Lam5input,Lam6input,         & 
...
& vd,vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Lam5,vd,vu,ZA,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,vS,ZH,ZP,               & 
& Lam6,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,cplAhAhAh,cplAhAhhh,cplAhhhhh,       & 
& cplAhHmcHm,cplhhhhhh,cplhhHmcHm,cplAhhhVZ,cplAhHmcVWm,cplAhcHmVWm,cplhhHmcVWm,         & 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,Lam5input,Lam6input,              & 
& Lam7input,Lam1input,Lam3input,Lam4input,Lam8input,Lam2input,Yuinput,Ydinput,           & 
& Yeinput,M12input,MS2input,M112input,M222input,vdinput,vuinput,vSinput,g1,              & 
& g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,              & 
& vd,vu,vS,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
