...
Complex(dp),Intent(in) :: cplAhAhAh(2,2,2),cplAhAhhh(2,2,3),cplAhcHmVWm(2,2),cplAhhhhh(2,3,3),cplAhhhVZ(2,3),   & 
...
& cplhhHmcVWm(3,2),cplhhVZVZ(3),cplHmcHmVP(2,2),cplHmcHmVZ(2,2),cplHmcVWmVP(2),          & 
& cplHmcVWmVZ(2)
...
Complex(dp),Intent(in) :: cplAhhhVZ(2,3),cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFdFdhhL(3,3,3),              & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFuHmL(3,3,2),               & 
...
& cplcFvFvVZR(3,3),cplcHmVWmVZ(2),cplcVWmVWmVZ,cplhhVZVZ(3),cplHmcHmVZ(2,2),             & 
& cplHmcVWmVZ(2)
...
Implicit None 
Real(dp),Intent(in) :: MAh(2),MAh2(2),MFd(3),MFd2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2),           & 
& MVWm,MVWm2,MVZ,MVZ2
...
& cplcFuFuAhR(3,3,2),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVGL(3,3),             & 
...
& cplhhcVWmVWm(3),cplhhhhhh(3,3,3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVZVZ(3),      & 
...
& cplcFdFdAhR(3,3,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),             & 
...
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,2),          & 
& cplcFuFuAhR(3,3,2),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
...
Complex(dp),Intent(in) :: cplAhAhhh(2,2,3),cplAhhhhh(2,3,3),cplAhhhVZ(2,3),cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),& 
& cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),             & 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
...
End Function C1C2 
End Module FlavorKit_QFV_N2HDM 
