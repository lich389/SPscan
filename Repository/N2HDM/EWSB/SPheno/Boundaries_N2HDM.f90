...
& ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,              & 
& Yd,Ye,M12,MS2,M112,M222,delta0,gMZ,kont)
...
Complex(dp) :: cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),cplcUFdFdhhL(3,3,3),cplcUFdFdhhR(3,3,3),      & 
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,vS,g1,             & 
& g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,.True.)
...
Call ParametersToG81(g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,             & 
& Yd,Ye,M12,MS2,M112,M222,gMZ)
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZA,ZH,ZP,               & 
& ZW,ZZ,betaH,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,             & 
& MS2,M112,M222,mGut,kont,WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(81), gB(81)
Real(dp) :: gC(84),  gD(84) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(3), lambda_SM, lambda_MZ 
Real(dp) :: comp(3), tanbQ, vev2 
Complex(dp) :: cplAhAhUhh(2,2,3),cplAhUhhhh(2,3,3),cplAhUhhVZ(2,3),cplcFdFdUhhL(3,3,3),              & 
...
mGUT = 1._dp 
Call GToParameters81(gB,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,             & 
...
Real(dp):: gA(81), gB(81), Scale_Save 
