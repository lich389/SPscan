...
& vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,            & 
& M112,M222,kont)
...
Complex(dp) :: cplAhAhcVWmVWm(2,2),cplAhAhUhh(2,2,3),cplAhAhUhhUhh(2,2,3,3),cplAhAhUHmcUHm(2,2,2,2), & 
& cplAhAhVZVZ(2,2),cplAhcUHmVWm(2,2),cplAhhhVZ(2,3),cplAhHmcUHm(2,2,2),cplAhHmcVWm(2,2), & 
& cplAhUhhhh(2,3,3),cplAhUhhVZ(2,3),cplcFdFdUAhL(3,3,2),cplcFdFdUAhR(3,3,2),             & 
...
& cplcFeFeUAhR(3,3,2),cplcFeFeUhhL(3,3,3),cplcFeFeUhhR(3,3,3),cplcFeFeVPL(3,3),          & 
...
& cplcFuFuUAhR(3,3,2),cplcFuFuUhhL(3,3,3),cplcFuFuUhhR(3,3,3),cplcFuFuVGL(3,3),          & 
...
& cplcgWpCgWpCUAh(2),cplcgWpCgWpCUhh(3),cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcUHm(2), & 
& cplcgWpCgZcVWm,cplcgZgWmcUHm(2),cplcgZgWmcVWm,cplcgZgWpCUHm(2),cplcgZgZUhh(3),         & 
& cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),cplcUFdFdhhL(3,3,3),& 
...
& cplcUFuFuAhR(3,3,2),cplcUFuFuhhL(3,3,3),cplcUFuFuhhR(3,3,3),cplcUFuFuVGL(3,3),         & 
...
& cplUAhAhhh(2,2,3),cplUAhhhhh(2,3,3),cplUAhhhVZ(2,3),cplUAhHmcHm(2,2,2),cplUAhHmcVWm(2,2),& 
& cplUAhUAhAhAh(2,2,2,2),cplUAhUAhcVWmVWm(2,2),cplUAhUAhhhhh(2,2,3,3),cplUAhUAhHmcHm(2,2,2,2),& 
& cplUAhUAhVZVZ(2,2),cplUhhcVWmVWm(3),cplUhhhhhh(3,3,3),cplUhhHmcHm(3,2,2)
...
Call CouplingsForLoopMasses(Lam5,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,vd,vu,vS,              & 
& ZA,ZH,g1,g2,TW,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,Lam6,ZP,g3,cplAhAhUhh,cplAhUhhhh,      & 
...
& cplUAhUAhHmcHm,cplUAhUAhcVWmVWm,cplUAhUAhVZVZ,cplAhHmcUHm,cplAhcUHmVWm,cplcFuFdcUHmL,  & 
...
& cplUHmcUHmcVWmVWm,cplUHmcUHmVZVZ,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,               & 
...
& cplcUFeFvVWmR,cplcUFvFecHmL,cplcUFvFecHmR,cplcUFvFecVWmL,cplcUFvFecVWmR,               & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,             & 
& Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,kont,ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,             & 
& Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,kont,ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)
...
End if 
Call SolveTadpoleEquations(g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,               & 
& Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,vd,vu,vS,Tad1Loop)
...
M2222L = M222
MS22L = MS2
Call OneLoophh(M12,Lam5,MS22L,M1122L,M2222L,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,            & 
& Lam2,vd,vu,vS,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MHm,               & 
& MHm2,MVWm,MVWm2,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,            & 
...
Call OneLoopAh(g1,g2,M12,Lam5,M1122L,M2222L,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,            & 
& vd,vu,vS,TW,MAh,MAh2,Mhh,Mhh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHm,MHm2,            & 
...
Else 
Call OneLoopAh(g1,g2,M12,Lam5,M1121L,M2221L,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,            & 
& vd,vu,vS,TW,MAh,MAh2,Mhh,Mhh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHm,MHm2,            & 
& MVWm,MVWm2,cplUAhAhAh,cplUAhAhhh,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,               & 
& cplcFeFeUAhR,cplcFuFuUAhL,cplcFuFuUAhR,cplcgWmgWmUAh,cplcgWpCgWpCUAh,cplUAhhhhh,       & 
& cplUAhhhVZ,cplUAhHmcHm,cplUAhHmcVWm,cplUAhUAhAhAh,cplUAhUAhhhhh,cplUAhUAhHmcHm,        & 
...
End if 
Call OneLoopHm(g2,M12,Lam5,M1121L,M2221L,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,               & 
& vd,vu,vS,MHm,MHm2,MAh,MAh2,MVWm,MVWm2,MFu,MFu2,MFd,MFd2,MFe,MFe2,Mhh,Mhh2,             & 
& MVZ,MVZ2,cplAhHmcUHm,cplAhcUHmVWm,cplcFuFdcUHmL,cplcFuFdcUHmR,cplcFvFecUHmL,           & 
...
Complex(dp), Intent(in) :: cplAhAhUhh(2,2,3),cplcFdFdUhhL(3,3,3),cplcFdFdUhhR(3,3,3),cplcFeFeUhhL(3,3,3),        & 
...
Subroutine OneLoophh(M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,            & 
& Lam2,vd,vu,vS,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MHm,               & 
& MHm2,MVWm,MVWm2,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,            & 
& cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,     & 
& cplcgZgZUhh,cplUhhhhhh,cplUhhHmcHm,cplUhhHmcVWm,cplUhhcVWmVWm,cplUhhVZVZ,              & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(2),MAh2(2),Mhh(3),Mhh2(3),MVZ,MVZ2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),          & 
& MFu2(3),MHm(2),MHm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: vd,vu,vS

Complex(dp), Intent(in) :: M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2

Complex(dp), Intent(in) :: cplAhAhUhh(2,2,3),cplAhUhhhh(2,3,3),cplAhUhhVZ(2,3),cplcFdFdUhhL(3,3,3),              & 
...
mat2a(1,1) = mat2a(1,1)+(Lam7*vS**2)/2._dp
...
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)+Lam7*vd*vS
mat2a(2,2) = 0._dp 
...
mat2a(2,2) = mat2a(2,2)+(Lam8*vS**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(vd**2*Conjg(Lam5))/4._dp
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)+Lam8*vu*vS
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+MS2
mat2a(3,3) = mat2a(3,3)+(Lam7*vd**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(Lam8*vu**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(3*Lam6*vS**2)/2._dp
...
Subroutine OneLoopAh(g1,g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,               & 
& Lam2,vd,vu,vS,TW,MAh,MAh2,Mhh,Mhh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHm,            & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(2),MAh2(2),Mhh(3),Mhh2(3),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),           & 
& MVZ,MVZ2,MHm(2),MHm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: g1,g2,vd,vu,vS,TW

Complex(dp), Intent(in) :: M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2

Complex(dp), Intent(in) :: cplUAhAhAh(2,2,2),cplUAhAhhh(2,2,3),cplcFdFdUAhL(3,3,2),cplcFdFdUAhR(3,3,2),          & 
...
Subroutine OneLoopHm(g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,             & 
& vd,vu,vS,MHm,MHm2,MAh,MAh2,MVWm,MVWm2,MFu,MFu2,MFd,MFd2,MFe,MFe2,Mhh,Mhh2,             & 
& MVZ,MVZ2,cplAhHmcUHm,cplAhcUHmVWm,cplcFuFdcUHmL,cplcFuFdcUHmR,cplcFvFecUHmL,           & 
& cplcFvFecUHmR,cplcgZgWmcUHm,cplcgWmgZUHm,cplcgWpCgZcUHm,cplcgZgWpCUHm,cplhhHmcUHm,     & 
& cplhhcUHmVWm,cplHmcUHmVP,cplHmcUHmVZ,cplcUHmVPVWm,cplcUHmVWmVZ,cplAhAhUHmcUHm,         & 
...
Implicit None 
Real(dp), Intent(in) :: MFd(3),MFd2(3),MAh(2),MAh2(2),Mhh(3),Mhh2(3),MVZ,MVZ2,MHm(2),MHm2(2),MFu(3),          & 
& MFu2(3),MVWm,MVWm2
...
Complex(dp), Intent(in) :: cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),cplcUFdFdhhL(3,3,3),cplcUFdFdhhR(3,3,3),      & 
...
Implicit None 
Real(dp), Intent(in) :: MFe(3),MFe2(3),MAh(2),MAh2(2),Mhh(3),Mhh2(3),MVZ,MVZ2,MHm(2),MHm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: vd

Complex(dp), Intent(in) :: Ye(3,3)

Complex(dp), Intent(in) :: cplcUFeFeAhL(3,3,2),cplcUFeFeAhR(3,3,2),cplcUFeFehhL(3,3,3),cplcUFeFehhR(3,3,3),      & 
...
Real(dp), Intent(in) :: Mhh(3),Mhh2(3),MAh(2),MAh2(2),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),           & 
& MVZ,MVZ2,MHm(2),MHm2(2),MVWm,MVWm2

Real(dp), Intent(in) :: g1,g2,vd,vu,TW

Complex(dp), Intent(in) :: cplAhhhVZ(2,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),   & 
...
& cplcVWmVWmVZ,cplAhAhcVWmVWm(2,2),cplhhhhcVWmVWm(3,3),cplHmcHmcVWmVWm(2,2),             & 
...
Complex(dp), Intent(in) :: cplAhhhhh(2,3,3),cplAhhhVZ(2,3),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),& 
...
Complex(dp), Intent(in) :: cplAhAhhh(2,2,3),cplAhcHmVWm(2,2),cplAhhhVZ(2,3),cplAhHmcHm(2,2,2),cplAhHmcVWm(2,2),  & 
