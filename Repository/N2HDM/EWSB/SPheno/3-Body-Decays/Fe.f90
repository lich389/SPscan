...
& MS2,M112,M222,vd,vu,vS,gTAh,gThh,gTHm,gTVWm,gTVZ,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,     & 
...
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,              & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MVZ,MAh(2),Mhh(3)
...
Real(dp),Intent(in) :: MFe(3),MVZ,MAh(2),Mhh(3)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MVZ,MAh(2),Mhh(3)
