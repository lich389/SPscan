...
& MS2,M112,M222,vd,vu,vS,gTAh,gThh,gTHm,gTVWm,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,     & 
...
Real(dp),Intent(in) :: MFd(3),MVZ,MAh(2),Mhh(3)
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MVZ,MAh(2),Mhh(3)
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVWm,MHm(2),MAh(2),Mhh(3)
