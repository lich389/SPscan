...
& MS2,M112,M222,vd,vu,vS,gTAh,gThh,gTHm,gTVWm,gTVZ,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,     & 
& gFuFdcFeFv,gFuFucFvFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(in) :: gTAh(2),gThh(3),gTHm(2),gTVWm,gTVZ

Real(dp) :: gFuFucFdFdi(3,3,3),gFuFucFeFei(3,3,3),gFuFucFuFui(3,3,3),gFuFdcFeFvi(3,3,3),          & 
& gFuFucFvFvi(3,3,3)

Real(dp) :: gTAhtemp(2),gThhtemp(3),gTHmtemp(2),gTVWmtemp,gTVZtemp
...
& ZUL,ZA,ZH,ZP,ZW,ZZ,betaH,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,             & 
& Yu,Yd,Ye,M12,MS2,M112,M222,vd,vu,vS,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,               & 
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVWm,MHm(2),MAh(2),Mhh(3)

Complex(dp),Intent(in) :: cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),          & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),               & 
...
Real(dp),Intent(inout) :: gTVZ,gTVWm,gTHm(2),gTAh(2),gThh(3)
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVZ,MAh(2),Mhh(3)
...
Real(dp),Intent(inout) :: gTVZ,gTAh(2),gThh(3)
...
Real(dp),Intent(in) :: MFu(3),MVZ,MAh(2),Mhh(3)

Complex(dp),Intent(in) :: cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),          & 
