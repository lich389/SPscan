...
Complex(dp) :: PDGhh(3),PDGAh(2),PDGHm(2),PDGVP,PDGVZ,PDGVG,PDGVWm,PDGgP,PDGgWm,PDGgWmC,             & 
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - N2HDM Spectrum + Decays + Flavor Observables"
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), Sqrt(mass_uncertainty_Q(7)**2+mass_uncertainty_Yt(7)**2),"# MHm(2) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Q(7),"# MHm(2) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Yt(7),"# MHm(2) " 
End if
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.N2HDM",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.N2HDM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.N2HDM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
