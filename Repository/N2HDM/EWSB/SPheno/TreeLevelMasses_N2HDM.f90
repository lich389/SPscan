...
& M112,M222,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MAh(2),MAh2(2),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),           & 
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesN2HDM'
...
Call CalculateMhh(M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,               & 
& Lam2,vd,vu,vS,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAh(g1,g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,             & 
& vd,vu,vS,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHm(g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,vd,             & 
...
& betaH,vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,Lam4,Lam8,Lam2,Yu,Yd,Ye,              & 
& M12,MS2,M112,M222,GenerationMixing,kont)
...
Call CalculateMhhEffPot(M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,Lam4,              & 
& Lam8,Lam2,vd,vu,vS,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAhEffPot(g1,g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,            & 
& Lam2,vd,vu,vS,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHmEffPot(g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,               & 
& Lam2,vd,vu,vS,ZP,MHm,MHm2,kont)
...
Subroutine CalculateMhh(M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,Lam4,              & 
& Lam8,Lam2,vd,vu,vS,ZH,Mhh,Mhh2,kont)
...
mat(1,1) = mat(1,1)+(Lam7*vS**2)/2._dp
...
mat(2,2) = mat(2,2)+(Lam8*vS**2)/2._dp
mat(2,2) = mat(2,2)+(vd**2*Conjg(Lam5))/4._dp
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+Lam8*vu*vS
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+MS2
mat(3,3) = mat(3,3)+(Lam7*vd**2)/2._dp
mat(3,3) = mat(3,3)+(Lam8*vu**2)/2._dp
mat(3,3) = mat(3,3)+(3*Lam6*vS**2)/2._dp
...
Subroutine CalculateMAh(g1,g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,            & 
& Lam2,vd,vu,vS,TW,ZA,MAh,MAh2,kont)
...
Subroutine CalculateMHm(g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,Lam8,               & 
& Lam2,vd,vu,vS,ZP,MHm,MHm2,kont)
...
Subroutine CalculateMhhEffPot(M12,Lam5,MS2,M112,M222,Lam6,Lam7,Lam1,Lam3,             & 
& Lam4,Lam8,Lam2,vd,vu,vS,ZH,Mhh,Mhh2,kont)
...
Subroutine CalculateMAhEffPot(g1,g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,           & 
& Lam8,Lam2,vd,vu,vS,TW,ZA,MAh,MAh2,kont)
...
Subroutine CalculateMHmEffPot(g2,M12,Lam5,M112,M222,Lam7,Lam1,Lam3,Lam4,              & 
& Lam8,Lam2,vd,vu,vS,ZP,MHm,MHm2,kont)
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,vd,vu,vS,g1,g2,g3,Lam5,Lam6,Lam7,Lam1,Lam3,           & 
& Lam4,Lam8,Lam2,Yu,Yd,Ye,M12,MS2,M112,M222,GenerationMixing,kont)
...
End Module TreeLevelMasses_N2HDM 
