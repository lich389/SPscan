...
Implicit None 
Real(dp),Intent(in) :: MAh(2),MFe(3),Mhh(3),MHm(2),MVWm,g2,vd,vu,ZA(2,2),ZH(3,3),ZP(2,2)

Complex(dp),Intent(in) :: ZER(3,3),ZEL(3,3),Ye(3,3)

Real(dp) :: MAh2(2),MFe2(3),Mhh2(3),MHm2(2),MVWm2

Complex(dp) :: cplAhcHmVWm(2,2),cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplcFeFehhL(3,3,3),            & 
...
End Module LoopCouplings_N2HDM 
