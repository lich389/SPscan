{{hh, 2*(-rMS/2 + B0[p^2, Mass2[VZ], Mass2[VZ]])*conj[Cp[Uhh[{gO2}], VZ, VZ]]*
 ...
 {Hm, 4*(-rMS/2 + B0[p^2, 0, Mass2[VWm]])*conj[Cp[conj[UHm[{gO2}]], VWm, VP]]*
 ...
 {Fv, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 
   ...
   -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hm[{gI1}]]]*
         conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][PR]]*
         Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][PR]]]/2 - 
    ...
    sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fe[{gI2}]], Mass2[VWm]])*
      ...
      Cp[bar[Fv[{gO1}]], conj[VWm], Fe[{gI2}]][PL]], 
   -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hm[{gI1}]]]*
         conj[Cp[bar[Fv[{gO2}]], conj[Hm[{gI1}]], Fe[{gI2}]][PL]]*
         Cp[bar[Fv[{gO1}]], conj[Hm[{gI1}]], Fe[{gI2}]][PL]]]/2 - 
    sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], Mass2[VZ]])*
 ...
 {VZ, B00[p^2, Mass2[gWm], Mass2[gWm]]*conj[Cp[VZ, bar[gWm], gWm]]*
   ...
   sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*Cp[VZ, VZ, conj[Hm[{gI1}]], 
      Hm[{gI1}]]] - 4*sum[gI1, 1, 2, sum[gI2, 1, 2, 
      B00[p^2, Mass2[Hm[{gI1}]], Mass2[Hm[{gI2}]]]*
       conj[Cp[VZ, conj[Hm[{gI1}]], Hm[{gI2}]]]*Cp[VZ, conj[Hm[{gI1}]], 
        Hm[{gI2}]]]] + sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
      Cp[VZ, VZ, hh[{gI1}], hh[{gI1}]]]/2 - 
   4*sum[gI1, 1, 3, sum[gI2, 1, 2, B00[p^2, Mass2[Ah[{gI2}]], 
 ...
 {VWm, B00[p^2, Mass2[gWm], Mass2[gP]]*conj[Cp[conj[VWm], bar[gP], gWm]]*
   ...
   sum[gI1, 1, 2, A0[Mass2[Ah[{gI1}]]]*Cp[VWm, conj[VWm], Ah[{gI1}], 
       Ah[{gI1}]]]/2 + sum[gI1, 1, 2, A0[Mass2[Hm[{gI1}]]]*
     Cp[VWm, conj[VWm], conj[Hm[{gI1}]], Hm[{gI1}]]] - 
   4*sum[gI1, 1, 2, sum[gI2, 1, 2, B00[p^2, Mass2[Ah[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[conj[VWm], Hm[{gI1}], Ah[{gI2}]]]*
       Cp[conj[VWm], Hm[{gI1}], Ah[{gI2}]]]] - 
   4*sum[gI1, 1, 2, sum[gI2, 1, 3, B00[p^2, Mass2[hh[{gI2}]], 
        Mass2[Hm[{gI1}]]]*conj[Cp[conj[VWm], Hm[{gI1}], hh[{gI2}]]]*
       Cp[conj[VWm], Hm[{gI1}], hh[{gI2}]]]] + 
